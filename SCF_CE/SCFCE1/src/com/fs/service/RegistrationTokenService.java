...
public class RegistrationTokenService {
	 ...
	 */
	public HashMap<String, String> generateRegistrationToken(
			    String cMainRef,
	 ...
	 // 1️ Generate JWT
	    String jwtToken = Jwts.builder()
	    		    .setSubject("COUNTERPARTY_REGISTRATION")
		            .claim("cMainRef", cMainRef)
		            .claim("counterpartyId", counterPartyId)
		            .claim("email", counterpartyEmail)
	            .setIssuedAt(now)
	...
	public HashMap<String, String> regenerateToken(String cMainRef, String counterpartyId, String counterpartyEmail,
			Integer expirationHours) throws Exception {
		return generateRegistrationToken(cMainRef, counterpartyId, counterpartyEmail, expirationHours);
	}
	...
	public static void main(String[] args) {
	    ...
	    try {
	        ...
	        HashMap<String, String> tokenResult =
	                service.generateRegistrationToken(
	                        "MAINREF001",
	                        "CP001",
	                        "test@gmail.com",
	                        null
	        ...
	        String jwt =
	                tokenResult.get("PLAIN_JWT");

	        String encryptedToken =
	                tokenResult.get("TOKEN");

	        String registrationLink =
	                tokenResult.get("REGISTRATION_LINK");
	        ...
	        HashMap<String, String> validateResult =
	                service.validateToken(encryptedToken);
