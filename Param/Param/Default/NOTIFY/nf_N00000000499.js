/* if (NS.isRelease()) {
    ...
    var sEmailId = NS.createMail("CSBankSupport","ReleaseCounterParty");

if(!NS.isLastAuthorizer()){
var nsTask = NS.createNotification("ReleaseCounterParty");
...
var authAlert = NS.createMail("ReleaseCounterParty");
...
var nsMarkerAlert = NS.createMail("ReleaseCounterParty");
