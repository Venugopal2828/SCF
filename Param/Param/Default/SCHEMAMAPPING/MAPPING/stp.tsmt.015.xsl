    ...
    <xsl:template match="/">
        <xsl:element name="root">
            <xsl:element name="domData">
                <xsl:element name="C_XML_DATA_015">
                    <xsl:value-of select="/message/out-msg-content/C_XML_DATA"/>
                </xsl:element>
                <xsl:element name="TSUR2_TRX_STATUS">
                    <xsl:value-of select="/message/Document/DltaRpt/TxSts/Sts"/>
                </xsl:element>
                <xsl:element name="TSU_AMD_SEQNO">
                    <xsl:value-of select="/message/Document/DltaRpt/AmdmntNb/Nb"/>
                </xsl:element>
                <xsl:element name="TSU_MESSAGE_ID">
                    <xsl:value-of select="/message/Document/DltaRpt/RptId/Id"/>
                </xsl:element>
                <xsl:element name="TSU_RL_MSG_ID">
                    <xsl:value-of select="/message/Document/DltaRpt/RptId/Id"/>
                </xsl:element>
                <xsl:element name="TSU_RL_MSG_ID_DTTM">
                    <xsl:value-of select="/message/Document/DltaRpt/RptId/CreDtTm"/>
                </xsl:element>
                <xsl:element name="TSU_TID">
                    <xsl:value-of select="/message/Document/DltaRpt/TxId/Id"/>
                </xsl:element>
