...
<xsl:stylesheet exclude-result-prefixes="xalan" extension-element-prefixes="base ee cs" version="1.0" xmlns:base="base"
    ...
    <xsl:template match="/">
        <xsl:element name="Document">
            <xsl:element name="BaselnAmdmntReq">
                <xsl:element name="ReqId">
                    <xsl:element name="Id">
                ...
                <xsl:element name="Baseln">
                    ...
                    <xsl:element name="Goods">
                        ...
                        <xsl:element name="RtgSummry">
                            <xsl:element name="IndvTrnsprt">
                                <xsl:element name="TrnsprtByAir">
                                    <xsl:element name="DprtureAirprt">
                                        <xsl:element name="OthrAirprtDesc"/>
                                    </xsl:element>
                                    <xsl:element name="DstnAirprt">
                                        <xsl:element name="OthrAirprtDesc"/>
                                    </xsl:element>
                                </xsl:element>
                                <xsl:element name="TrnsprtByRoad"/>
                            </xsl:element>
                        </xsl:element>
                    ...
                    <xsl:element name="TrnsprtDataSetReqrd">
                        <xsl:element name="Submitr"/>
                    </xsl:element>
