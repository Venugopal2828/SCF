...
<xsl:stylesheet exclude-result-prefixes="xalan" extension-element-prefixes="base ee cs" version="1.0" xmlns:base="base"
    ...
    <xsl:template match="/">
        <xsl:element name="Document">
            ...
            <xsl:apply-templates mode="m0" select="/root/domData/XDO_SA_RF"/>
        </xsl:element>
    </xsl:template>
    <xsl:template match="/root/domData/XDO_SA_RF" mode="m0">
        <DFAgreement>
