...
//sSQLCond1 = DV.addSQLCondition(sSQLCond1, "FA_AGM_SIGN_FLG","Active");


//sSQLCond = DV.addSQLCondition(sSQLCond, "C_UNIT_CODE",sUnitCode);
sSQLCond = DV.addSQLCondition(sSQLCond, "FA_BUSI_TYPE","PF");
sSQLCond = DV.addSQLCondition(sSQLCond, "FA_SEL_ID",sUnitCode);
...
//sSQLCond2 = DV.addSQLCondition(sSQLCond2, "FA_INV_FIN_TYPE","Buyer");
sSQLCond2 = DV.addSQLCondition(sSQLCond2, "FA_SEL_ID",sUnitCode);
//sSQLCond2 = DV.addSQLCondition(sSQLCond2, "FA_AGM_SIGN_FLG","Active");

//sSQLCond3 = DV.addSQLCondition(sSQLCond3, "C_UNIT_CODE",sUnitCode);
sSQLCond3 = DV.addSQLCondition(sSQLCond3, "FA_BUSI_TYPE","DD");
//sSQLCond3 = DV.addSQLCondition(sSQLCond3, "FA_INV_FIN_TYPE","Supplier");
sSQLCond3 = DV.addSQLCondition(sSQLCond3, "FA_SEL_ID",sUnitCode);
//sSQLCond3 = DV.addSQLCondition(sSQLCond3, "FA_AGM_SIGN_FLG","Active");
...
for(var i=0;i < count3 ;i++){
	var record3 = DV.getRecord(RS3,i);
	var sBusiType = String(DV.getDBFieldValue(record3,"FA_BUSI_TYPE"));
