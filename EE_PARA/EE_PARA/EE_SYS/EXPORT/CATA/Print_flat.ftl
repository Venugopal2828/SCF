...
<head>
	...
	<link href="../theme_flat/catalog_display.css" rel="stylesheet" type="text/css" media="screen">
	<link href="../theme_flat/Print.css" rel="stylesheet" type="text/css" media="print">	
	<link href="../theme_flat/sys_btn.css" rel="stylesheet" type="text/css" media="screen">
	<link href="../theme_flat/Master.css" rel="stylesheet" type="text/css" media="screen">
	<style type="text/css">
	@media   print   {	
...
<#assign tdClass01 = "class='td_grid_title'"/>
<#assign trClass02 = "class='td_grid_title'"/>
...
<#assign DECIMAL = "3"/>
 <br> 
  ...
  <div id="cataAction" width="100%" >
    <!--EE-10000 <input type="button" style="left:350px;position:absolute;top:80px" class="sbtn_default" value="Close" onmouseover="light_image(this)" onmouseout="restore_image(this)" onclick="window.close()">-->
	<input type="button" style="left:450px;position:absolute;top:80px" name="_Print" class="sbtn_default" value="Print" onmouseover="light_image(this)" onmouseout="restore_image(this)" onClick="printdiv('div_print');" >  
  </div> 
  <br>  
<div id="div_print">
