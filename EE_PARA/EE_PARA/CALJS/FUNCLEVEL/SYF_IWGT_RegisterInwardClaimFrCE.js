...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*ConfirmBusinessCheckSave", e);
    }
}

csFuncLevelProto.InitValues = function() {
    try {
        document.MAINFORM.CURRNT_STATUS.value = 'RegisterClaimCE';
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*InitValues", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Cal_check_CLM_AMT = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*SYF_IWGT_Cal_check_CLM_AMT", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_getDOdata_AdviceForBankCust = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*SYF_IWGT_getDOdata_AdviceForBankCust", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CLM_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*FLD_IWGT_CLM_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CLM_TRX_CCY_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*FLD_IWGT_CLM_TRX_CCY_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_DIARY_NARRATIVE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*FLD_IWGT_DIARY_NARRATIVE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_view_1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_RegisterInwardClaimFrCE.js*FLD_IWGT_view_1_onclick", e);
    }
}