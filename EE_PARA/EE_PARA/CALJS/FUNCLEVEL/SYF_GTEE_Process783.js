...
csFuncLevelProto.SYF_GTEE_AMD_DETAILS = function() {
    try {
        ...
        DisExcpt("SYF_GTEE_Process783.js", e);
    }
}
...
csFuncLevelProto.SYF_GTEE_Cal_NEW_BAL = function() {
    try {

        var REL_AMT = SYS_BeFloat(document.MAINFORM.X798_33B_REL_AMT.value);
        var GTEE_AMT = SYS_BeFloat(document.MAINFORM.GTEE_AMT.value);
        var BASE_BAL = SYS_BeFloat(document.MAINFORM.BASE_BAL.value);
        var NEW_GTEE_AMT;
        var NEW_BASE_BAL;
        NEW_GTEE_AMT = GTEE_AMT - REL_AMT;
        NEW_BASE_BAL = BASE_BAL - REL_AMT;
        document.MAINFORM.NEW_GTEE_AMT.value = SYT_AmtFormat(document.MAINFORM.GTEE_CCY.value, NEW_GTEE_AMT);
        document.MAINFORM.NEW_BASE_BAL.value = SYT_AmtFormat(document.MAINFORM.GTEE_CCY.value, NEW_BASE_BAL);
    } catch (e) {
        DisExcpt("SYF_GTEE_Process783.js", e);
    }
}
