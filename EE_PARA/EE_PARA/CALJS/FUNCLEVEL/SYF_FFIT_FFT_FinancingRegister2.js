...
csFuncLevelProto.SYF_FFIT_ACPT_BK_CNTY = function() {
    try {
        ...
        if (document.MAINFORM.ACPT_BK_CNTY.value != '') {
            REHN = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_ACPT_BK_CNTY_0', '1');
            if (REHN == 'N') {
                SYT_ChangeFldClass(document.MAINFORM.HO_ACPT_BK_ID, 'M', 'N');
                document.MAINFORM.Submit4.disabled = false;
                REHW = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_ACPT_BK_CNTY_1', '1');
            }
            ...
            if (REHW == 'Y') {
                RECN = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_ACPT_BK_CNTY_2', '1');
                if (RECN == 'N') {
        ...
        if ((REHW == 'Y') && (HOREHW == 'Y')) {
            ...
            if (SYS_BeFloat(document.MAINFORM.ACPT_CNTY_TYPE.value) == SYS_BeFloat(document.MAINFORM.HO_ACPT_CNTY_TYPE.value)) {
                SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_ACPT_BK_CNTY_3', '1');

            }
            if (SYS_BeFloat(document.MAINFORM.ACPT_CNTY_TYPE.value) < SYS_BeFloat(document.MAINFORM.HO_ACPT_CNTY_TYPE.value)) {
                SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_ACPT_BK_CNTY_4', '1');
        ...
        DisExcpt("SYF_FFIT_FFT_FinancingRegister2.js", e);
    }
}
...
csFuncLevelProto.SYF_FFIT_ACPT_BK_ID = function() {
    try {
        ...
        if (document.MAINFORM.ACPT_BK_ID.value != '') {
            RECH = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_ACPT_BK_ID_5', '1');
            if (RECH == 'N') {
...
csFuncLevelProto.SYF_FFIT_ACPT_BK_SW = function() {
    try {
        ...
        if (document.MAINFORM.ACPT_BK_SW.value != '') {
            RECH = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_ACPT_BK_SW_6', '1');
            if (RECH == 'N') {
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        document.MAINFORM.AUTH_MARGIN.value = '0';
        document.MAINFORM.OVER_AC_NO.value = document.MAINFORM.ACPT_BK_CNTY.value;
        SYT_Check_AMT();
    } catch (e) {
        DisExcpt("SYF_FFIT_FFT_FinancingRegister2.js", e);
    }
...
csFuncLevelProto.SYF_FFIT_EXPT_ID = function() {
    try {
        ...
        if (document.MAINFORM.EXPT_ID.value != '') {
            SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_EXPT_ID_7', '1');
        }
        if (document.MAINFORM.EXPT_ID.value == '') {
...
csFuncLevelProto.SYF_FFIT_GTS_PRVN_ID = function() {
    try {
        ...
        if (document.MAINFORM.GTS_BR_ID.value != '') {
            //SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_GTS_PRVN_ID_8', '1');
        } else {
...
csFuncLevelProto.SYF_FFIT_HO_ACPT_BK_CNTY = function() {
    try {
        ...
        if (document.MAINFORM.HO_ACPT_BK_CNTY.value != '') {
            HOREHW = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_HO_ACPT_BK_CNTY_9', '1');

            if (HOREHW == 'Y') {
                HORECN = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_HO_ACPT_BK_CNTY_10', '1');
                if (HORECN == 'N') {
                    alert('There is no country risk rating maintain');
                }
            }
        ...
        if ((REHW == 'Y') && (HOREHW == 'Y')) {
            ...
            if (SYS_BeFloat(document.MAINFORM.ACPT_CNTY_TYPE.value) == SYS_BeFloat(document.MAINFORM.HO_ACPT_CNTY_TYPE.value)) {
                SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_HO_ACPT_BK_CNTY_11', '1');

            }
            if (SYS_BeFloat(document.MAINFORM.ACPT_CNTY_TYPE.value) < SYS_BeFloat(document.MAINFORM.HO_ACPT_CNTY_TYPE.value)) {
                SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_HO_ACPT_BK_CNTY_12', '1');
                document.MAINFORM.FFT_MARGIN_LOWEST.value = document.MAINFORM.FFT_MARGIN_LOWEST.value - 10;
                if (document.MAINFORM.FFT_MARGIN_LOWEST.value < 50) {
                    document.MAINFORM.FFT_MARGIN_LOWEST.value = '50';
                }
...
csFuncLevelProto.SYF_FFIT_HO_ACPT_BK_ID = function() {
    try {
        ...
        if (document.MAINFORM.HO_ACPT_BK_ID.value != '') {
            RECH = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_HO_ACPT_BK_ID_13', '1');
            if (RECH == 'N') {
                alert('BK_ID is wrong!'); // Utility Auto Fix Comments
                document.MAINFORM.FFT_MARGIN_LOWEST.value = '0';
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.EVENT_TYPE.VALUE = 'FINCRegister2';
...
csFuncLevelProto.SYF_FFIT_SELL_BK_ID = function() {
    try {
        ...
        if (document.MAINFORM.SELL_BK_ID.value != '') {
            RECH = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_SELL_BK_ID_14', '1');
            if (RECH == 'N') {
                alert('BK_ID is wrong!'); // Utility Auto Fix Comments
...
csFuncLevelProto.SYF_FFIT_SELL_BK_SW = function() {
    try {
        ...
        if (document.MAINFORM.SELL_BK_SW.value != '') {
            RECH = SYS_GetTableDataByRule_S('SYF_FFIT_FFT_FinancingRegister2_SYF_FFIT_SELL_BK_SW_15', '1');
            if (RECH == 'N') {
                alert('SWIFT number is wrong. Please input again!');
            }
        }
    ...
    try {
        ...
        if (document.MAINFORM.MATURITY.value != '') {
            if ((document.MAINFORM.GRACE_FLG.value == '2') && (document.MAINFORM.GRACE_DAYS.value >= '0')) {
                SYS_CalEndWorkingDate_S(SYS_BANK_COUNTRY, document.MAINFORM.MATURITY.value, document.MAINFORM.GRACE_DAYS.value, 'FINC_DUE_DT', 'A', 'Y', 'Y');
            } else if ((document.MAINFORM.GRACE_FLG.value == '1') && (document.MAINFORM.GRACE_DAYS.value >= '0')) {
                SYS_CalEndWorkingDate_S(SYS_BANK_COUNTRY, document.MAINFORM.MATURITY.value, document.MAINFORM.GRACE_DAYS.value, 'FINC_DUE_DT', 'A', 'N', 'Y');
            }
        } else {
...
csFuncLevelProto.SYF_FFIT_changefield = function() {
    try {
      ...
      if (document.MAINFORM.FAV_RT_FLG.value == 'YES') { 
            SYT_ChangeFldClass(document.MAINFORM.FAV_REMARK, 'M', 'N');
        }
...
csFuncLevelProto.SYF_FFIT_ACPT_AMT = function() {
    try {
        ...
        document.MAINFORM.FINC_AMT.value = document.MAINFORM.ACPT_AMT.value;
    } catch (e) {
        DisExcpt("SYF_FFIT_FFT_FinancingRegister2.js", e);
    }
}
...
csFuncLevelProto.FLD_FFIT_FINC_AMT_onchange = function(event) {
    try {
        if (SYS_BeFloat(document.MAINFORM.FINC_AMT2.value) > SYS_BeFloat(document.MAINFORM.ACPT_AMT.value)) {
            alert("Finance amount should not be greater than Acceptance amount");
            document.MAINFORM.FINC_AMT2.value = '';
        }
