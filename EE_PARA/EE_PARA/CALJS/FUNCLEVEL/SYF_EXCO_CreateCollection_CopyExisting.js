...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        //zoe added to clear values in initial
        ...
        document.MAINFORM.MAX_TRACER_NO.value = 0;
        document.MAINFORM.NXT_TRCR_DT.value = '';
        document.MAINFORM.NOTES.value = '';
        document.MAINFORM.WAIVE_INSTRUCTION.value = '';
        ...
        document.MAINFORM.SPCL_INSTR.value = '';
        document.MAINFORM.PMT_INSTR.value = '';
        ...
        DisExcpt("SYF_EXCO_CreateCollection_CopyExisting.js", e);
    }
}
...
csFuncLevelProto.SYF_EXCO_AFTER_DRWR_ID = function() {
    try {
        ...
        EEHtml.fireEvent(document.MAINFORM.DRWE_CORR_MED, "onchange");
...
csFuncLevelProto.SYF_EXCO_CALL_BILL_INSTR = function() {
    try {
        ...
        if (document.MAINFORM.DELVR_DOC_AGST.value == "D/P") {
            ...
            document.MAINFORM.DOC_INSTR.value = "Irrevocable undertaking to pay at maturity";
...
csFuncLevelProto.SYF_EXCO_CAL_DRWE_CORR_MED_BY_COLL_TYPE = function() {
    try {
        ...
        if (document.MAINFORM.COLL_TYPE.value == "Documentary Through Bank" || document.MAINFORM.COLL_TYPE.value == "Clean Through Bank") {
            ...
            //document.MAINFORM.DRWE_CORR_MED.value = "None"; //Add for Unique test on 20200622
...
csFuncLevelProto.SYF_EXCO_CLASS_BY_TENOR_TYPE = function() {
    try {
        ...
        if (document.MAINFORM.TENOR_TYPE.value == "Fixed Maturity") {
            ...
            SYT_ChangeFldClass(document.MAINFORM.DUE_DT, 'P');
            SYT_ChangeFldClass(document.MAINFORM.DAY_MON_FLG, 'P');
...
csFuncLevelProto.SYF_EXCO_MPO_BY_COLL_TYPE = function() {
    try {
        ...
        if (document.MAINFORM.COLL_TYPE.value == "Documentary Through Bank" || document.MAINFORM.COLL_TYPE.value == "Clean Through Bank") {
            ...
            SYT_ChangeFldClass(document.MAINFORM.DRWE_LANG, 'O');
            SYT_ChangeFldClass(document.MAINFORM.DRWE_CORR_MED, 'O');
        } else {
...
csFuncLevelProto.SYF_EXCO_MPO_INT_DT = function() {
    try {
        ...
        if (document.MAINFORM.INT_FM_PRD.value == "" && document.MAINFORM.INT_TO_PRD.value == "") {
            ...
            SYT_ChangeFldClass(document.MAINFORM.INT_FM_DT, "B"); //64633
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        InitRun();
        // SYF_EXCO_CLASS_BY_COLL_INT_FLAG();MARKED ON 20190202 FOR 64655;
        SYF_EXCO_CLASS_BY_TENOR_TYPE();
...
csFuncLevelProto.FLD_EXCO_DELVR_DOC_AGST_onchange = function(event) {
    try {
        SYF_EXCO_CALL_BILL_INSTR();
        SYF_EXCO_CAL_COMM(); // Utility Auto Fix Comments
        SYF_EXCO_CLASS_BY_DELVR_DOC_AGST();
