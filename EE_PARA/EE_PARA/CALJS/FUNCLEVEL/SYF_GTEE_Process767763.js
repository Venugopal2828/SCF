...
csFuncLevelProto.SYF_GTEE_AMD_DETAILS = function() {
    try {
        ...
        DisExcpt("SYF_GTEE_Process767763.js", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        if (document.MAINFORM.EXPIRY_TYPE.value == 'FIXD') {
            document.MAINFORM.EXPIRY_COND.value = ' ';
        }
        if (document.MAINFORM.EXPIRY_TYPE_LOCAL.value == 'FIXD') {
...
csFuncLevelProto.SYF_GTEE_AMY_TEST = function() {
    try {
...
csFuncLevelProto.SYF_GTEE_CHK_DEC_AMT = function() {
    try {
