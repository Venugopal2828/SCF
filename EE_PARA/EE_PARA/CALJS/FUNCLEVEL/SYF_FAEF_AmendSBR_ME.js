...
csFuncLevelProto.SYF_FAEF_CHECK_POF_LOAN_FIELD = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_AmendSBR_ME.js", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        //SYF_FAEF_Cal_forChildtoMainScreen();--marked for SCF change
    } catch (e) {
        DisExcpt("SYF_FAEF_AmendSBR_ME.js", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        if (!SYF_FAEF_Check_Pending_Invoices()) {
            return false;
        }
...
csFuncLevelProto.SYF_FAEF_Get_FA_LMT_BAL = function() {
    try {
        ...
        if (document.MAINFORM.FA_BUSI_TYPE.value == 'DF') {
            ...
            SYS_GetTableDataByRule_S('Get_FA_LMT_SEL_BAL_1', '1', 'Y');
...
csFuncLevelProto.SYF_FAEF_Check_Pending_Invoices = function() {
    try {
...
csFuncLevelProto.FLD_FAEF_FA_RELATION_STATUS_onchange = function(event) {
    try {
        SYF_FAEF_Check_Pending_Invoices();
    } catch (e) {
        DisExcpt("SYF_FAEF_AmendSBR_ME.js", e);
    }
}
