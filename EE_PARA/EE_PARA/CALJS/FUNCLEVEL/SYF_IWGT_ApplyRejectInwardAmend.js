...
csFuncLevelProto.SYF_IWGT_MPO_ACPT_REJ = function() {
    try {
        ...
        if (document.MAINFORM.ACPT_REJ.value == 'ACCP') {
            ...
            SYT_ChangeFldClass(document.MAINFORM.REJ_REASON, 'O');
        }
    } catch (e) {
        DisExcpt("SYF_IWGT_ApplyRejectInwardAmend.js", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Cal_ACPT_REJ = function() {
    try {
        ...
        //if ACPT_REJ flag is 'Apply' calculate GTEE Balance from INC_AMT or DEC_AMT
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        if (document.MAINFORM.NEW_EXPIRY_RVW_DT.value != "") {
            document.MAINFORM.TEMP_EXPIRY_DT.value = document.MAINFORM.NEW_EXPIRY_RVW_DT.value;
        } else {
...
csFuncLevelProto.FLD_IWGT_ACPT_REJ_onchange = function(event) {
    try {
        ...
        document.MAINFORM.TEMP_ACPT_REJ.value = '/' + document.MAINFORM.ACPT_REJ.value + '/';
    } catch (e) {
        DisExcpt("SYF_IWGT_ApplyRejectInwardAmend.js", e);
    }
}
