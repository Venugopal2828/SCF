...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.AMD_74.value = ''; //FOR BUG 990
        document.MAINFORM.NEW_TENOR_DETAILS.value = ''; //FOR BUG 989
        document.MAINFORM.NEW_TENOR_TYPE.value = ''; //FOR BUG 989
        ...
        DisExcpt("SYF_EXCO_EXCO_AmendorDischarge.js", e);
    }
}
...
csFuncLevelProto.SYF_EXCO_MPO_BY_SEND_AMD_BY = function() {
    try {
        ...
        arr_Fld = new Array(document.MAINFORM.BK_TO_BK_INFO, document.MAINFORM.NARR_MAIL, document.MAINFORM.NARR_TAG_79, document.MAINFORM.AMD_74);
        arr_CLS_999 = new Array("B", "B", "M", "B");
        arr_CLS_430 = new Array("O", "B", "B", "M");
        arr_CLS_Mail = new Array("B", "M", "B", "B");
...
csFuncLevelProto.SYF_EXCO_chk_COLL_TRX_CCY_AMT = function(event) {
    try {
        if (document.MAINFORM.TEMP_COLL_AMT_COLL_CCY.value != document.MAINFORM.COLL_TRX_CCY_AMT.value && document.MAINFORM.DELVR_DOC_AGST.value !='D/P') {

           SYT_ChangeFldClass(document.MAINFORM.DELVR_DOC_AGST, 'M');
        }else{
        	SYT_ChangeFldClass(document.MAINFORM.DELVR_DOC_AGST, 'O');
        }
     } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_AmendorDischarge.js", e);
    }
...
csFuncLevelProto.SYF_EXCO_CLASS_BY_NEW_TENOR_TYPE = function() {
    try {
        ...
        if (document.MAINFORM.NEW_TENOR_TYPE.value == "Fixed Maturity") {
         ...
         } else if (document.MAINFORM.NEW_TENOR_TYPE.value == "") {
            SYT_ChangeFldClass(document.MAINFORM.NEW_TENOR_TYPE, "O");
...
csFuncLevelProto.SYF_EXCO_Chk_TENOR_DT = function() {
    try {

        if (SYS_GetSubDays(document.MAINFORM.COLL_DT.name, document.MAINFORM.NEW_TENOR_START_DT.name) < 0) {
...
csFuncLevelProto.SYF_EXCO_CAL_COLLECTING_BANK = function() {
    try {

        if (document.MAINFORM.COLL_TYPE.value == 'Clean Through Bank') {
            SYT_ChangeFldClass(document.MAINFORM.COLL_BK_ID, "M");
...
csFuncLevelProto.SYF_EXCO_MPO_BY_COLL_TYPE = function() {
    try {
        ...
        if (document.MAINFORM.COLL_TYPE.value == "Documentary Through Bank" || document.MAINFORM.COLL_TYPE.value == "Clean Through Bank") {
            ...
            SYT_ChangeFldClass(document.MAINFORM.DRWE_LANG, 'B');
...
csFuncLevelProto.SYF_EXCO_MT730_59 = function() {
    try {
...
csFuncLevelProto.FLD_EXCO_COLL_BK_ID_onchange = function(event) {
    try {
        SYT_GetCUBK_All('COLL_BK_ID', 'COLL_BK_ID', 'SYF_EXCO_SET_SEND_AMD_BY()');
...
csFuncLevelProto.FLD_EXCO_NEW_DUE_DT_onchange = function(event) {
    try {
        ...
        SYF_EXCO_Chk_TENOR_DT(); //64678 20190225;
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_AmendorDischarge.js", e);
    }
}
