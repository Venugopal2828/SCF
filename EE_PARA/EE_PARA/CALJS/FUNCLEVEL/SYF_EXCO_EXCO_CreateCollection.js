...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        //get ref
        SYS_GetRefNo('EXCO', 'SYF_EXCO_C_MAIN_REF', 'SYF_EXCO_GET_REF_20');
        ...
        document.MAINFORM.TEMP_N90_REF_20.value = document.MAINFORM.COLL_BK_REF.value; //Add on 20190213 64634;
        document.MAINFORM.TEMP_N90_REF_21.value = document.MAINFORM.CUST_REF.value; //Add on 20190213 64634;


        document.MAINFORM.COLL_CCY.value = SYS_LOCAL_CCY;
        ...
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
}
...
csFuncLevelProto.SYF_EXCO_C_MAIN_REF = function(ref) {
    try {
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        //    CHG_allChargeFor_onchange();//Jax 2020/5/11
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
}
...
csFuncLevelProto.SYF_EXCO_CHK_DIRY_DT = function() {
    try {
        ...
        var nDays; // Utility Auto Fix Comments
        if (document.MAINFORM.COLL_DT.value != SYS_BUSI_DATE) {
            alert("The Registration date should be always current date.");
            document.MAINFORM.COLL_DT.value = SYS_BUSI_DATE;
        }
...
csFuncLevelProto.SYF_EXCO_TrackingCheck = function() {
    try {

        var TrackingNumber; // Utility Auto Fix Comments
        TrackingNumber = document.MAINFORM.TRACKING_NUMBER.value;

        if (TrackingNumber != '') {
            document.MAINFORM.INTF_STATUSDESC.value = "";
            document.MAINFORM.ACTIVITIES_XML_B64.value = "";
            document.MAINFORM.TRACKING_INFO.value = "";
            document.MAINFORM.TRACKING_INFO.value = "Tracking " + TrackingNumber + ". Please wait...";

            SYS_InqGapi('PackageTracking', 'SYF_EXCO_TrackingRetSucc()');
        }
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
...
csFuncLevelProto.SYF_EXCO_TrackingRetSucc = function() {
    try {

        var test; // Utility Auto Fix Comments
        test = document.MAINFORM.INTF_STATUSDESC.value;
        test = test.replace(new RegExp(/\\n/g), '\n');
        document.MAINFORM.INTF_STATUSDESC.value = test;
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        if (document.MAINFORM.DELVR_DOC_AGST.value == "D/A and Aval" && document.MAINFORM.DOC_INSTR.value == "Payment") {
        ...
        if (document.MAINFORM.INT_FM_PRD.value != '' && document.MAINFORM.INT_TO_PRD.value == '') {
            alert("Interest To can't be empty!");
            return false;
        }

        if (document.MAINFORM.INT_TO_PRD.value != '' && document.MAINFORM.INT_FM_PRD.value == '') {
            alert("Interest From can't be empty!");
            return false;
        }

        if (document.MAINFORM.INT_TO_DT.value != '' && document.MAINFORM.INT_FM_DT.value == '') {
            alert("Interest From Date can't be empty!");
            return false;
        }

        if (document.MAINFORM.INT_FM_DT.value != '' && document.MAINFORM.INT_TO_DT.value == '') {
            alert("Interest To Date can't be empty!");
            return false;
        }
...
csFuncLevelProto.SYF_EXCO_FREE_PYMT_CLS_FLG = function() {
    try {

        if (document.MAINFORM.DOC_INSTR.value == 'Free of Payment') {
            document.MAINFORM.CLS_FLG.value = 'YES';
            document.MAINFORM.CHG_FLD_ALL_CHARGE_AT.value = 0;
            SYT_ChangeFldClass(document.MAINFORM.REMT_DT, "O");
            ...
            SYT_ChangeFldClass(document.MAINFORM.REMT_DT, "M");
...
csFuncLevelProto.FLD_EXCO_COLL_BK_ID_onchange = function(event) {
    try {
        ...
        EEHtml.fireEvent(document.MAINFORM.COLL_BK_CORR_MED, 'onchange');
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
}
...
csFuncLevelProto.FLD_EXCO_CUST_REF_onchange = function(event) {
    try {
        document.MAINFORM.TEMP_N90_REF_21.value = document.MAINFORM.CUST_REF.value; //Add on 20190213 64634;
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
...
csFuncLevelProto.FLD_EXCO_DELVR_DOC_AGST_onchange = function(event) {
    try {
        ...
        // EEHtml.fireEvent(document.MAINFORM.DAY_MON_FLG, 'onchange'); #64601 use chrome with error;
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
}
...
csFuncLevelProto.FLD_EXCO_DRWE_EMAIL_onchange = function(event) {
    try {
        var email = document.MAINFORM.DRWE_EMAIL.value;
        SYM_EXCO_checkEmailAdd(email);
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
}
...
csFuncLevelProto.FLD_EXCO_DRWR_EMAIL_onchange = function(event) {
    try {
        var email = document.MAINFORM.DRWR_EMAIL.value;
        SYM_EXCO_checkEmailAdd(email);
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
...
csFuncLevelProto.FLD_EXCO_PRES_BK_ID_onchange = function(event) {
    try {
        ...
        EEHtml.fireEvent(document.MAINFORM.PRES_BK_CORR_MED, 'onchange');
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
}
...
csFuncLevelProto.FLD_EXCO_TRACK_PACKAGE_BTN_onclick = function(event) {
    try {
        //SYF_EXCO_TrackingCheck();
    } catch (e) {
        DisExcpt("SYF_EXCO_EXCO_CreateCollection.js", e);
    }
}
