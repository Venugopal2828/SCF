...
csFuncLevelProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*CancelCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        Cal_MSG_TYPE();
        SYF_IWGT_CAL_GOVERN_LAW();
        SYF_IWGT_CAL_GOVERN_LAW_LOCAL();
        if (document.MAINFORM.AUTO_EXTEN_PERIOD.value != '') {
               if (document.MAINFORM.AUTO_EXTEN_PERIOD.value.charAt(0) == '/') {
                    document.MAINFORM.AUTO_EXTEN_PERIOD.value = document.MAINFORM.AUTO_EXTEN_PERIOD.value.substring(1);
                  }
                }
        if (document.MAINFORM.AUTO_EXTEN_PERIOD_LOCAL.value != '') {
               if (document.MAINFORM.AUTO_EXTEN_PERIOD_LOCAL.value.charAt(0) == '/') {
                    document.MAINFORM.AUTO_EXTEN_PERIOD_LOCAL.value = document.MAINFORM.AUTO_EXTEN_PERIOD_LOCAL.value.substring(1);
                  }
                }
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*ConfirmBusinessCall", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        if (!SYF_IWGT_CHK_ADV_BK()) {
            return false;
        }

        return true;
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*ConfirmBusinessCheckSave", e);
    }
}

csFuncLevelProto.InitValues = function() {
    try {
        document.MAINFORM.TEMP_PURP_OF_MESS.value = document.MAINFORM.PURP_OF_MESS.value;    	
        ...
        if (document.MAINFORM.GTEE_TYPE.value == 'Standby') {
            document.MAINFORM.FORM_OF_UNDERTAKING.value = 'STBY';
            document.MAINFORM.PURP_OF_MESS.value = 'ACNF';
        }
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*InitValues", e);
    }
}

csFuncLevelProto.PostconditionOnInit = function() {
    try {
    	  SYF_IWGT_CHK_PURP_OF_MESS();
        onChangeDiary();
        SYF_IWGT_Cal_APLB_RULE();
        SYM_IWGT_CHK_ISSUE_BK_SW_TAG_LOCAL();
        FLD_IWGT_SEND_TO_CORR_MED_onchange();
        ...
        if (document.MAINFORM.PURP_OF_MESS.value == 'ISSU') {
            SYT_ChangeFldClass(document.MAINFORM.ADV_FLG, 'P');
            document.MAINFORM.ADV_FLG.value = '';
            ...
            SYT_ChangeFldClass(document.MAINFORM.ADV_FLG, 'M');
        ...
        SYF_IWGT_Cal24E();
        SYF_IWGT_MPO_AC_WT_BK_NM();
        SYF_IWGT_Risk_Show();
        SYF_IWGT_Cal_Confirm_FLG();
        FLD_IWGT_FORM_OF_UNDERTAKING_onchange();
        FLD_IWGT_CONF_INSTR_onchange();
        if (document.MAINFORM.EXPIRY_TYPE.value == 'OPEN') {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.PreconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*PreconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_AC_BK_SW_TAG = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_AC_BK_SW_TAG", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_CAL_SEND_TO_RECEIVER = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_CAL_SEND_TO_RECEIVER", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_CHK_COMM_DT = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_CHK_COMM_DT", e);
    }
}

csFuncLevelProto.SYF_IWGT_CHK_ADV_BK = function() { 
    try { 
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_CHK_ADV_BK", e); 
    } 
} 
...
csFuncLevelProto.SYF_IWGT_CHK_COMM_END_DT = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_CHK_COMM_END_DT", e);
    }
}

csFuncLevelProto.SYF_IWGT_CHK_PURP_OF_MESS = function() {
    try {
    var PURP=document.MAINFORM.TEMP_PURP_OF_MESS.value;
    switch (PURP) {
        case 'ICCO':
            SYT_RemoveOption('PURP_OF_MESS', 'ACNF'); 
            SYT_RemoveOption('PURP_OF_MESS', 'ADVI'); 
            SYT_RemoveOption('ADV_FLG', 'BENE');
            SYT_RemoveOption('ADV_FLG', '2ADV');
            break;
        case 'ISCO':
            SYT_RemoveOption('PURP_OF_MESS', 'ACNF'); 
            SYT_RemoveOption('PURP_OF_MESS', 'ADVI'); 
            SYT_RemoveOption('PURP_OF_MESS', 'ICCO'); 
            SYT_RemoveOption('PURP_OF_MESS', 'ISCO'); 
            SYT_RemoveOption('ADV_FLG', 'BENE');
            SYT_RemoveOption('ADV_FLG', '2ADV');
            break;
        case 'ISSU':
            SYT_RemoveOption('PURP_OF_MESS', 'ICCO'); 
            SYT_RemoveOption('PURP_OF_MESS', 'ISCO'); 
            SYT_RemoveOption('PURP_OF_MESS', 'ISSU');
            SYT_RemoveOption('ADV_FLG', '1ADV');
            break;
        default: 
            SYT_RemoveOption('PURP_OF_MESS', 'ICCO'); 
            SYT_RemoveOption('PURP_OF_MESS', 'ISCO'); 
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_CHK_PURP_OF_MESS", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_COUNTER_GTEE_FLG = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_COUNTER_GTEE_FLG", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Cal24E = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Cal24E", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Cal_APLB_RULE = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Cal_APLB_RULE", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Cal_Charge_Calculate = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Cal_Charge_Calculate", e);
    }
}

csFuncLevelProto.SYF_IWGT_Cal_Confirm_FLG = function() {
    try {
        if (document.MAINFORM.MTHD_OF_ISS.value == 'Issue' && document.MAINFORM.FORM_OF_UNDERTAKING.value == 'STBY') {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Cal_Confirm_FLG", e);
    }
}

csFuncLevelProto.SYF_IWGT_CAL_GOVERN_LAW = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_CAL_GOVERN_LAW", e);
    }
}

csFuncLevelProto.SYF_IWGT_CAL_GOVERN_LAW_LOCAL = function() {
    try {
...
csFuncLevelProto.SYF_IWGT_Cal_Incoming_Field = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Cal_Incoming_Field", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Cal_TOTAL_ISS_COMM = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Cal_TOTAL_ISS_COMM", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Cal_X768_DATE_30 = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Cal_X768_DATE_30", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Calculate_ISS_COMM_NEW = function() {
    try {
        ...
        var ISS_COMM_HALF_YEAR;
        var ISS_COMM_MONTH;
        var ISS_COMM_QUARTER;
        var ISS_COMM_WEEK;
        var ISS_COMM_YEAR;
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Calculate_ISS_COMM_NEW", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Calculate_ISS_COMM_NEW2 = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Calculate_ISS_COMM_NEW2", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_ChangeFldClass = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_ChangeFldClass", e);
    }
}

csFuncLevelProto.SYF_IWGT_DEFAULT_SEND_TO = function() {
    try {
    	      if(document.MAINFORM.ADV_FLG.value == '2ADV'&& (document.MAINFORM.ISSUE_BY.value == 'MT760'||document.MAINFORM.ISSUE_BY.value == 'Mail') ) {
            document.MAINFORM.SEND_TO_ID.value = document.MAINFORM.ADV_THU_BK_ID.value;
            document.MAINFORM.SEND_TO_ADD1.value = document.MAINFORM.ADV_THU_BK_ADD1.value; 
            document.MAINFORM.SEND_TO_ADD2.value = document.MAINFORM.ADV_THU_BK_ADD2.value; 
            document.MAINFORM.SEND_TO_ADD3.value = document.MAINFORM.ADV_THU_BK_ADD3.value; 
            document.MAINFORM.SEND_TO_SW_ADD.value = document.MAINFORM.ADV_THU_BK_SW_ADD.value; 
            document.MAINFORM.SEND_TO_SW_TAG.value = document.MAINFORM.ADV_THU_BK_SW_TAG.value; 
            document.MAINFORM.SEND_TO_MAIL_ADD.value = document.MAINFORM.ADV_THU_BK_MAIL_ADD.value; 
            document.MAINFORM.SEND_TO_NM.value = document.MAINFORM.ADV_THU_BK_NM.value;
            document.MAINFORM.SEND_TO_CORR_MED.value = document.MAINFORM.ADV_THU_BK_CORR_MED.value;
            document.MAINFORM.SEND_TO.value = 'Bank';
          }else if(document.MAINFORM.ADV_FLG.value == 'BENE'&& document.MAINFORM.ISSUE_BY.value == 'Mail'){
          if(document.MAINFORM.BENE_CUST_BK.value=='Customer'){
            ...
            document.MAINFORM.SEND_TO.value = 'Customer';
          }else if (document.MAINFORM.PURP_OF_MESS.value == 'ISCO' || document.MAINFORM.PURP_OF_MESS.value == 'ICCO') { 
          	document.MAINFORM.SEND_TO_ID.value = document.MAINFORM.BENE_ID_LOCAL.value;
            document.MAINFORM.SEND_TO_ADD1.value = document.MAINFORM.BENE_ADD1_LOCAL.value; 
            document.MAINFORM.SEND_TO_ADD2.value = document.MAINFORM.BENE_ADD2_LOCAL.value; 
            document.MAINFORM.SEND_TO_ADD3.value = document.MAINFORM.BENE_ADD3_LOCAL.value; 
            document.MAINFORM.SEND_TO_NM.value = document.MAINFORM.BENE_NM_LOCAL.value;
          }
          }
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_DEFAULT_SEND_TO", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_FOR_AMEND_DT = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_FOR_AMEND_DT", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_FURTHER = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_FURTHER", e);
    }
}

csFuncLevelProto.SYF_IWGT_MPO_AC_WT_BK_NM = function() {
    try {
        if (document.MAINFORM.SEND_MT768_FLG.value == "Y") {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_MPO_AC_WT_BK_NM", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_MPO_Incoming_Fields = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_MPO_Incoming_Fields", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Part_In_Advance_Comm_Onchange = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Part_In_Advance_Comm_Onchange", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_Risk_Show = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_Risk_Show", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_SET_NO_OF_PERIODS = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_SET_NO_OF_PERIODS", e);
    }
}
...
csFuncLevelProto.SYF_IWGT_getDOdata_AdviceForBankCust = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*SYF_IWGT_getDOdata_AdviceForBankCust", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*addRecordCheck", e);
    }
}
...
csFuncLevelProto.deleteRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*deleteRecordCheck", e);
    }
}
...
csFuncLevelProto.editRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*editRecordCheck", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AC_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AC_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AC_WT_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AC_WT_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AC_WT_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AC_WT_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AC_WT_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AC_WT_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AC_WT_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AC_WT_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AC_WT_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AC_WT_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_SW_ADD_onchange", e);
    }
}
    ...
    try {
        switch (document.MAINFORM.ADV_FLG.value) {
            case '2ADV':
                ...
                SYT_ChangeFldClass(document.MAINFORM.SW_FORM, 'P');
            ...
            case 'BENE':
                ...
                SYT_ChangeFldClass(document.MAINFORM.SW_FORM, 'O')
        ...
        FLD_IWGT_SW_FORM_onchange();
        SYF_IWGT_DEFAULT_SEND_TO();
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_ID_onchange = function(event) {
    try {
        if (document.MAINFORM.ADV_THU_BK_ID.value == '') {
            ...
            SYS_GetCUBK('ADV_THU_BK_ID', 'ADV_THU_BK_ID','SYF_IWGT_DEFAULT_SEND_TO');
        }
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_SW_TAG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_SW_TAG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APLB_RULE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APLB_RULE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPLY_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPLY_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_ADD_ORDERNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_ADD_ORDERNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_CORR_MED1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_CORR_MED1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_CUST_BK_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_CUST_BK_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_EMAIL_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_EMAIL_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_ID_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_ID_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_MAIL_ADD_ORDERNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_MAIL_ADD_ORDERNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_SW_ADD_onchange", e);
    }
}

csFuncLevelProto.FLD_IWGT_AUTO_EXTEN_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AUTO_EXTEN_CODE_onchange", e);
    }
}

csFuncLevelProto.FLD_IWGT_AUTO_EXTEN_CODE_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AUTO_EXTEN_CODE_LOCAL_onchange", e);
    }
}

csFuncLevelProto.FLD_IWGT_AUTO_EXTEN_PERIOD_onchange = function(event) {
    try {
        if (document.MAINFORM.AUTO_EXTEN_PERIOD.value == '' && document.MAINFORM.AUTO_EXTEN_CODE.value == '') {
            document.MAINFORM.AUTO_EXTEN_EXPIRY_DT.value = '';
            SYT_ChangeFldClass(document.MAINFORM.AUTO_EXTEN_EXPIRY_DT, 'P');
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AUTO_EXTEN_PERIOD_onchange", e);
    }
}

csFuncLevelProto.FLD_IWGT_AUTO_EXTEN_PERIOD_LOCAL_onchange = function(event) {
    try {
        if (document.MAINFORM.AUTO_EXTEN_PERIOD_LOCAL.value == '' && document.MAINFORM.AUTO_EXTEN_CODE_LOCAL.value == '') {
            document.MAINFORM.AUTO_EXTEN_EXPIRY_DT_LOCAL.value = '';
            SYT_ChangeFldClass(document.MAINFORM.AUTO_EXTEN_EXPIRY_DT_LOCAL, 'P');
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AUTO_EXTEN_PERIOD_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ADD1_onchange", e);
    }
}

csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ADD1_LOCAL_onchange = function(event) {
    try {
        SYM_IWGT_CHK_AVAL_BK_SW_TAG_LOCAL();
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ADD1_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ADD2_onchange", e);
    }
}

csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ADD2_LOCAL_onchange = function(event) {
    try {
        SYM_IWGT_CHK_AVAL_BK_SW_TAG_LOCAL();
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ADD2_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ADD3_onchange", e);
    }
}

csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ADD3_LOCAL_onchange = function(event) {
    try {
        SYM_IWGT_CHK_AVAL_BK_SW_TAG_LOCAL();
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ADD3_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ID_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ID_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_NM_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_NM_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_SW_ADD_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_SW_ADD_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_ADD_ORDERNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_ADD_ORDERNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_CUST_BK_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_CUST_BK_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_EMAIL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_EMAIL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_ID_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_ID_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_MAIL_ADD_ORDERNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_MAIL_ADD_ORDERNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_AMT_MT768_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_AMT_MT768_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_FLD_ALL_BAL_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_FLD_ALL_BAL_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_FLD_ALL_CHARGE_AT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_FLD_ALL_CHARGE_AT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_FLD_ALL_CHARGE_FOR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_FLD_ALL_CHARGE_FOR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_FLD_COLLECT_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_FLD_COLLECT_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_FLD_LOCAL_CUST_AC_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_FLD_LOCAL_CUST_AC_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_POLICY_onchange = function(event) {
    try {
        ...
        SYF_IWGT_ChangeFldClass();
        //SYM_IWGT_Cal_NXT_COMM_DT();
        EEHtml.fireEvent(document.MAINFORM.COMM_END_DT, "onchange");
        if (document.MAINFORM.CHG_POLICY.value != 'All in Advance' && document.MAINFORM.CHG_POLICY.value != 'Part in Advance' && document.MAINFORM.CHG_POLICY.value != '') {
            var nDays; // Utility Auto Fix Comments
            nDays = SYS_GetSubDays(document.MAINFORM.NXT_COMM_DT.name, document.MAINFORM.COMM_END_DT.name);
            if (nDays <= 0) {
                alert('Next Commission Date should be less than the Commission End Date');
                document.MAINFORM.NXT_COMM_DT.value = '';
                return false;
            } else {
                return true;
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_POLICY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_COMM_BAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_COMM_BAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_COMM_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_COMM_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_COMM_END_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_COMM_END_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_COMM_START_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_COMM_START_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CONF_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CONF_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CONF_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CONF_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CONF_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CONF_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CONF_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CONF_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CONF_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CONF_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CONF_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CONF_BK_SW_ADD_onchange", e);
    }
}

csFuncLevelProto.FLD_IWGT_CONF_INSTR_onchange = function() {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CONF_INSTR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_COUNTR_GTEE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_COUNTR_GTEE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CURRENT_COMM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CURRENT_COMM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_DELIVERY_TO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_DELIVERY_TO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_DELIVERY_TO_AMD_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_DELIVERY_TO_AMD_CODE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_DELIV_OF_ORIG_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_DELIV_OF_ORIG_CODE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_DET_CHG_MT768_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_DET_CHG_MT768_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_DIARY_NARRATIVE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_DIARY_NARRATIVE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_EXPIRY_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_EXPIRY_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_EXPIRY_TYPE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_EXPIRY_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_EXPIRY_TYPE_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_EXPIRY_TYPE_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_FORM_OF_UNDERTAKING_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_FORM_OF_UNDERTAKING_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_GTEE_AMT_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_GTEE_AMT_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_GTEE_BAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_GTEE_BAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_GTEE_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_GTEE_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_INDEMN_ID_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_INDEMN_ID_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_INWARD_RCV_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_INWARD_RCV_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ISSUE_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ISSUE_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ISSUE_BK_ID_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ISSUE_BK_ID_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ISSUE_BK_SW_ADD_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ISSUE_BK_SW_ADD_LOCAL_onchange", e);
    }
}
    ...
    try {
        ...
        switch (document.MAINFORM.ISSUE_BY.value) {
            case 'MT760':
                ...
                document.MAINFORM.SW_FORM.value = 'MT760';
                SYT_ChangeFldClass_New('SW_FORM', 'P');
                SYT_ChangeFldClass_New('SEND_TO_SW_ADD', 'M');
                break;
            case 'Mail':
                SYT_ChangeFldClass_New('NARR_MAIL', 'M');
                SYT_ChangeFldClass_New('GTEE_DETAILS', 'O');
                SYT_ClearFields("GTEE_DETAILS");
                SYT_ChangeFldClass_New('SW_FORM', 'O');
                SYT_ChangeFldClass_New('SEND_TO_SW_ADD', 'O');
                break;
            case 'MT799':
                SYT_ChangeFldClass_New('GTEE_DETAILS_79', 'M');
                SYT_ChangeFldClass_New('GTEE_DETAILS', 'O');
                SYT_ClearFields("GTEE_DETAILS");
                SYT_ChangeFldClass_New('SW_FORM', 'O');
                SYT_ChangeFldClass_New('SEND_TO_SW_ADD', 'O');
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ISSUE_BY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_MTHD_OF_ISS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_MTHD_OF_ISS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_NEW_BENE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_NEW_BENE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_NEW_BENE_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_NEW_BENE_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_NEW_BENE_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_NEW_BENE_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_PURP_OF_MESS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_PURP_OF_MESS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_ADD_ORDERNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_ADD_ORDERNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_EMAIL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_EMAIL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_MAIL_ADD_ORDERNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_MAIL_ADD_ORDERNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_MT768_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_MT768_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_ADD_ORDERNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_ADD_ORDERNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_EMAIL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_EMAIL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_MAIL_ADD_ORDERNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_MAIL_ADD_ORDERNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_STAN_WORD_REQD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_STAN_WORD_REQD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SW_FORM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SW_FORM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_UNDERTAKING_TYPE_LOCAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_UNDERTAKING_TYPE_LOCAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AC_WT_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AC_WT_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AC_WT_BK_NM_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AC_WT_BK_NM_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THRU_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THRU_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ADV_THRU_BK_ID_BTN_LOCAL_onclick = function(event) { 
    try { 
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THRU_BK_ID_BTN_LOCAL_onclick", e); 
    } 
}
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_ADD_BTN_LOCAL_onclick = function(event) { 
    try { 
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_ADD_BTN_LOCAL_onclick", e); 
    } 
} 
...
csFuncLevelProto.FLD_IWGT_ADV_THU_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ADV_THU_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_AC_MRGN_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_AC_MRGN_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_ID_BTN_LOCAL_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_ID_BTN_LOCAL_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_APPL_MAIL_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_APPL_MAIL_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ASSET_ACNO_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ASSET_ACNO_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ADD_BTN_LOCAL_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ADD_BTN_LOCAL_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_AVAL_WT_BK_ID_BTN_LOCAL_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_AVAL_WT_BK_ID_BTN_LOCAL_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_ID_BTN_LOCAL_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_ID_BTN_LOCAL_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_BENE_MAIL_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_BENE_MAIL_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_GETAC_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_GETAC_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CHG_VALUE_DATE_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CHG_VALUE_DATE_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_CONF_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_CONF_BK_ID_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IWGT_ClauseButton_onclick = function(event) {
    try {
        return SYS_InsertClause('GTEE_DETAILS');
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ClauseButton_onclick", e);
    }
}

csFuncLevelProto.FLD_IWGT_ClauseButton2_onclick = function(event) {
    try {
        return SYS_InsertClause('GTEE_DETAILS_79');
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ClauseButton2_onclick", e);
    }
}

csFuncLevelProto.FLD_IWGT_ClauseButton3_onclick = function(event) {
    try {
        return SYS_InsertClause('NARR_MAIL');
    } catch (e) {
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ClauseButton3_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_INDEMN_ID_BTN_LOCAL_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_INDEMN_ID_BTN_LOCAL_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_ISSUE_BK_ID_BTN_LOCAL_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_ISSUE_BK_ID_BTN_LOCAL_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_NEW_BENE_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_NEW_BENE_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_RCV_FM_BK_MAIL_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_RCV_FM_BK_MAIL_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_ADD1_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_ADD1_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_SEND_TO_MAIL_ADD1_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_SEND_TO_MAIL_ADD1_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_button1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_button1_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IWGT_view_1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IWGT_AdviseGuarantee.js*FLD_IWGT_view_1_onclick", e);
    }
}