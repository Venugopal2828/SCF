...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*ConfirmBusinessCall", e);
    }
}

csFuncLevelProto.SYF_FAEF_Chk_PO_LOAN_BAL= function(){
	    try {
        var PO_LOAN_BAL = document.MAINFORM.PO_LOAN_BAL.value;
             if(PO_LOAN_BAL > 0){
             	alert('Please run the PO Financing Return to return the PO loan firstly.');
            }                    
    } catch (e) {
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Chk_PO_LOAN_BAL", e);
    }
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*InitValues", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        SYT_ChangeFldClass(document.MAINFORM.FA_TEMP_AMT8, 'P');
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.PreconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*PreconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_FA_LOAN_CCY = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Cal_FA_LOAN_CCY", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_FA_LOAN_INT_RT = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Cal_FA_LOAN_INT_RT", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_FA_SEL_AC_AMT = function() {
    try {
        ...
        return true;
      	...
      	alert("The invoice loan amount could not cover the PO loan balance, the transaction will terminate.");
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Cal_FA_SEL_AC_AMT", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_FA_TTL_LOAN_BAL = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Cal_FA_TTL_LOAN_BAL", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_RefNo = function(ref) {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Cal_RefNo", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Check_FIN_TYPE = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Check_FIN_TYPE", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_FA_LOAN_PERC = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Chk_FA_LOAN_PERC", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_MAX_LOAN_PERC = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Chk_MAX_LOAN_PERC", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_MultiDebit_MultiCredit_BAL = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Chk_MultiDebit_MultiCredit_BAL", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_RecordStatus = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Chk_RecordStatus", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_ReqLoanAmt = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Chk_ReqLoanAmt", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_ReqLoanAmt_submit = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Chk_ReqLoanAmt_submit", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_FA_BPOINV_LOAN_ID = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_FA_BPOINV_LOAN_ID", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_FA_TEMP_AMT10 = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_FA_TEMP_AMT10", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_GUID = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_GUID", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_GetExchangeRate = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_GetExchangeRate", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_GetSBRLimitBal = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_GetSBRLimitBal", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_BaseDay_CCYDec = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Get_BaseDay_CCYDec", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_DOC_CCY = function() {
    try {
        ...
        if (document.MAINFORM.FA_BUSI_TYPE.value == 'PF' || document.MAINFORM.FA_BUSI_TYPE.value == 'RD' || document.MAINFORM.FA_BUSI_TYPE.value == 'POF') {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Get_DOC_CCY", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_ratetype = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_Get_ratetype", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_LoadDoComplete = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_LoadDoComplete", e);
    }
}
    ...
    try {
      ...
      //  minus_rebate = SYS_FloatSub(IntSum, rebate);
       minus_rebate = SYT_AmtFormat(document.MAINFORM.FA_DOC_CCY.value,SYS_FloatSub(IntSum, rebate));//zoe
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_MLDC_SetDebitCreditData", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_MLDC_SetDebitCreditData_POF = function() {
    ...
    if(C_LEN > 0){
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_MLDC_SetDebitCreditData_POF", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_MPO_ControlInterestChgTypeAndLoanCcy = function(flag) {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_MPO_ControlInterestChgTypeAndLoanCcy", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_MPO_Financing_back = function(tag) {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_MPO_Financing_back", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_getDOdata_InvFinance = function() {
    try {
      ...
      if(busi_tp=='RD'||busi_tp =='PF'){
        SYS_GetDataForDO_S("GET_InvFinance_CE", "A", false, '', "InvFinance");

       }
       else if(busi_tp=='POF'){
       	SYS_GetDataForDO_S("GET_POFInvFinance_CE", "A", false, '', "InvFinance");
      }
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FAEF_getDOdata_InvFinance", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_CPYT_PAY_COV_MSG_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_CPYT_PAY_COV_MSG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_DOC_CCY_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_DOC_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_FIN_TYPE_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_FIN_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_IRT_SPREAD_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_IRT_SPREAD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_LOAN_CCY_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_LOAN_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_LOAN_PERC_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_LOAN_PERC_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_PAID_INT_SUM_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_PAID_INT_SUM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_PMT_GRC_DAY_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_PMT_GRC_DAY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_TEMP_AMT8_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_TEMP_AMT8_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_TTL_LOAN_AMT_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_FA_TTL_LOAN_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_XBOR_RT_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FAEF_XBOR_RT_onchange", e);
    }
}
...
csFuncLevelProto.SYF_FADA_CHECK_BUSI_TYPE_FIELD = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js", e);
    }
}

csFuncLevelProto.FLD_PO_NO_onchange = function() {
    try {
    	        if (document.MAINFORM.FA_BUSI_TYPE.value == 'POF') {
SYS_GetCUBK('Get_PO_NO_INVFIN', document.MAINFORM.PO_NO.name);

}

    } catch (e) {
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_PO_NO_onchange", e);
    }
}


csFuncLevelProto.FLD_FADA_lookup1_onclick = function() {
    try {
        SYF_FADA_Get_PO_NO();
    } catch (e) {
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*FLD_FADA_lookup1_onclick", e);
    }
}

csFuncLevelProto.SYF_FADA_Get_PO_NO = function() {
    try {
        SYS_InqCUBK_byCondition('Get_PO_NO_INVFIN', '1');
    } catch (e) {
        DisExcpt("SYF_FAEF_ProcessFinancingFromCE.js*SYF_FADA_Get_PO_NO", e);
    }
}