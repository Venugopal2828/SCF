...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYT_CCY_AMT(document.MAINFORM.FA_LOAN_CCY.value, document.MAINFORM.FA_TTL_LOAN_AMT.value);
        SYT_ChangeFldClass(document.MAINFORM.FA_LOAN_CCY, 'P');
        SYT_ChangeFldClass(document.MAINFORM.FA_TTL_LOAN_AMT, 'P');
        SYT_ChangeFldClass(document.MAINFORM.FA_LOAN_EXCH, 'P');
        SYT_ChangeFldClass(document.MAINFORM.FA_LOAN_VAL_DT, 'P');
        SYT_ChangeFldClass(document.MAINFORM.FA_LOAN_DUE_DT, 'P');
    } catch (e) {
        DisExcpt("SYF_ABLF_ProcessFinancingRequest.js", e);
    }
}
