...
csFuncLevelProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*CancelCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*ConfirmBusinessCall", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*InitValues", e);
    }
}
...
csFuncLevelProto.LoadDODataOnInit = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*LoadDODataOnInit", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        SYT_ChangeFldClass(document.MAINFORM.APPL_BK_ID, 'O');
        SYT_ChangeFldClass(document.MAINFORM.APPL_BK_NM, 'O');
        SYT_ChangeFldClass(document.MAINFORM.APPL_BK_ADD1, 'O');
        SYT_ChangeFldClass(document.MAINFORM.APPL_BK_ADD2, 'O');
        SYT_ChangeFldClass(document.MAINFORM.APPL_BK_ADD3, 'O');
        SYT_ChangeFldClass(document.MAINFORM.APPL_BK_CORR_MED, 'O');
        SYT_ChangeFldClass(document.MAINFORM.APPL_BK_REF, 'O');
        SYT_ChangeFldClass(document.MAINFORM.APPL_BK_AC_NO, 'O');
        ...
        document.MAINFORM.NEW_BENE_AC_OFF_CD.value = document.MAINFORM.BENE_AC_OFF_CODE.value;
        SYF_IPLC_Change_SameAsApplicant();
        SYF_IPLC_Cal_SameAsApplicant_2();
        SYF_IPLC_Chk_NEW_AVAL_BY_POST();
        FLD_IPLC_NEW_REIM_BK_CORR_MED_onchange();
        document.MAINFORM.ISSUE_BK_SW_ADD.value = '';
        SYF_IPLC_CAL_Tolerance();
        SYF_IPLC_Change_NEW_APLB_RULE();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_APPL_ID_back = function() {
    try {
        ...
        SYF_IPLC_Applicant_ID();
        SYM_IPLC_CAL_APPL_ADD_back();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_APPL_ID_back", e);
    }
}

csFuncLevelProto.SYF_IPLC_Applicant_ID = function() {
    try {
        SYS_GetCUBK('APPL_ID', document.MAINFORM.APPL_ID.name, 'SYF_IPLC_Charge()');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Applicant_ID", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_APPL_ID_inFUNC = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CAL_APPL_ID_inFUNC", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_FORACOF_ID_inFUNC = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CAL_FORACOF_ID_inFUNC", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_NEW_LC_BAL = function() {
    try {
        ...
        if (POS_TOL > 0 || INC_AMT > 0 || DEC_AMT > 0) {
            ...
            NEW_LC_BAL = lc_bal_new * (1 + POS_TOL / 100);
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CAL_NEW_LC_BAL", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_TEMP_FIELDS = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CAL_TEMP_FIELDS", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_Temp_Tolerance = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CAL_Temp_Tolerance", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_Tolerance = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CAL_Tolerance", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHECK_52_50B = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CHECK_52_50B", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_INC_DEC_AMT = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CHK_INC_DEC_AMT", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_NEW_DATES = function() {
    try {
        ...
        if (document.MAINFORM.NEW_EXPIRY_DT.value != '') {
            nDays4 = SYS_GetSubDays(document.MAINFORM.ISSUE_DT.name, document.MAINFORM.NEW_EXPIRY_DT.name);
            if (nDays4 < 0) {
                SYS_CheckError(document.MAINFORM.NEW_EXPIRY_DT, "The New Expiry Date must be later than LC Issue Date.");
                document.MAINFORM.NEW_EXPIRY_DT.value = '';
            }
        }
        if (document.MAINFORM.NEW_EXPIRY_DT.value != '' && document.MAINFORM.MAST_EXPIRY_DT.value != '') {
            nDays5 = SYS_GetSubDays(document.MAINFORM.MAST_EXPIRY_DT.name, document.MAINFORM.NEW_EXPIRY_DT.name);
            if (nDays5 > 0) {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CHK_NEW_DATES", e);
    }
}

csFuncLevelProto.SYF_IPLC_CHK_NEW_PRES_DAYS = function() {
    try {
        var NEW_PRES_DAYS; // Utility Auto Fix Comments
        var days; // Utility Auto Fix Comments
        NEW_PRES_DAYS = document.MAINFORM.AMD_PRES_DAYS.value;
        days = SYS_GetSubDays(document.MAINFORM.NEW_LTST_SHIP_DT.name, document.MAINFORM.EXPIRY_DT.name);
        if (document.MAINFORM.NEW_LTST_SHIP_DT.value != '') {
            if (NEW_PRES_DAYS != days) {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CHK_NEW_PRES_DAYS", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_NEW_SHIP_PRD = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_CHK_NEW_SHIP_PRD", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_DetrimentalAMT = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Cal_DetrimentalAMT", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_IPLC_OPEN_COMM_DEF = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Cal_IPLC_OPEN_COMM_DEF", e);
    }
}

csFuncLevelProto.SYF_IPLC_Cal_NEW_PRES_PRD_TXT = function() {
    try {
        var NEW_PRES_DAYS; // Utility Auto Fix Comments
        var NEW_PRES_TYPE; // Utility Auto Fix Comments
        NEW_PRES_DAYS = SYS_BeInt(document.MAINFORM.AMD_PRES_DAYS.value);
        NEW_PRES_TYPE = document.MAINFORM.AMD_PRES_TYPE.value;
        if (NEW_PRES_TYPE != '') {
            document.MAINFORM.AMD_PRES_PRD_TXT.value = NEW_PRES_DAYS + '/' + NEW_PRES_TYPE;
        } else {
            document.MAINFORM.AMD_PRES_PRD_TXT.value = '';
        }
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Cal_NEW_PRES_PRD_TXT", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_SameAsApplicant_2 = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Cal_SameAsApplicant_2", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_TEMP_EXPIRY_PLC_NARR = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Cal_TEMP_EXPIRY_PLC_NARR", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_clear_Amd_contents = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Cal_clear_Amd_contents", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_temp_amd_no_b = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Cal_temp_amd_no_b", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_AMD_CHG_PAY_BY = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_AMD_CHG_PAY_BY", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_APLB_RULE = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_APLB_RULE", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_EXPIRY_PLC = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_EXPIRY_PLC", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_NEW_APLB_RULE = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_NEW_APLB_RULE", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_NEW_EXPIRY_PLC = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_NEW_EXPIRY_PLC", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_NEW_PARTIAL_SHIP = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_NEW_PARTIAL_SHIP", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_NEW_TNSHIP = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_NEW_TNSHIP", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_PARTIAL_SHIP = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_PARTIAL_SHIP", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_SameAsApplicant = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_SameAsApplicant", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_TNSHIP = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Change_TNSHIP", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Charge = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Charge", e);
    }
}

csFuncLevelProto.SYF_IPLC_Chg_SWIFT_IPLC = function() {
    try {
        var arr; // Utility Auto Fix Comments
        arr = ['SWIFT_CHG'];
        Chg.calculate(arr, document.MAINFORM.LC_CCY.value, document.MAINFORM.LC_AMT.value);
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Chg_SWIFT_IPLC", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Chk_AVAL_BY = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Chk_AVAL_BY", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Chk_NEW_AVAL_BY = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Chk_NEW_AVAL_BY", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Chk_NEW_AVAL_BY_POST = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Chk_NEW_AVAL_BY_POST", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_FORACOF_CHG_back = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_FORACOF_CHG_back", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_FORACOF_ID_back = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_FORACOF_ID_back", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_MT798_FLAG = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_MT798_FLAG", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_NARRATIVE = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_NARRATIVE", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_NEW_58 = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_NEW_58", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_NEW_AVAL_BY_class = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_NEW_AVAL_BY_class", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_NO_OF_DRAW = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_NO_OF_DRAW", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Tenor_Narrative = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_Tenor_Narrative", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_getDOdata_AdviceForBankCust = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*SYF_IPLC_getDOdata_AdviceForBankCust", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*addRecordCheck", e);
    }
}
...
csFuncLevelProto.deleteRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*deleteRecordCheck", e);
    }
}
...
csFuncLevelProto.editRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*editRecordCheck", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_ADDIT_CONDITION_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_ADDIT_CONDITION_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_CHG_PAY_BY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_CHG_PAY_BY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_DESC_OF_GOODS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_DESC_OF_GOODS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_DOC_REQ_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_DOC_REQ_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_PRES_DAYS_onchange = function(event) {
    try {
        ...
        SYF_IPLC_Cal_NEW_PRES_PRD_TXT();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_PRES_DAYS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPLY_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPLY_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_BY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_BY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_OPT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_OPT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_AC_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_BENE_AC_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_BENE_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_BENE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_BENE_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_BENE_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_BAL_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CHG_FLD_ALL_BAL_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_CHARGE_AT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CHG_FLD_ALL_CHARGE_AT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_CHARGE_FOR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CHG_FLD_ALL_CHARGE_FOR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_COLLECT_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CHG_FLD_COLLECT_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_LOCAL_CUST_AC_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CHG_FLD_LOCAL_CUST_AC_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CONF_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CONF_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DEC_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DEC_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DEF_PMT_DET_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DEF_PMT_DET_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DETRMNTL_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DETRMNTL_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DIARY_NARRATIVE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DIARY_NARRATIVE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRAFTS_AT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRAFTS_AT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRWE_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRWE_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRWE_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRWE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRWE_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRWE_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRWE_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_FORACOF_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_FORACOF_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INC_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_INC_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ISSUE_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ISSUE_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ISSUE_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ISSUE_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ISSUE_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ISSUE_BK_SW_ADD_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_ISSUE_BK_SW_TAG_onchange = function(event) {
    try {
        SYM_IPLC_CHK_ISSUE_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ISSUE_BK_SW_TAG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_MIX_PMT_DETL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_MIX_PMT_DETL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_ADV_THU_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_ADV_THU_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_ADV_THU_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_ADV_THU_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_ADV_THU_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_ADV_THU_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AMT_SPEC_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AMT_SPEC_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_APLB_RULE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_APLB_RULE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_APLB_RULE_NARR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_APLB_RULE_NARR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_APPL_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_APPL_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AVAL_BY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_BY_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ADD1_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_AVAL_WT_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_ADD1_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ADD2_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_AVAL_WT_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_ADD2_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ADD3_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_AVAL_WT_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_OPT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_OPT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ACNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_BENE_ACNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_BENE_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_BENE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_BENE_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_BENE_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_CONF_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_CONF_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_CONF_BK_ADD3_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ID_onchange = function(event) {
    try {
        SYM_IPLC_NEW_CAL_CONF_BK_ID();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_CONF_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_CONF_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_CONF_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_CONF_INSTR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_CONF_INSTR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_DRWE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_DRWE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_DRWE_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_DRWE_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_EXPIRY_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_EXPIRY_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_EXPIRY_PLC_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_EXPIRY_PLC_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_LC_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_LC_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_LC_BAL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_LC_BAL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_LTST_SHIP_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_LTST_SHIP_DT_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_NEG_TOL_onchange = function(event) {
    try {
        SYF_IPLC_CAL_Temp_Tolerance();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_NEG_TOL_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_PARTIAL_SHIP_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_PARTIAL_SHIP_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_POS_TOL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_POS_TOL_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ADD1_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_REIM_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_ADD1_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ADD2_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_REIM_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_ADD2_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ADD3_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_REIM_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_AUTH_REQ_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_AUTH_REQ_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_ID_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_NM_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_REIM_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_SW_ADD_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_SHIP_PRD_onchange = function(event) {
    try {} catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_SHIP_PRD_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_TENOR_DAYS_onchange = function(event) {
    try {
        FLD_IPLC_NEW_AVAL_BY_onchange();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_TENOR_DAYS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_TENOR_TYPE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_TENOR_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_TNSHIP_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_TNSHIP_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NON_BANK_ISSUER_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NON_BANK_ISSUER_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PARTIAL_SHIP_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_PARTIAL_SHIP_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_AUTH_REQ_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_AUTH_REQ_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_SAME_AS_APPL_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_SAME_AS_APPL_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_TENOR_DAYS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_TENOR_DAYS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_TENOR_TYPE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_TENOR_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_TNSHIP_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_TNSHIP_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THRU_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THRU_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ADV_THU_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_ADDIT_CONDITION_CLAUSE_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_ADDIT_CONDITION_CLAUSE_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_CHARGES_CLAUSE_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_CHARGES_CLAUSE_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_DOC_REQ_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_DOC_REQ_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_GOOD_DESC_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_GOOD_DESC_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_INSTR_TO_PAY_BK_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_INSTR_TO_PAY_BK_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AMD_SEND_TO_RCV_INFO_CLAUSE_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AMD_SEND_TO_RCV_INFO_CLAUSE_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_APPL_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVAL_WT_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVLBL_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_AVLBL_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_BENE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_BENE_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_BENE_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_GETAC_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CHG_GETAC_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_VALUE_DATE_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CHG_VALUE_DATE_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CONF_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_CONF_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRWE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRW_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_DRW_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_FORACOF_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_FORACOF_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_FORACOF_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_ISSUE_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_ADV_THRU_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_ADV_THRU_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_ADV_THU_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_APPL_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_APPL_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVAL_WT_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AVLBL_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_AVLBL_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_BENE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_BENE_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_BENE_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_CONF_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_DRWE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_DRWE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_DRWE_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_DRWE_ID_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ADD_BTN_onclick = function(event) {
    try {
        SYM_IPLC_CAL_NEW_REIM_BK_MULT_ADD();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NEW_REIM_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NON_BANK_ISSUER_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_NON_BANK_ISSUER_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_REIM_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_view_1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendment.js*FLD_IPLC_view_1_onclick", e);
    }
}