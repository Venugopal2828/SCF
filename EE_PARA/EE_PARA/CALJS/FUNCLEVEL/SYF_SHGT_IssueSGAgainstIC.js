...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYT_Cal_LOCAL_AMT('SG_CCY', 'SG_BAL', 'LOCAL_CCY', 'LOCAL_AMT', 'LOCAL_RATE');
        SYT_Cal_CHG_FLD_LOCAL_CUST_CCY();
    } catch (e) {
        DisExcpt("SYF_SHGT_IssueSGAgainstIC.js", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        SYM_SHGT_CHG_mapLocal_Foreign_Cust_IC();
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        SYT_CHG_VOUCHER();
        SYT_LIAB_VOUCHER();
        document.MAINFORM.CURRNT_STATUS.value = 'SG Issue IC';
    } catch (e) {
        DisExcpt("SYF_SHGT_IssueSGAgainstIC.js", e);
    }
}
...
csFuncLevelProto.FLD_SHGT_INV_AMT_onchange = function(event) {
    try {
        if (SYS_BeFloat(document.MAINFORM.INV_AMT.value) < 0) {
            alert("Invoice amt should not be negative");
        ...
        if (SYS_BeFloat(document.MAINFORM.INV_AMT.value) > SYS_BeFloat(document.MAINFORM.SG_AMT.value)) {
            alert("Invoice CCY and Amt should not be greater than SG amount");
            document.MAINFORM.INV_AMT.value = 0;
        }
    } catch (e) {
        DisExcpt("SYF_SHGT_IssueSGAgainstIC.js", e);
...
csFuncLevelProto.FLD_SHGT_SG_BAL_onchange = function(event) {
    try {
        SYT_Cal_LOCAL_AMT('SG_CCY', 'SG_BAL', 'LOCAL_CCY', 'LOCAL_AMT', 'LOCAL_RATE');
    } catch (e) {
        DisExcpt("SYF_SHGT_IssueSGAgainstIC.js", e);
