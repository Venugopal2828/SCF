...
csFuncLevelProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*CancelCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*ConfirmBusinessCall", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*InitValues", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        /*document.MAINFORM.CLOSE_FLG.style.visibility = 'hidden';
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Init_CLS_FLG = function() {
    try {
        ...
        if (amd_type == "Release Free of Payment" || amd_type == "Close File and return documents") {
            document.MAINFORM.CLOSE_FLG.value = "Yes";
        }else{
            document.MAINFORM.CLOSE_FLG.value = "No";
        }
    } catch (e) {
...
csFuncLevelProto.SYF_IMCO_MPO_BY_AMD_TYPE = function() {
    try {
        ...
        if (amd_type == "Release Free of Payment") {
            document.MAINFORM.CLOSE_FLG.style.visibility = 'visible';
            SYT_ChangeFldClass(document.MAINFORM.CLOSE_FLG, 'M');
            EEHtml.getElementById('CLS').style.display = "block";
        }

        if (amd_type == "Close File and return documents") {
            SYT_ChangeFldClass(document.MAINFORM.CLOSE_FLG, 'O');
            document.MAINFORM.CLOSE_FLG.style.visibility = 'hidden';
            EEHtml.getElementById('CLS').style.display = "none";
        }
    } catch (e) {
...
csFuncLevelProto.SYF_IMCO_CAL_TENOR_33K = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_CAL_TENOR_33K", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_CHK_PRES_BK_REF = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_CHK_PRES_BK_REF", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_CLASS_BY_TENOR_TYPE = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_CLASS_BY_TENOR_TYPE", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_CLASS_BY_TENOR_TYPE_OLD = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_CLASS_BY_TENOR_TYPE_OLD", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_COURIER_FEE_CHG1 = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_COURIER_FEE_CHG1", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_MT4XX_32A_FLG = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Cal_MT4XX_32A_FLG", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_MT4XX_33A_FLG = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Cal_MT4XX_33A_FLG", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_NEW_COLL_AMT = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Cal_NEW_COLL_AMT", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_NO_OF_AMD = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Cal_NO_OF_AMD", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_REMIT_BK_NM = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Cal_REMIT_BK_NM", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Charge = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Charge", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Chk_INC_DEC_AMT = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Chk_INC_DEC_AMT", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Chk_TENOR_DT = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Chk_TENOR_DT", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_DRWR_ID_B = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_DRWR_ID_B", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_DRWR_NM_Z = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_DRWR_NM_Z", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_DRW_ID = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_DRW_ID", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Field = function() {
    ...
    if(oTAG_79.value.length >0)	SYS_CheckTextAreaLength(oTAG_79);
    */
    } catch (e) {
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Field", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Get_REMIT_BK_ID = function() {
    try {
        ...
        if (document.MAINFORM.REMIT_BK_SW_ADD.value.length == 11 || document.MAINFORM.REMIT_BK_SW_ADD.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_IMCO_Process_MT430_SYF_IMCO_Get_REMIT_BK_ID_0', '1', true);
            if (document.MAINFORM.REMIT_BK_ID.value != '') {
                SYS_GetCUBK('REMIT_BK_ID', 'REMIT_BK_ID', 'SYF_IMCO_REMIT_BK_ID_B()');
            }
        }
    } catch (e) {
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Get_REMIT_BK_ID", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_MAT_DT_back = function(matdt) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_MAT_DT_back", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_NEW_DRWE_CORR_MED = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_NEW_DRWE_CORR_MED", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_NEW_DRWE_ID_B = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_NEW_DRWE_ID_B", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_NEW_DRWE_ID_B2 = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_NEW_DRWE_ID_B2", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_NEW_DRWE_NM_Z = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_NEW_DRWE_NM_Z", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_New_Tenor = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_New_Tenor", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_PRES_BK_ID = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_PRES_BK_ID", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_REMIT_BK_ID_B = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_REMIT_BK_ID_B", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Remit_Charge = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_Remit_Charge", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_TENOR_DAY = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_TENOR_DAY", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_TENOR_START_DT_OLD = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_TENOR_START_DT_OLD", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_checkChgUnpaid = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_checkChgUnpaid", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_getDOdata_AdviceForBankCust = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*SYF_IMCO_getDOdata_AdviceForBankCust", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*addRecordCheck", e);
    }
}
...
csFuncLevelProto.deleteRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*deleteRecordCheck", e);
    }
}
...
csFuncLevelProto.editRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*editRecordCheck", e);
    }
}

csFuncLevelProto.FLD_IMCO_AMD_DT_onchange = function(event) {
    try {
        if (SYS_GetSubDays(document.MAINFORM.REG_DT.name, document.MAINFORM.AMD_DT.name) < 0) {
            alert("Amendment Date is not allowed in the past times!");
            document.MAINFORM.AMD_DT.value = '';
        }
    } catch (e) {
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_AMD_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_AMD_TYPE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_AMD_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_ALL_BAL_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_CHG_FLD_ALL_BAL_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_ALL_CHARGE_AT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_CHG_FLD_ALL_CHARGE_AT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_ALL_CHARGE_FOR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_CHG_FLD_ALL_CHARGE_FOR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_COLLECT_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_CHG_FLD_COLLECT_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_LOCAL_CUST_AC_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_CHG_FLD_LOCAL_CUST_AC_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DIARY_NARRATIVE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DIARY_NARRATIVE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DRWR_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DRWR_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DRWR_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DRWR_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_MAIL_METHOD_1ST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_MAIL_METHOD_1ST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_MAIL_METHOD_2ND_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_MAIL_METHOD_2ND_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_COL_AMT_NCOL_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_COL_AMT_NCOL_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DAY_MON_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DAY_MON_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DELVR_DOC_AGST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DELVR_DOC_AGST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DRWE_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DRWE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DRWE_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DRWE_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DUE_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DUE_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_TENOR_DAYS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_TENOR_DAYS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_TENOR_EVENT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_TENOR_EVENT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_TENOR_START_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_TENOR_START_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_OUR_ROLE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_OUR_ROLE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_CHG_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_CHG_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_COR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_COR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_SHIP_FM_CNTY_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_SHIP_FM_CNTY_CODE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_SHIP_TO_CNTY_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_SHIP_TO_CNTY_CODE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_GETAC_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_CHG_GETAC_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_VALUE_DATE_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_CHG_VALUE_DATE_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DRWR_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DRWR_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DRWR_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRW_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_DRW_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DRWE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DRWE_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRW_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_NEW_DRW_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_PRES_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_REMIT_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_button1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_button1_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_view_1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_Process_MT430.js*FLD_IMCO_view_1_onclick", e);
    }
}