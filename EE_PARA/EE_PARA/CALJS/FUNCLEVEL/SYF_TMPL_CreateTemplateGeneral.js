...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.TEMP_TYPE.value = 'General Template';
    } catch (e) {
        DisExcpt("SYF_TMPL_CreateTemplateGeneral.js*InitValues", e);
    }
}
...
csFuncLevelProto.SYF_TMPL_GET_Customer_ID = function() {
    try {
        ...
        DisExcpt("SYF_TMPL_CreateTemplateGeneral.js*SYF_TMPL_GET_Customer_ID", e);
    }
}
...
csFuncLevelProto.loadTemplateDropdownInit= function(richEditorID) {
   ...
   SYS_GetRichTextMappingFields(richEditorID, templateType);
        ...
        DisExcpt("SYF_TMPL_CreateTemplateGeneral.js*loadTemplateDropdownInit", e);
    }
}
...
csFuncLevelProto.SYF_TMPL_SetRefNo = function(ref) {
    try {
        ...
        DisExcpt("SYF_TMPL_CreateTemplateGeneral.js*SYF_TMPL_SetRefNo", e);
    }
}
...
/*csFuncLevelProto.FLD_TMPL_ACTIVE_FLAG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_TMPL_CreateTemplateGeneral.js*FLD_TMPL_ACTIVE_FLAG_onchange", e);
    }
}*/
...
csFuncLevelProto.FLD_TMPL_CUST_SPEC_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_TMPL_CreateTemplateGeneral.js*FLD_TMPL_CUST_SPEC_onchange", e);
    }
}
...
csFuncLevelProto.FLD_TMPL_CUST_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_TMPL_CreateTemplateGeneral.js*FLD_TMPL_CUST_ID_BTN_onclick", e);
    }
}