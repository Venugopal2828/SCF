...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        DisExcpt("SYF_BPOM_AdviceBPO.js", e);
    }
}
...
csFuncLevelProto.SYF_BPOM_CAL_CONF_BAL = function() {
    try {
        ...
        if (pct != '' && pct != null) {
            conf_bal = ttl_net_amt * pct / 100;
            document.MAINFORM.CONF_BAL.value = SYT_AmtFormat(document.MAINFORM.TSU_TTL_NET_CCY.value, conf_bal);
        }
    } catch (e) {
        DisExcpt("SYF_BPOM_AdviceBPO.js", e);
    }
...
csFuncLevelProto.SYF_BPOM_CAL_LIAB_ACNO = function() {
    try {
        ...
        if (document.MAINFORM.CONF_ADDED.value == 'Yes') {
            SYS_GetTableDataByRule_S('SYF_BPOM_AdviceBPO_SYF_BPOM_CAL_LIAB_ACNO_0', '1', 'Y');
...
csFuncLevelProto.LoadDODataOnInit = function() {
    try {
        ...
        if (xDO) {
            commList = "BPOM_CONFIRM,BPOM_EX_HANDLING,BPOM_OTHER";
...
csFuncLevelProto.SYF_BPOM_Chg_BPOM_CONFIRM = function() {
    try {
        ...
        arr = ['BPOM_CONFIRM'];
        amt = EEHtml.getElementById('CONF_BAL').value;
...
csFuncLevelProto.SYF_BPOM_MPO_CONF_PCT = function() {
    try {
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        document.MAINFORM.BUSI_STATUS.value = 'Export Advice';
    } catch (e) {
        DisExcpt("SYF_BPOM_AdviceBPO.js", e);
    }
}
...
csFuncLevelProto.FLD_BPOM_CONF_BAL_onchange = function(event) {
    try {
        SYF_BPOM_Chg_BPOM_CONFIRM();
    } catch (e) {
        DisExcpt("SYF_BPOM_AdviceBPO.js", e);
