...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_EPLC_EPLC_Reinstate_LC.js", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        //set back confirmation balance
        /*
if (document.MAINFORM.CONF_BAL_TEMP.value!=0){
document.MAINFORM.CONF_BAL.value = document.MAINFORM.CONF_BAL_TEMP.value;
document.MAINFORM.CONF_BAL_TEMP.value = 0;
}
*/
        document.MAINFORM.LC_BAL.value = document.MAINFORM.OLD_LC_BAL.value;
        document.MAINFORM.LIAB_BAL.value = document.MAINFORM.OLD_LIAB_BAL.value;
        document.MAINFORM.CONF_BAL.value = document.MAINFORM.OLD_CONF_BAL.value;
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_Reinstate_LC.js", e);
    }
}
