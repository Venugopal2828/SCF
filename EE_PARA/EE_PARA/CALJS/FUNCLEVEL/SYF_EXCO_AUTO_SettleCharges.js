...
csFuncLevelProto.SYF_EXCO_CAL_FOREN_RT = function() {
    try {
        ...
        DisExcpt("SYF_EXCO_AUTO_SettleCharges.js", e);
    }
}
...
csFuncLevelProto.SYF_EXCO_Get_DRWR_MAIL_ADD = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_EXCO_AUTO_SettleCharges_SYF_EXCO_Get_DRWR_MAIL_ADD_0', '1');
    } catch (e) {
        DisExcpt("SYF_EXCO_AUTO_SettleCharges.js", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        if (SYS_FUNCTION_TYPE != 'RE' && SYS_FUNCTION_TYPE != 'IQ' && SYS_FUNCTION_TYPE != 'EC') {
            ...
            SYF_EXCO_ContralChgAt();
        }
        /*For SMBC Only*/
        document.MAINFORM.CHG_LOCAL_CUST_PAY_RATE.value = 0.7767;
        document.MAINFORM.CHG_FLD_LOCAL_CUST_CCY.value = 'EUR';
        document.MAINFORM.CHG_FLD_LOCAL_CUST_AC_NO.value = '987987SUNNY';
        FLD_EXCO_CHG_FLD_LOCAL_CUST_AC_NO_onchange();
