...
csFuncLevelProto.InitValues = function() {
    try {
        //document.MAINFORM.TEMP_TYPE.value = 'Documents Required';
        document.MAINFORM.TEMP_FLG1.value = document.MAINFORM.CE_CUSTOMER.value;
    } catch (e) {
        DisExcpt("SYF_TMPL_EditTemplateGeneral.js*InitValues", e);
    }
}
...
csFuncLevelProto.loadTemplateDropdownInit= function(richEditorID) {
   ...
   SYS_GetRichTextMappingFields(richEditorID, templateType);
        ...
        DisExcpt("SYF_TMPL_EditTemplateGeneral.js*loadTemplateDropdownInit", e);
    }
}
...
csFuncLevelProto.SYF_TMPL_GET_Customer_ID = function() {
    try {
        ...
        DisExcpt("SYF_TMPL_EditTemplateGeneral.js*SYF_TMPL_GET_Customer_ID", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    ...
    if(document.MAINFORM.TEMP_FLG1.value!=document.MAINFORM.CE_CUSTOMER.value && document.MAINFORM.CE_CUSTOMER.value=='Both'){
        ...
        DisExcpt("SYF_TMPL_EditTemplateGeneral.js*ConfirmBusinessCall", e);
    }
}
...
/*csFuncLevelProto.FLD_TMPL_ACTIVE_FLAG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_TMPL_EditTemplateGeneral.js*FLD_TMPL_ACTIVE_FLAG_onchange", e);
    }
}*/
...
csFuncLevelProto.FLD_TMPL_CUST_SPEC_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_TMPL_EditTemplateGeneral.js*FLD_TMPL_CUST_SPEC_onchange", e);
    }
}
...
csFuncLevelProto.FLD_TMPL_CUST_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_TMPL_EditTemplateGeneral.js*FLD_TMPL_CUST_ID_BTN_onclick", e);
    }
}