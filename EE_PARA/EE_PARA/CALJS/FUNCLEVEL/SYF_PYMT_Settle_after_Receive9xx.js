...
csFuncLevelProto.SYF_PYMT_AC_NO_Change = function() {
    try {
        ...
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
}
        ...
        switch (SYS_BANK_COUNTRY) {
            case "MU":
                if (SYF_PYMT_LocalMUP()) {
                    ...
                    SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_CheckMUPTISAccountNumber_0', '1', true);
            ...
            case "TZ":
                if (SYF_PYMT_LocalTIS()) {
                    ...
                    SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_CheckMUPTISAccountNumber_1', '1', true);
                    if (document.MAINFORM[Mapping_List].value != document.MAINFORM.TEMP_ACC_NO.value) {
                        if (document.MAINFORM.MT103_DISTRBN.value == 'Single Settlement') {
...
csFuncLevelProto.SYF_PYMT_ChkCustAccNum = function(acctNum) {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_ChkCustAccNum_2', '1', true);
        if (document.MAINFORM.C_CUST_ID.value != "") {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_ChkCustAccNum_3', '1', true);
...
csFuncLevelProto.SYF_PYMT_Chk_IBANForMU = function() {
    try {
        ...
        BENECUACNO59A = document.MAINFORM.INW_X103_BENECUACNO59A.value;
        BENECUACNO59A = BENECUACNO59A.toString();
        //BENECUACNO59A = String(BENECUACNO59A)+'';
        X103_BENECUACNO59A = "";
        ...
        if (CleanedAccNum.length == 30) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Chk_IBANForMU_4', '1', true);
...
csFuncLevelProto.SYF_PYMT_Clbk_ITT_Chrgs = function() {
    try {
        ...
        var Preadv_chgObj; // Utility Auto Fix Comments
        var RecChg_71GObj; // Utility Auto Fix Comments
        ...
        if (document.MAINFORM.INW_X103_DET_CHG_71A.value == 'OUR') {
            ...
            if (RecChg_71GObj.getBalAmt() > 0) {
                ...
                //edit by amy for Preadv
                Preadv_chgObj = Chg.Screen.getDefChargeByCommCode('PYMT_PRE_ADV_COMM');
                if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
                    Preadv_chgObj[0].setPayAmt(0);
                    Preadv_chgObj[0].setCollectAmt(0);
                }
            }
        }
    } catch (e) {
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        if (document.MAINFORM.SEND_TO_FLAG.value != "Send to Investigation Queue") {
            if (!SYS_Batch_CheckFieldValue()) { // Utility Auto Fix Comments
                return false; //check whether the value of all class fields are correct// Utility Auto Fix Comments
            ...
            if (sett_loadFlag) {
                if (document.MAINFORM.MT103_DISTRBN.value != "Single Settlement") {
                    ...
                    if (!SYM_PYMT_match_trn_and_settlement_amts()) { // Utility Auto Fix Comments
		...
		{
			document.MAINFORM.X103_INSTRCODE_23E.value = 
				document.MAINFORM.X103_INSTRCODE1_23E.value +'/'+ 
				document.MAINFORM.X103_INSTRCODE2_23E.value;
		}
		...
		*/
		...
		else
		{
			document.MAINFORM.X103_INSTR_AMT_33B.value  = 
				SYS_BeFloat(document.MAINFORM.X103_SETT_AMT_32A.value) + SYS_BeFloat(document.MAINFORM.X103_SENDCHGAMT71F.value);
		}
		*/ //sathish dec 21

                if (SYS_BeFloat(document.MAINFORM.X103_SENDCHGAMT71F.value) <= 0) {
                    //document.MAINFORM.X103_DET_CHG_71A.value = 'SHA'; //sathish dec 21
                    document.MAINFORM.X103_INSTR_AMT_33B.value = SYS_BeFloat(document.MAINFORM.X103_SETT_AMT_32A.value);
                } else {
                    document.MAINFORM.X103_INSTR_AMT_33B.value = SYS_BeFloat(document.MAINFORM.X103_SETT_AMT_32A.value) +
                ...
                document.MAINFORM.REMIT_INFO_TMP_70.value =
                    document.MAINFORM.INW_X103_REMIT_INF1_70.value + document.MAINFORM.INW_X103_REMIT_INF2_70.value +
                    document.MAINFORM.INW_X103_REMIT_INF3_70.value + document.MAINFORM.INW_X103_REMIT_INF4_70.value;
            } else if (document.MAINFORM.MT103_DISTRBN.value == "Single Settlement") {
                SYF_PYMT_Set_Foreign_ChgAcct(ChgCodeOur);
	...
	{  */ //edit by amy
            ...
            if (document.MAINFORM.MT190_Flag) {
...
csFuncLevelProto.SYF_PYMT_Decide_191_190 = function(ChgCodeOur) {
    try {
        ...
        var Preadv_chgObj; // Utility Auto Fix Comments
        var Preadv_chg_ActiveAmt; // Utility Auto Fix Comments
        var Preadv_chg_PayAmt; // Utility Auto Fix Comments
        ...
        var RecChg_71GObj; // Utility Auto Fix Comments
        var XN90_AMT_32A; // Utility Auto Fix Comments
        ...
        RecChg_71GObj = Chg.Screen.getTrxChargeByCommCode(ChgCodeOur);
        //edit by amy for Preadv chg
        Preadv_chgObj = Chg.Screen.getDefChargeByCommCode('PYMT_PRE_ADV_COMM');
        if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
            RecChg71G_Bank = SYS_BeFloat(RecChg_71GObj.getBalAmt()) + SYS_BeFloat(Preadv_chgObj[0].getBalAmt());
            Preadv_chg_ActiveAmt = Preadv_chgObj[0].getActiveAmt();
        } else {
            RecChg71G_Bank = SYS_BeFloat(RecChg_71GObj.getBalAmt());
        }
        ...
        if (inc71GChg > 0) {
            if (inc32ACcy != SYS_LOCAL_CCY) {
                if (inc71GCcy == inc32ACcy) {
                    ...
                    if (RecChg71G_ActiveAmt > 0 || Preadv_chg_ActiveAmt > 0) {
                ...
                if (RecChg71G_ActiveAmt > 0 || Preadv_chg_ActiveAmt > 0) {
                    if (document.MAINFORM.BANK_CHRG_ACCT.value != "") {
                        ...
                        //document.MAINFORM.XN90_AMT_32A.value = SYT_AmtFormat(document.MAINFORM.XN90_CCY_32A.value,RecChg_71GObj.getPayAmt());//edit by amy
                        if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
                            XN90_AMT_32A = SYS_BeFloat(Preadv_chgObj[0].getPayAmt()) + SYS_BeFloat(RecChg_71GObj.getPayAmt());
                        } else {
                            XN90_AMT_32A = SYS_BeFloat(RecChg_71GObj.getPayAmt());
                        }
                        document.MAINFORM.XN90_AMT_32A.value = SYT_AmtFormat(document.MAINFORM.XN90_CCY_32A.value, XN90_AMT_32A); //	edit by amy
        ...
        if (inc32ACcy == SYS_LOCAL_CCY) {
            ...
            if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
                Preadv_chg_PayAmt = Preadv_chgObj[0].getPayAmt();
            }
            if (RecChg71G_ActiveAmt > 0 || Preadv_chg_ActiveAmt > 0) {
                if (RecChg71G_Bank > 0 || RecChg71G_PayAmt > 0 || Preadv_chg_PayAmt > 0) {
                    if (document.MAINFORM.BANK_CHRG_ACCT.value != "") {
                        EEHtml.getElementById("L").style.display = "block";
                        EEHtml.getElementById("MT190_Break").style.display = "block";
                        document.MAINFORM.MT190_Flag.value = "Yes";
    ...
    try {
        ...
        if (document.MAINFORM.INW_X103_SETT_CCY_32A.value == SYS_LOCAL_CCY) {
            ...
            if (document.MAINFORM.BANK_CHRG_ACCT.value != '') {
                ...
                SYS_GetTableDataByRule('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Enb_MT191_5', '1', 'SYF_PYMT_Get_191CorrDetails()', 'SYF_PYMT_Get_191CorrDetails()', true);
            }
        }
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
...
csFuncLevelProto.SYF_PYMT_Enb_MT900 = function() {
    try {
        ...
        EEHtml.getElementById('O').style.display = "block";
...
csFuncLevelProto.SYF_PYMT_Get_191CorrDetails = function() {
    try {
        ...
        if (document.MAINFORM.XN91_ACC_BKID_57A.value.trim() == '') {
            ...
            //Field_List = "C_ACCT_WITH_ID";
            //Mapping_List = "XN91_ACC_BKID_57A";
            SYS_GetTableDataByRule('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Get_191CorrDetails_6', '1', '', '', true);
        }
        if (document.MAINFORM.INW_X103_SETT_CCY_32A.value == SYS_LOCAL_CCY) {
...
csFuncLevelProto.SYF_PYMT_Get_CPYT_DR_AC = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Get_CPYT_DR_AC_7', '1', true);
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_Get_Resident_Status = function() {
    try {
        ...
        SYS_GetTableDataByRule('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Get_Resident_Status_8', '1', '', '', true);
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
}
        ...
        switch (SYS_BANK_COUNTRY) {
            case "MU":
                ...
                if (document.MAINFORM.MT103_DISTRBN.value == 'Single Settlement') {
                    ...
                    document.MAINFORM.CPYT_CR_BK_AC.value = "";
                    SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_ITT_MUP_TIS_AccountDefault_9', '1', true);
                } else if (document.MAINFORM.MT103_DISTRBN.value == 'Forward Funds') {
                    //Mapping_List4 = "CPYT_CR_BK_AC";
                    SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_ITT_MUP_TIS_AccountDefault_10', '1', true);
                }
            ...
            case "TZ":
                ...
                if (document.MAINFORM.MT103_DISTRBN.value == 'Single Settlement') {
                    //Mapping_List6 = "CPYT_DR_AC";
                    document.MAINFORM.CPYT_CR_BK_AC.value = "";
                    SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_ITT_MUP_TIS_AccountDefault_11', '1', true);
                } else if (document.MAINFORM.MT103_DISTRBN.value == 'Forward Funds') {
                    //Mapping_List5 = "CPYT_CR_BK_AC";
                    SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_ITT_MUP_TIS_AccountDefault_12', '1', true);
                }
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        var def_chg; // Utility Auto Fix Comments
        var i; // Utility Auto Fix Comments
        ...
        if (SYS_BANK_COUNTRY == 'ZA') {
            ...
            //Remove non-applicable Paid At options: "Waived"
        ...
        if (SYS_FUNCTION_TYPE == 'EC' && SYS_ERROR == "") {
            ...
            SYF_PYMT_Set_IncTabs(); // Utility Auto Fix Comments
        } else {
            ...
            //For deferred charge by amy
            def_chg = Chg.Screen.getAllDefCharge();
            for (i = 0; i < def_chg.length; i++) {
                def_chg[i].setChargeAt(0);
                def_chg[i].chargeAtOnchange();
            }
            ...
            /*
	if(document.MAINFORM.X103_BENECU_ID_59A.value == ""){
		SYT_ChangeFldClass(document.MAINFORM.lookup7,"P");			
	}else{
		document.MAINFORM.ORG_BEN_CUSTID.value = document.MAINFORM.X103_BENECU_ID_59A.value;
		document.MAINFORM.ORG_BEN_CUSTACCT.value = document.MAINFORM.X103_BENECUACNO59A.value;
	}
...
csFuncLevelProto.SYF_PYMT_Set_Acct_Name = function(sAcct) {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Set_Acct_Name_13', '1', true);

        //Sql_Cond2 = "C_MAIN_REF='" + v_C_ACCT_WITH_ID + "'";
        //Field_List2 = "PARTY_NM";
        //Mapping_List2 = "CPYT_CR_BK_AC1";
        SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Set_Acct_Name_14', '1', true);
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_Set_ChgChanges_OUR = function(ChgCodeOur) {
    try {
        ...
        var ChgTotle; // Utility Auto Fix Comments
        var ConvAmt; // Utility Auto Fix Comments
        var InwCcy; // Utility Auto Fix Comments
        var Paid_71GObj; // Utility Auto Fix Comments
        var Preadv_chgObj; // Utility Auto Fix Comments
        var Preadv_set; // Utility Auto Fix Comments
        var RecChg71G_Bank; // Utility Auto Fix Comments
        ...
        var TotleConvAmt; // Utility Auto Fix Comments
        ...
        if (document.MAINFORM.INW_X103_DET_CHG_71A.value == "OUR") {
            ...
            if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
                if (RuleCcy != '' && (RecChg_71GObj.getActiveAmt() > 0 || Preadv_chgObj[0].getActiveAmt() > 0)) { //dec 14
                    if (InwCcy != SYS_LOCAL_CCY) {
                        if (RuleCcy != SYS_LOCAL_CCY) {
                            if (InwCcy != RuleCcy) {
                                ...
                                Preadv_chgObj[0].setBalCcy(InwCcy);
                                document.MAINFORM.DB_CALC_AMT1.value = Preadv_chgObj[0].getActiveAmt();
                                SYT_getExchangeRateSB(document.MAINFORM.DB_CCY, document.MAINFORM.INW_X103_SETT_CCY_32A, rate_type, document.MAINFORM.DB_CALC_AMT1, document.MAINFORM.DB_AMT1, document.MAINFORM.EXCH_RATE);
                                ...
                                Preadv_chgObj[0].setBalCcy(InwCcy);
                                TotleConvAmt = SYS_BeFloat(document.MAINFORM.DB_AMT.value) + SYS_BeFloat(document.MAINFORM.DB_AMT1.value);
                                if (TotleConvAmt - ReceivedChg71 > 0) {
                                    if (SYS_BeFloat(document.MAINFORM.DB_AMT.value) - SYS_BeFloat(ReceivedChg71) > 0) {
                                        RecChg_71GObj.setBalAmt(SYS_BeFloat(document.MAINFORM.DB_AMT.value) - SYS_BeFloat(ReceivedChg71));
                                        RecChg_71GObj.setPayAmt(RecChg_71GObj.getBalAmt());
                                        Preadv_chgObj[0].setBalAmt(document.MAINFORM.DB_AMT1.value);
                                    } else {
                                        if (SYS_BeFloat(document.MAINFORM.DB_AMT1.value) - (SYS_BeFloat(ReceivedChg71) - SYS_BeFloat(document.MAINFORM.DB_AMT.value)) > 0) {
                                            RecChg_71GObj.setBalAmt(0);
                                            Preadv_chgObj[0].setBalAmt(SYS_BeFloat(document.MAINFORM.DB_AMT1.value) - (SYS_BeFloat(ReceivedChg71) - SYS_BeFloat(document.MAINFORM.DB_AMT.value)));
                                        } else {
                                            RecChg_71GObj.setBalAmt(0);
                                            Preadv_chgObj[0].setBalAmt(0);
                                        }
                                    }
                                } else {
                                    RecChg_71GObj.setBalAmt(0);
                                ...
                                RecChg_71GObj.setBalCcy(InwCcy);
                                Preadv_chgObj[0].setBalCcy(InwCcy);
                                RecChg71G_set = RecChg_71GObj.getActiveAmt();
                                Preadv_set = Preadv_chgObj[0].getActiveAmt();
                                ChgTotle = SYS_BeFloat(RecChg71G_set) + SYS_BeFloat(Preadv_set);
                                if (ChgTotle - SYS_BeFloat(ReceivedChg71) > 0) {
                                    if (SYS_BeFloat(RecChg71G_set) - SYS_BeFloat(ReceivedChg71) > 0) {
                                        ...
                                        Preadv_chgObj[0].setBalAmt(Preadv_set);
                                    } else {
                                        if (SYS_BeFloat(Preadv_set) - (SYS_BeFloat(ReceivedChg71) - SYS_BeFloat(RecChg71G_set)) > 0) {
                                            RecChg_71GObj.setBalAmt(0);
                                            Preadv_chgObj[0].setBalAmt(SYS_BeFloat(Preadv_set) - (SYS_BeFloat(ReceivedChg71) - SYS_BeFloat(RecChg71G_set)));
                                        } else {
                                            RecChg_71GObj.setBalAmt(0);
                                            Preadv_chgObj[0].setBalAmt(0);
                                        }
                    ...
                    if (RuleCcy != '' && (RecChg_71GObj.getActiveAmt() > 0 || Preadv_chgObj[0].getActiveAmt() > 0)) { //dec 14
                        if (document.MAINFORM.INW_X103_SETT_CCY_32A.value == SYS_LOCAL_CCY) {
                            if (document.MAINFORM.BANK_CHRG_ACCT.value != '') {
                                ...
                                Preadv_chgObj[0].setPayAmt(Preadv_chgObj[0].getBalAmt());
                                Preadv_chgObj[0].setCollectCcy(SYS_LOCAL_CCY);
                                Preadv_chgObj[0].setCollectAmt(Preadv_chgObj[0].getPayAmt());
                                Preadv_chgObj[0].setBalCcy(SYS_LOCAL_CCY);
                                Preadv_chgObj[0].setBalAmt(0.00);
                            }
                        }
                    }
                    SYF_PYMT_Set_Chrgs_TotalAmt();
...
csFuncLevelProto.SYF_PYMT_Set_Chrgs_TotalAmt = function() {
    try {
        ...
        if (Chg.Screen.getForeignCollectVatTotalAmt() > 0) {
            if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
                Chg.Screen.setForeignCollectTotalAmt(RecChg_71GObj.getCollectAmt() + Paid_71GObj.getCollectAmt() + Preadv_chgObj[0].getCollectAmt() + Chg.Screen.getForeignCollectVatTotalAmt());
            } else {
            ...
            if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
                Chg.Screen.setForeignCollectTotalAmt(RecChg_71GObj.getCollectAmt() + Paid_71GObj.getCollectAmt() + Preadv_chgObj[0].getCollectAmt());
            } else {
        ...
        if (Chg.Screen.getForeignPayVatTotalAmt() > 0) {
            if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
                Chg.Screen.setForeignPayTotalAmt(RecChg_71GObj.getPayAmt() + Paid_71GObj.getPayAmt() + Preadv_chgObj[0].getPayAmt() + Chg.Screen.getForeignPayVatTotalAmt());
            } else {
                Chg.Screen.setForeignPayTotalAmt(RecChg_71GObj.getPayAmt() + Paid_71GObj.getPayAmt() + Chg.Screen.getForeignPayVatTotalAmt());
            }
        } else {
            if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
                Chg.Screen.setForeignPayTotalAmt(RecChg_71GObj.getPayAmt() + Paid_71GObj.getPayAmt() + Preadv_chgObj[0].getPayAmt());
            } else {
                Chg.Screen.setForeignPayTotalAmt(RecChg_71GObj.getPayAmt() + Paid_71GObj.getPayAmt());
            }
        }
        if (Preadv_chgObj != '' && Preadv_chgObj != null && Preadv_chgObj != 'null' && Preadv_chgObj != 'undefined') {
            Chg.Screen.setForeignPayChgTotalAmt(RecChg_71GObj.getPayAmt() + Paid_71GObj.getPayAmt() + Preadv_chgObj[0].getPayAmt());
            Chg.Screen.setForeignCollectChgTotalAmt(RecChg_71GObj.getCollectAmt() + Paid_71GObj.getCollectAmt() + Preadv_chgObj[0].getCollectAmt());
        } else {
    ...
    try {
        ...
        */
        if (document.MAINFORM.INW_X103_SETT_CCY_32A.value == SYS_LOCAL_CCY) {
            ...
            //Field_List = "C_ACCT_NR";
            //Mapping_List = "CPYT_DR_AC";
            SYS_GetTableDataByRule('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Set_DB_AcctNo_15', '1', '', '', true);
        } else if (document.MAINFORM.INW_X103_SETT_CCY_32A.value != SYS_LOCAL_CCY) {
            document.MAINFORM.C_CLEAR_TYPE.value = "NOSTRO";
            ...
            SYS_GetTableDataByRule('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Set_DB_AcctNo_16', '1', '', '', true);
        }
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
...
csFuncLevelProto.SYF_PYMT_Set_Foreign_ChgAcct = function(ChgCodeOur) {
    try {
        ...
        var Obj_PYMT_PRE_ADV_COMM; // Utility Auto Fix Comments
        var _71G_REC_CHGS_AC; // Utility Auto Fix Comments
        ...
        if (document.MAINFORM.INW_X103_DET_CHG_71A.value == 'OUR') {
            ...
            Obj_PYMT_PRE_ADV_COMM = Chg.Screen.getDefChargeByCommCode('PYMT_PRE_ADV_COMM');
            if (Obj_PYMT_PRE_ADV_COMM != null && Obj_PYMT_PRE_ADV_COMM != 'null' && Obj_PYMT_PRE_ADV_COMM != '' && Obj_PYMT_PRE_ADV_COMM != 'undefined') {
                _71G_REC_CHGS_AC = Chg.Screen.getTrxTempFieldVaule(ChgCodeOur, "1"); // Utility Auto Fix Comments
                Chg.Screen.setDefTempFieldVaule("PYMT_PRE_ADV_COMM", "1", _71G_REC_CHGS_AC); // Utility Auto Fix Comments
            }
        }
        SYF_PYMT_Set_Acct_Name(document.MAINFORM.CPYT_DR_AC.value);
        if (document.MAINFORM.MT103_DISTRBN.value == "Return of Funds") {
...
csFuncLevelProto.SYF_PYMT_Set_Init_Values = function() {
    try {
        ...
        document.MAINFORM.MT103_DISTRBN.remove(2);
        document.MAINFORM.CR_CALC_AMT.value = document.MAINFORM.CR_AMT.value;
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
    ...
    try {
        ...
        if (document.MAINFORM.INW_X103_DET_CHG_71A.value == "OUR") {
            if (document.MAINFORM.INW_X103_SETT_CCY_32A.value == SYS_LOCAL_CCY) {
                ...
                SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Set_MT191_17', '1', true);
                ...
                SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Set_MT191_18', '1', true);
                SYF_PYMT_Decide_191_190(ChgCodeOur);
            }
        }
    } catch (e) {
        ...
        if (document.MAINFORM.MT103_DISTRBN.value != 'Return of Funds') {
            if (document.MAINFORM.INW_X103_DET_CHG_71A.value == "OUR") {
                ...
                if (inc32ACcy == SYS_LOCAL_CCY) {
                    ...
                    //Field_List = "C_ACCT_NR";
                    //Mapping_List = "BANK_CHRG_ACCT";
                    SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Set_RecChgs_19', '1', true);
                } else if (inc32ACcy != SYS_LOCAL_CCY) {
                    document.MAINFORM.C_CLEAR_TYPE.value = "NOSTRO";
                    //Sql_Cond1 = "C_CNTY_CODE=" + "'" + SYS_BANK_COUNTRY + "'" + " AND " + "C_CLEAR_VALID=" + "'T'" + " AND " + "C_CLEAR_TYPE=" + "'" + document.MAINFORM.C_CLEAR_TYPE.value + "'" + " AND " + "C_ACCT_CCY=" + "'" + document.MAINFORM.INW_X103_SETT_CCY_32A.value + "'" + " AND " + "C_ACCT_WITH_ID=" + "'" + document.MAINFORM.INW_SNDBK_ID.value + "'";
                    //Field_List1 = "C_ACCT_NR";
                    //Mapping_List1 = "BANK_CHRG_ACCT";
                    SYS_GetTableDataByRule_S('SYF_PYMT_Settle_after_Receive9xx_SYF_PYMT_Set_RecChgs_20', '1', true);
                }
                Paid_71GObj = Chg.Screen.getTrxChargeByCommCode('PAID_71G');
                        ...
                        if (RuleCcy != '' && (RecChg_71GObj.getActiveAmt() > 0 || Preadv_chgObj[0].getActiveAmt() > 0)) { //dec 14
                            if (document.MAINFORM.INW_X103_SETT_CCY_32A.value == SYS_LOCAL_CCY) {
                                if (document.MAINFORM.BANK_CHRG_ACCT.value != '') {
                                    ...
                                    if (RecChg_71GObj.getBalAmt() > 0) {
                                        RecChg_71GObj.setPayAmt(RecChg_71GObj.getBalAmt());
                                    } else if (Preadv_chgObj[0].getBalAmt() > 0) {
                                        Preadv_chgObj[0].setPayAmt(Preadv_chgObj[0].getBalAmt());
                                    }
                                    RecChg_71GObj.setCollectCcy(SYS_LOCAL_CCY);
                                    RecChg_71GObj.setCollectAmt(RecChg_71GObj.getPayAmt());
...
csFuncLevelProto.SYF_PYMT_ShowPayTabs = function() {
    try {
        ...
        EEHtml.getElementById("I").style.display = "block";
...
csFuncLevelProto.SYF_PYMT_Show_195_196Tab = function() {
    try {
        ...
        EEHtml.getElementById("M").style.display = "block";
...
csFuncLevelProto.SYF_PYMT_Show_Sett = function() {
    try {
        ...
        EEHtml.getElementById("Sett_Break").style.display = "block";
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        var _dodetail; // Utility Auto Fix Comments
        if (document.MAINFORM.X103_BENECU_ID_59A.value == "") {
            alert("Beneficiary Customer[59] ID is null , Settlement cannot be done."); // Utility Auto Fix Comments
            return false;
        }
...
csFuncLevelProto.FLD_PYMT_MT103_DISTRBN_onchange = function(event) {
    try {
        SYF_PYMT_Chg_MT103_DISTRBN();
        SYF_PYMT_Set_MT900();
    } catch (e) {
...
csFuncLevelProto.FLD_PYMT_X103RECCORRACNO54A_onchange = function(event) {
    try {
        if (document.MAINFORM.X103RECCORRACNO54A.value != "" && document.MAINFORM.X103RECCORRACNO54A.value.substr(0, 1) != "/") {
            document.MAINFORM.X103RECCORRACNO54A.value = "/" + document.MAINFORM.X103RECCORRACNO54A.value;
            if (document.MAINFORM.X103RECCORRACNO54A.value.length > 35) {
                SYS_CheckError(oAC_NO, "The max length for event.currentTarget field is 35!");
                return false;
            } else {
                return true;
            }
...
csFuncLevelProto.FLD_PYMT_X103SENDCORACNO53A_onchange = function(event) {
    try {


        if (document.MAINFORM.X103SENDCORACNO53A.value != "" && document.MAINFORM.X103SENDCORACNO53A.value.substr(0, 1) != "/") {
            document.MAINFORM.X103SENDCORACNO53A.value = "/" + document.MAINFORM.X103SENDCORACNO53A.value;
            if (document.MAINFORM.X103SENDCORACNO53A.value.length > 35) {
                SYS_CheckError(oAC_NO, "The max length for event.currentTarget field is 35!");
                return false;
            } else {
                return true;
...
csFuncLevelProto.FLD_PYMT_X103_51_ADD_BTN_onclick = function(event) {
    try {
...
csFuncLevelProto.FLD_PYMT_X103_RECCORRID_54A_onchange = function(event) {
    try {
        ...
        setTimeout(FLD_PYMT_X103RECCORRACNO54A_onchange, 500);
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
}
...
csFuncLevelProto.FLD_PYMT_X103_SENDCORRID53A_onchange = function(event) {
    try {
        ...
        setTimeout(FLD_PYMT_X103SENDCORACNO53A_onchange, 500);
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
    }
}
...
csFuncLevelProto.FLD_PYMT_XN90_ORD_BKID_52A_onchange = function(event) {
    try {
...
csFuncLevelProto.FLD_PYMT_XN90_ORD_BKSW_52A_onchange = function(event) {
    try {
...
csFuncLevelProto.FLD_PYMT_XN91_ACC_BKID_57A_onchange = function(event) {
    try {
        SYM_PYMT_Chg_XN91_ACC_BKID_57A();
    } catch (e) {
        DisExcpt("SYF_PYMT_Settle_after_Receive9xx.js", e);
...
csFuncLevelProto.FLD_PYMT_XN91_ACC_BKSW_57A_onchange = function(event) {
    try {
