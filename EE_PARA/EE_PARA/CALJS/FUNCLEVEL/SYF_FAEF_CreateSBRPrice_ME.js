...
csFuncLevelProto.SYF_FAEF_Cal_FA_IRT_SPREAD = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_CreateSBRPrice_ME.js", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.FA_EF_HAN_CHG_CCY.value = document.MAINFORM.FA_MAX_CCY.value;
...
csFuncLevelProto.PreconditionOnInit = function() {
    try {
        ...
        SYS_GetRefNo('DF_SCF_AGRMNT', 'SYF_FAEF_setMainRef()');
    } catch (e) {
        DisExcpt("SYF_FAEF_CreateSBRPrice_ME.js", e);
    }
}
