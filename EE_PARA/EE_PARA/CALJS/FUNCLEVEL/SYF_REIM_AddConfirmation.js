...
csFuncLevelProto.SYF_REIM_ChgFldCLS = function() {
    try {
        ...
        DisExcpt("SYF_REIM_AddConfirmation.js", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        document.MAINFORM.CONF_DR_AC_NO.value = 'IssuingBankliability';
...
csFuncLevelProto.FLD_REIM_CONF_INSTR_onchange = function(event) {
    try {
        if (document.MAINFORM.CONF_INSTR.value == "Confirmed") {
            document.MAINFORM.REIM_CONF_BAL.value = SYT_AmtFormat(document.MAINFORM.LC_CCY.value, document.MAINFORM.REIM_INST_BAL.value);
        } else {
