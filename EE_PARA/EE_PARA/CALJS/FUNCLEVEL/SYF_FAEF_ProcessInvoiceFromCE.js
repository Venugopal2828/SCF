...
csFuncLevelProto.SYF_FAEF_Cal_ExcelUploaded = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ProcessInvoiceFromCE.js", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_PmtTerms = function() {
    try {
        ...
        pmtTerms = document.MAINFORM.FA_TEMP4.value;
        if (pmtTerms > 180) {
            alert("Payment Terms are more than 180 days!");
        }
        if (pmtTerms > document.MAINFORM.FA_PMT_TERMS.value) {
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        if (!SYT_checkFactoringChildRecord('InvTRF1')) {
            return false;
        }
...
csFuncLevelProto.SYF_FAEF_Cal_FA_INV_CCY = function() {
    try {
        ...
        SYS_refreshChildDoValue("InvTRF1", 'FA_DOC_CCY', ccy);
    } catch (e) {
        DisExcpt("SYF_FAEF_ProcessInvoiceFromCE.js", e);
    }
}
    ...
    try {
        ...
        if (docCcy == priCcy) {
            ...
            if (exRt != '') {
                ...
                num = SYS_getcurrRecordCount("InvTRF1");
                if (num > 0) {
...
csFuncLevelProto.LoadDODataOnInit = function() {
    try {
        ...
        /*var efhandalsum = 0;
        var _do = SYS_getDoByXpath('InvTRF1');
...
csFuncLevelProto.SYF_FAEF_CHG_INIT = function() {
    try {
        ...
        type = document.MAINFORM.FA_BUSI_TYPE.value;
        if (type == 'EF' || type == 'DF' || type == 'DISC' || type == 'DD') {
...
csFuncLevelProto.SYF_FAEF_UpLoadFile_InvTRF = function() {
    try {
        ...
        SYS_UpLoadInvFile('UploadInvoice', 'SYF_FAEF_Cal_ExcelUploaded', '', 'FI', '', 'InvTRF1');
    } catch (e) {
        DisExcpt("SYF_FAEF_ProcessInvoiceFromCE.js", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Sum_DO_Data = function() {
    try {
        ...
        var num;
        var record;
        _do = SYS_getDoByXpath('InvTRF1');
        num = SYS_getcurrRecordCount("InvTRF1");
        document.MAINFORM.FA_TTL_INV_NO.value = num;
        ...
        if (num > 0) {
            ...
            for (i = 0, len = arrayvalue.length; i < len; i++) {
                ...
                document.MAINFORM.FA_TTL_INV_AMT.value = SYT_AmtFormat(document.MAINFORM.FA_DOC_CCY.value, ttlamt);
...
csFuncLevelProto.SYF_FAEF_CheckDOEditInv = function() {
    try {
        ...
        if (num > 0) {
            ...
            for (i = 0, len = arrayvalue.length; i < len; i++) {
                ...
                if ('E' == type) {
                    ...
                    alert("Should edit the Invoice DO first!");
                    return false;
                }
            }
        }
