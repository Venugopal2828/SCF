...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*ConfirmBusinessCall", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_dcmMul = function(arg1, arg2) {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*InitValues", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_AMTTOSELLER = function() {
    try {
        ...
        selamt = SYS_BeFloat(document.MAINFORM.FA_PMT_AMT_SUM.value) * 1000 - SYS_BeFloat(document.MAINFORM.FA_PAID_INT_SUM.value) * 1000 - SYS_BeFloat(document.MAINFORM.FA_PAID_PRIN_SUM.value) * 1000 - SYS_BeFloat(document.MAINFORM.FA_OVDUE_INT_SUM.value) * 1000;
        ...
        if(document.MAINFORM.FA_SETTLE_FLG.value=='Unfinanced Invoices'||document.MAINFORM.FA_SETTLE_FLG.value=='All') {
        ...
        for (i = 0, len = arrayvalue.length; i < len; i++) { // Utility Auto Fix Comments
            ...
            var loanid = SYS_getValFromRec(record, 'FA_INV_LOAN_ID');
      ...
      SYF_FAEF_MLDC_SetDebitCreditData();
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_Cal_AMTTOSELLER", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_ChargeFor = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_Cal_ChargeFor", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_PAY_SEQ = function(ref) {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_Cal_PAY_SEQ", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_SetRefNo = function(ref) {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_Cal_SetRefNo", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_TRX_Value = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_Cal_TRX_Value", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_CheckTotalIInterest = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_CheckTotalIInterest", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_AMOUNT = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_Chk_AMOUNT", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_MultiDebit_MultiCredit_BAL = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_Chk_MultiDebit_MultiCredit_BAL", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_CreditCover_FSB_Inq = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_CreditCover_FSB_Inq", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_FA_PMT_TYPE = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_FA_PMT_TYPE", e);
    }
}

csFuncLevelProto.SYF_FAEF_FLD_FAEF_ACJENERICDTLSTRINGDO_onchange = function(event) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_FLD_FAEF_ACJENERICDTLSTRINGDO_onchange", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_LoadDoComplete = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_LoadDoComplete", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_MLDC_SetDebitCreditData = function() {
    try {
        ...
        payAMTs2 = "";
        descs2 = "";
        ccyProtecteFlgs2 = ""; //protected ccy
        actions2 = ""; //save
        merges2 = "";
        comp2 = "";
        var prin_ref = document.MAINFORM.C_MAIN_REF.value + 'PRN';
		var ESF_ref= document.MAINFORM.C_MAIN_REF.value + 'ESF';//Early Settle Fee ref
		...
		var earlysetl = document.MAINFORM.FA_EARLY_SETL_FEE.value;//Early Settle Fee Value
        var minus_rebate = SYS_FloatSub(IntSum, rebate);
        var rb_ref = document.MAINFORM.C_MAIN_REF.value + 'RB';
        var netint = SYT_CCY_AMT(document.MAINFORM.FA_LMT_CCY.value,SYS_FloatAdd(SYS_BeFloat(document.MAINFORM.FA_PAID_INT_SUM.value),SYS_BeFloat(document.MAINFORM.FA_OVDUE_INT_SUM.value)));
		...
		if (SYS_BeFloat(document.MAINFORM.FA_PMT_AMT_SUM.value) > 0 && SYS_BeFloat(IntSum)>0 && SYS_BeFloat(document.MAINFORM.FA_PAID_PRIN_SUM.value)>0) {
            ...
            payAMTs = document.MAINFORM.FA_PMT_AMT_SUM.value + "/" + document.MAINFORM.FA_PAID_PRIN_SUM.value + "/" + netint + "/" + document.MAINFORM.FA_SEL_AC_AMT.value;
        ...
        /* Add for pay unfinance invoices on 20220812- S*/
        else if(SYS_BeFloat(document.MAINFORM.FA_PMT_AMT_SUM.value) > 0 &&document.MAINFORM.FA_SETTLE_FLG.value =='Unfinanced Invoices' ) {
        ...
        /* Add for pay unfinance invoices on 20220812- E*/
            ...
            payCCYs = document.MAINFORM.FA_SBR_CCY.value + "/" + document.MAINFORM.FA_SBR_CCY.value + "/" + document.MAINFORM.FA_SBR_CCY.value;
            payAMTs = document.MAINFORM.FA_PMT_AMT_SUM.value + "/" + netint + "/" + document.MAINFORM.FA_SEL_AC_AMT.value;
            ccyProtecteFlgs = "N/N/N"; //protected ccy
            actions = "S/S/S"; //save
            merges = "N/N/N";
            comp = "Payment";
        ...
        if (SYS_BeFloat(document.MAINFORM.FA_REBATE_AMT.value) > 0 &&document.MAINFORM.FA_BUSI_TYPE.value=='PF') {
			dcFlgs2 = "D/C"; //debit and credit group
			keyindex2 = rb_ref + "/" + rb_ref;
			payCCYs2 = document.MAINFORM.FA_SBR_CCY.value + "/" + document.MAINFORM.FA_SBR_CCY.value;
			payAMTs2 = rebate + "/" + rebate;
			descs2 = "Rebate Interest/Rebate Interest";
			ccyProtecteFlgs2 = "N/N"; //protected ccy
			actions2 = "S/S"; //save
			merges2 = "N/N";
			comp2 = "Rebate Interest";
			SYT_MLDC_SaveSummary(dcFlgs2, keyindex2, payCCYs2, descs2, payAMTs2, ccyProtecteFlgs2, actions2, merges2, comp2);     
		}
		
		if (SYS_BeFloat(earlysetl) > 0) {
			dcFlgs1 = "D/C"; //debit and credit group
			keyindex1 = ESF_ref + "/" + ESF_ref;
			payCCYs1 = document.MAINFORM.FA_SBR_CCY.value + "/" + document.MAINFORM.FA_SBR_CCY.value;
			payAMTs1 = earlysetl + "/" + earlysetl;
			descs1 = "Early Settlement Fee/Early Settlement Fee";
			ccyProtecteFlgs1 = "N/N"; //protected ccy
			actions1 = "S/S"; //save
			merges1 = "N/N";
			comp1 = "Early Settlement Fee";
			SYT_MLDC_SaveSummary(dcFlgs1, keyindex1, payCCYs1, descs1, payAMTs1, ccyProtecteFlgs1, actions1, merges1, comp1);     
		}
    } catch (e) {
        DisExcpt("SYF_FAEF_Settlement_ME.js*SYF_FAEF_MLDC_SetDebitCreditData", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_LOAN_ID_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_LOAN_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_OVDUE_INT_SUM_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_OVDUE_INT_SUM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_PAID_INT_SUM_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_PAID_INT_SUM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_PAID_PRIN_SUM_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_PAID_PRIN_SUM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_PMT_DT_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_PMT_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_PMT_TYPE_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_PMT_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_PMT_VAL_DT_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_PMT_VAL_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_SETTLE_FLG_onchange = function() {
    try {
        ...
        /* 	Add for settle flag switch related tab on 20220812 S*/
        var dd = SYS_getDoByXpath('MultiCreditSummary');
        var ee = SYS_getDoByXpath('MultiDebitSummary');
        dd.clearAllDataSets(true);
        ee.clearAllDataSets(true);
        SYT_ClearFields("FA_PMT_AMT_SUM,FA_PAID_PRIN_SUM,FA_TTL_AMT_CLEARED,FA_REBATE_ACCOUNT,FA_SEL_AC_AMT,FA_PAID_INT_SUM,FA_OVDUE_INT_SUM,FA_REBATE_AMT,FA_EARLY_SETL_FEE");
      /* 	Add for settle flag switch related tab on 20220812 E*/
    } catch (e) {
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_SETTLE_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_TTL_REFUND_INT_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_TTL_REFUND_INT_onchange", e);
    }
}



csFuncLevelProto.FLD_FAEF_FA_EARLY_SETL_FEE_onchange = function() {
    try {
		document.MAINFORM.FA_EARLY_SETL_FEE.value = SYT_CCY_AMT(document.MAINFORM.FA_PMT_CCY.value, document.MAINFORM.FA_EARLY_SETL_FEE.value);
		SYF_FAEF_MLDC_SetDebitCreditData();
    } catch (e) {
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_EARLY_SETL_FEE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_LOAN_ID_BTN_onclick = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_Settlement_ME.js*FLD_FAEF_FA_LOAN_ID_BTN_onclick", e);
    }
}