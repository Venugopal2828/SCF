...
csFuncLevelProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*CancelCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*ConfirmBusinessCall", e);
    }
}

csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        if (!SYM_IPLC_CHK_MT740_sent()) {
            return false;
        }
        if (!SYM_IPLC_CHK_NEW_EXPIRY()) {
            return false;
        }
        if (!SYM_IPLC_CHK_NEW_AVAL_BY()) {
            return false;
        }
        return Cal_eloan_fields_IPLC();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYF_IPLC_Cal_clear_Amd_contents();
        ...
        document.MAINFORM.NEW_REIM_BK_ID.value = document.MAINFORM.REIM_BK_ID.value;
        document.MAINFORM.NEW_REIM_BK_NM.value = document.MAINFORM.REIM_BK_NM.value;
        document.MAINFORM.NEW_REIM_BK_ADD1.value = document.MAINFORM.REIM_BK_ADD1.value;
        document.MAINFORM.NEW_REIM_BK_ADD2.value = document.MAINFORM.REIM_BK_ADD2.value;
        document.MAINFORM.NEW_REIM_BK_ADD3.value = document.MAINFORM.REIM_BK_ADD3.value;
        document.MAINFORM.NEW_REIM_BK_MAIL_ADD.value = document.MAINFORM.REIM_BK_MAIL_ADD.value;
        document.MAINFORM.NEW_REIM_BK_SW_TAG.value = document.MAINFORM.REIM_BK_SW_TAG.value;
        document.MAINFORM.NEW_REIM_BK_SW_ADD.value = document.MAINFORM.REIM_BK_SW_ADD.value;
        document.MAINFORM.NEW_REIM_BK_CORR_MED.value = document.MAINFORM.REIM_BK_CORR_MED.value;
        document.MAINFORM.NEW_REIM_BK_AC_NO.value = document.MAINFORM.REIM_BK_AC_NO.value;
        document.MAINFORM.NEW_APLB_RULE_40F.value = document.MAINFORM.APLB_RULE_40F.value;
        document.MAINFORM.NEW_REIM_BK_CHG_DESC.value = document.MAINFORM.REIM_BK_CHG_DESC.value;
        document.MAINFORM.NEW_REIM_BK_REF.value = document.MAINFORM.REIM_BK_REF.value;
        document.MAINFORM.NEW_REIM_BK_OTH_CHG_NARR.value = document.MAINFORM.REIM_BK_OTH_CHG_NARR.value;
        document.MAINFORM.NEW_BK_TO_BK_INFO.value = document.MAINFORM.BK_TO_BK_INFO.value;
        document.MAINFORM.NEW_REIM_NARR_TAG_77.value = document.MAINFORM.REIM_NARR_TAG_77.value;
        document.MAINFORM.NEW_APPL_ID.value = document.MAINFORM.APPL_ID.value;
        //SYT_ChangeFldClass(document.MAINFORM.AC_OFFICER_CODE, "O");
        SYF_IPLC_NO_OF_DRAW();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*InitValues", e);
    }
}
...
csFuncLevelProto.LoadDODataOnInit = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*LoadDODataOnInit", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        FLD_IPLC_NEW_REIM_BK_ID_onchange();
        ...
        SYF_IPLC_Change_AMD_CHG_PAY_BY();
        SYM_IPLC_CHK_NEW_REIM_BK_AUTH_REQ();
        ...
        SYF_IPLC_Chk_NEW_AVAL_BY_POST();
        var AMD_ADDIT_CONDITION = document.MAINFORM.AMD_ADDIT_CONDITION.value;
        EEHtml.fireEvent(document.MAINFORM.NEW_AVAL_BY, 'onchange');
        document.MAINFORM.AMD_ADDIT_CONDITION.value = AMD_ADDIT_CONDITION;
        SYM_IPLC_showMixPayment();
        FLD_IPLC_NEW_TENOR_DAYS_onchange();
        FLD_IPLC_NEW_TENOR_TYPE_onchange();
        FLD_IPLC_SAME_AS_APPL_FLG_onchange();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_APPL_ID_CHG = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_APPL_ID_CHG", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_APPL_ID_back = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_APPL_ID_back", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_APPL_ID_inFUNC = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CAL_APPL_ID_inFUNC", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_FORACOF_ID_inFUNC = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CAL_FORACOF_ID_inFUNC", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_NEW_LC_BAL = function() {
    try {
        ...
        if (POS_TOL > 0 || INC_AMT > 0 || DEC_AMT > 0) {
            ...
            EEHtml.fireEvent(document.MAINFORM.NEW_LC_BAL, "onchange"); //sunny
            if (SYS_BeFloat(document.MAINFORM.MAST_LC_AMT.value) > 0 && SYS_BeFloat(document.MAINFORM.NEW_LC_AMT.value) > SYS_BeFloat(document.MAINFORM.MAST_LC_AMT.value)) {
                alert("The Increased Amount Exceed the Master LC amount!");
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CAL_NEW_LC_BAL", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_NO_OF_AMD = function(ref) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CAL_NO_OF_AMD", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_Temp_Tolerance = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CAL_Temp_Tolerance", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CAL_Tolerance = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CAL_Tolerance", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHARGE = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CHARGE", e);
    }
}

csFuncLevelProto.SYF_IPLC_CHECK_52_50B = function() {
    try {
        var ADV_BK_CORR_MED = document.MAINFORM.ADV_BK_CORR_MED.value;
        var ISSUE_BK_ID = document.MAINFORM.ISSUE_BK_ID.value;
        var NON_BANK_ISSUER_ID = document.MAINFORM.NON_BANK_ISSUER_ID.value;
        if (ADV_BK_CORR_MED == 'SWIFT') {
            if (ISSUE_BK_ID == '' && NON_BANK_ISSUER_ID == '') {
                ...
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ID, 'M');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ID_BTN, 'O');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_NM, 'O');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD1, 'O');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD2, 'O');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD3, 'O');
            } else if (ISSUE_BK_ID == '' && NON_BANK_ISSUER_ID != '') {
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_ID, 'B');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_ID_BTN, 'P');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_NM, 'B');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_ADD_BTN, 'P');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_ADD1, 'B');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_ADD2, 'B');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_ADD3, 'B');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_SW_TAG, 'B');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_SW_ADD, 'B');

                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ID, 'M');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ID_BTN, 'O');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_NM, 'M');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD1, 'M');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD2, 'M');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD3, 'M');
            } else if (ISSUE_BK_ID != '' && NON_BANK_ISSUER_ID == '') {
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_ID, 'O');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_ID_BTN, 'O');
                SYT_ChangeFldClass(document.MAINFORM.ISSUE_BK_NM, 'M');
                ...
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ID, 'B');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ID_BTN, 'P');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_NM, 'B');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD1, 'B');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD2, 'B');
                SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ADD3, 'B');
            } else {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CHECK_52_50B", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_INC_DEC_AMT = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CHK_INC_DEC_AMT", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_NEW_DATES = function() {
    try {
        ...
        if (document.MAINFORM.NEW_EXPIRY_DT.value != '' && document.MAINFORM.MAST_EXPIRY_DT.value != '') {
            nDays4 = SYS_GetSubDays(document.MAINFORM.MAST_EXPIRY_DT.name, document.MAINFORM.NEW_EXPIRY_DT.name);
            if (nDays4 > 0) {
                SYS_CheckError(document.MAINFORM.NEW_EXPIRY_DT, "The Expiry Date must be earlier than the Master LC expiry Date.");
                document.MAINFORM.NEW_EXPIRY_DT.value = '';
            }

        }
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CHK_NEW_DATES", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_NEW_LCAMTBAL = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CHK_NEW_LCAMTBAL", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_NEW_PRES_DAYS = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CHK_NEW_PRES_DAYS", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_NEW_SHIP_PRD = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_CHK_NEW_SHIP_PRD", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_AMD_PRES_PRD_TXT = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Cal_AMD_PRES_PRD_TXT", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_DetrimentalAMT = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Cal_DetrimentalAMT", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_IPLC_OPEN_COMM_DEF = function() {
    try {
        ...
        //Cal IPLC_OPEN_COMM  from ISSUE_DT  to AMD_DT
        if (Obj_IPLC_OPEN_COMM_DEF && ((INC_AMT_value != "" && INC_AMT_value != 0) || (DEC_AMT_value != "" && DEC_AMT_value != 0) || NEW_EXPIRY_DT_value != "")) {
            ...
            if (Obj_IPLC_OPEN_COMM_DEF && (INC_AMT_value == "" || INC_AMT_value == 0) && (DEC_AMT_value == "" || DEC_AMT_value == 0) && NEW_EXPIRY_DT_value == "") {
                Obj_IPLC_OPEN_COMM_DEF[0]._refresh(); // Utility Auto Fix Comments
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Cal_IPLC_OPEN_COMM_DEF", e);
    }
}

csFuncLevelProto.SYF_IPLC_Cal_NO_OF_AMD_B = function() {
    try {
        document.MAINFORM.NO_OF_AMD_B.value = SYS_BeFloat(document.MAINFORM.NO_OF_AMD.value) + 1;
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Cal_NO_OF_AMD_B", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_SameAsApplicant_2 = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Cal_SameAsApplicant_2", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_TEMP_EXPIRY_PLC_NARR = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Cal_TEMP_EXPIRY_PLC_NARR", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_clear_Amd_contents = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Cal_clear_Amd_contents", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_temp_amd_no_b = function() {
    try {
        if (document.MAINFORM.NO_OF_AMD_B.value != '' && document.MAINFORM.NO_OF_AMD_B.value <= 9) {
            document.MAINFORM.TEMP_AMD_NO.value = '00' + document.MAINFORM.NO_OF_AMD_B.value;
        } else {
            document.MAINFORM.TEMP_AMD_NO.value = '0' + document.MAINFORM.NO_OF_AMD_B.value;
        }
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Cal_temp_amd_no_b", e);
    }
}

csFuncLevelProto.SYF_IPLC_Change_AMD_CHG_PAY_BY = function() {
    try {
        if (document.MAINFORM.AMD_CHG_PAY_BY.value == 'OTHR') {
            document.MAINFORM.AMD_CHG_PAY_BY_NARR.style.visibility = "visible";
            SYT_ChangeFldClass(document.MAINFORM.AMD_CHG_PAY_BY_NARR, "M");
        } else {
            document.MAINFORM.AMD_CHG_PAY_BY_NARR.value = '';
            SYT_ChangeFldClass(document.MAINFORM.AMD_CHG_PAY_BY_NARR, "O");
            document.MAINFORM.AMD_CHG_PAY_BY_NARR.style.visibility = "hidden";
        }
        if (document.MAINFORM.AMD_CHG_PAY_BY.value != '') {
            document.MAINFORM.TEMP_AMD_CHG_PAY_BY.value = '/' + document.MAINFORM.AMD_CHG_PAY_BY.value + '/';
        } else {
            document.MAINFORM.TEMP_AMD_CHG_PAY_BY.value = '';
        }
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_AMD_CHG_PAY_BY", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_APLB_RULE = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_APLB_RULE", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_EXPIRY_PLC = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_EXPIRY_PLC", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_NEW_APLB_RULE = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_NEW_APLB_RULE", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_NEW_EXPIRY_PLC = function() {
    try {
        if (document.MAINFORM.NEW_EXPIRY_PLC.value == 'Other') {
            ...
            SYT_ChangeFldClass(document.MAINFORM.NEW_EXPIRY_PLC_NA, 'O');
            document.MAINFORM.NEW_EXPIRY_PLC_NA.style.visibility = "hidden";
        }
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_NEW_EXPIRY_PLC", e);
    }
}

csFuncLevelProto.SYF_IPLC_Change_NEW_PARTIAL_SHIP = function() {
    try {
        if (document.MAINFORM.NEW_PARTIAL_SHIP.value == 'CONDITIONAL') {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_NEW_PARTIAL_SHIP", e);
    }
}

csFuncLevelProto.SYF_IPLC_Change_NEW_TNSHIP = function() {
    try {
        if (document.MAINFORM.NEW_TNSHIP.value == 'CONDITIONAL') {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_NEW_TNSHIP", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_PARTIAL_SHIP = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_PARTIAL_SHIP", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_SameAsApplicant = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_SameAsApplicant", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Change_TNSHIP = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Change_TNSHIP", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Chk_AVAL_BY = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Chk_AVAL_BY", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Chk_NEW_AVAL_BY = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Chk_NEW_AVAL_BY", e);
    }
}

csFuncLevelProto.SYF_IPLC_Chk_NEW_AVAL_BY_POST = function() {
    try {
        if (document.MAINFORM.NEW_AVAL_BY.value == '') {
            SYT_ChangeFldClass(document.MAINFORM.NEW_DRWE_ID, "O");
            SYT_ChangeFldClass(document.MAINFORM.NEW_DRWE_NM, "O");
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Chk_NEW_AVAL_BY_POST", e);
    }
}

csFuncLevelProto.SYF_IPLC_FORACOF_CHG_back = function() {
    try {
        SYS_GetCUBK('FORACOF_ID', document.MAINFORM.FORACOF_ID.name, 'SYF_IPLC_CHARGE');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_FORACOF_CHG_back", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_FORACOF_ID_back = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_FORACOF_ID_back", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_MT798_FLAG = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_MT798_FLAG", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_NARRATIVE = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_NARRATIVE", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_NEW_58 = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_NEW_58", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_NEW_AVAL_BY_class = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_NEW_AVAL_BY_class", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_NO_OF_DRAW = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_NO_OF_DRAW", e);
    }
}

csFuncLevelProto.SYF_IPLC_NEW_AVAL_BY_default = function() {
    try {
        var NO_OF_DRAW;
        NO_OF_DRAW = document.MAINFORM.NO_OF_DRAW.value;
        if (NO_OF_DRAW >= 1) {
        	if(document.MAINFORM.NEW_AVAL_WT_BK_OPT.value!=''||document.MAINFORM.NEW_AVAL_WT_BK_NM.value!=''||document.MAINFORM.NEW_AVAL_WT_BK_SW_ADD.value!=''){
            //for mt707
            document.MAINFORM.NEW_AVAL_BY.value=document.MAINFORM.AVAL_BY.value;
            document.MAINFORM.NEW_TENOR_DAYS.value=document.MAINFORM.TENOR_DAYS.value;
            document.MAINFORM.NEW_TENOR_TYPE.value=document.MAINFORM.TENOR_TYPE.value;
            document.MAINFORM.NEW_MIX_PMT_DETL.value=document.MAINFORM.MIX_PMT_DETL.value;
        }else{
...
csFuncLevelProto.SYF_IPLC_SetAmdRef = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_SetAmdRef", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Tenor_Narrative = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_Tenor_Narrative", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_getDOdata_AdviceForBankCust = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*SYF_IPLC_getDOdata_AdviceForBankCust", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*addRecordCheck", e);
    }
}
...
csFuncLevelProto.deleteRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*deleteRecordCheck", e);
    }
}
...
csFuncLevelProto.editRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*editRecordCheck", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_SW_ADD_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_ADDIT_CONDITION_onchange = function(event) {
    try {
        //SYF_IPLC_NARRATIVE();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_ADDIT_CONDITION_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_CHG_PAY_BY_onchange = function(event) {
    try {
        SYF_IPLC_Change_AMD_CHG_PAY_BY();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_CHG_PAY_BY_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_DESC_OF_GOODS_onchange = function(event) {
    try {
        //SYF_IPLC_NARRATIVE();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_DESC_OF_GOODS_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_DOC_REQ_onchange = function(event) {
    try {
        //SYF_IPLC_NARRATIVE();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_DOC_REQ_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_DT_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_PRES_DAYS_onchange = function(event) {
    try {
        SYF_IPLC_CHK_NEW_PRES_DAYS();
        SYF_IPLC_Cal_AMD_PRES_PRD_TXT();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_PRES_DAYS_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_PRES_TYPE_onchange = function(event) {
    try {
        SYF_IPLC_Cal_AMD_PRES_PRD_TXT();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_PRES_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPLY_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPLY_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ID_onchange = function(event) {
    try {
        ...
        EEHtml.fireEvent(document.MAINFORM.APPL_BK_CORR_MED, 'onchange'); // Utility Auto Fix Comments
        SYM_IPLC_CHK_APPL_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_BY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_BY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_OPT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_OPT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_AC_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_BENE_AC_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_BENE_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_BENE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_BENE_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_BENE_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_BAL_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CHG_FLD_ALL_BAL_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_CHARGE_AT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CHG_FLD_ALL_CHARGE_AT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_CHARGE_FOR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CHG_FLD_ALL_CHARGE_FOR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_COLLECT_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CHG_FLD_COLLECT_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_LOCAL_CUST_AC_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CHG_FLD_LOCAL_CUST_AC_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CONF_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CONF_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DEC_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DEC_AMT_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_DEF_PMT_DET_onchange = function(event) {
    try {
        SYF_IPLC_Tenor_Narrative();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DEF_PMT_DET_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DETRMNTL_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DETRMNTL_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DIARY_NARRATIVE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DIARY_NARRATIVE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRAFTS_AT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRAFTS_AT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRWE_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRWE_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRWE_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRWE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRWE_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRWE_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRWE_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_FORACOF_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_FORACOF_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INC_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_INC_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_ID_onchange = function(event) {
    try {
        ...
        SYF_IPLC_CHECK_52_50B();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ISSUE_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_NM_onchange = function(event) {
    try {
        if (document.MAINFORM.ISSUE_BK_ID.value == '' && document.MAINFORM.ISSUE_BK_NM.value == '') {
            ...
            SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ID, "O");
        }
        if (ADV_BK_CORR_MED == 'SWIFT') {
            SYT_ChangeFldClass(document.MAINFORM.NON_BANK_ISSUER_ID, "P");
        }
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ISSUE_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ISSUE_BK_SW_ADD_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_MIX_PMT_DETL_onchange = function(event) {
    try {
        SYF_IPLC_Tenor_Narrative();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_MIX_PMT_DETL_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ADD1_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_ADV_THU_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_ADV_THU_BK_ADD1_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ADD2_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_ADV_THU_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_ADV_THU_BK_ADD2_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ADD3_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_ADV_THU_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_ADV_THU_BK_ADD3_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ID_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_ADV_THU_BK_ID();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_ADV_THU_BK_ID_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_NM_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_ADV_THU_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_ADV_THU_BK_NM_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_SW_ADD_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_ADV_THU_BK_SW_TAG();
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_ADV_THU_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_AMT_SPEC_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AMT_SPEC_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_APLB_RULE_onchange = function(event) {
    try {
        SYF_IPLC_Change_NEW_APLB_RULE();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_APLB_RULE_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_APLB_RULE_NARR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_APLB_RULE_NARR_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_APPL_ORDER_NO_onchange = function(event) {
    try {
        SYS_GetCUBK('NEW_APPL_CUST_MULT_ADD', "NEW_APPL_ORDER_NO;NEW_APPL_ID");
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_APPL_ORDER_NO_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_BY_onchange = function(event) {
    try {
        document.MAINFORM.AMD_ADDIT_CONDITION.value = '';
        ...
        SYM_IPLC_addPaymentRecord();
      if(document.MAINFORM.NEW_AVAL_BY.value!=''){
      	SYT_ChangeFldClass(document.MAINFORM.NEW_AVAL_WT_BK_OPT, 'M');
      }else{
      	SYT_ChangeFldClass(document.MAINFORM.NEW_AVAL_WT_BK_OPT, 'O');
      }
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AVAL_BY_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ID_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_AVAL_WT_BK_ID();
        SYF_IPLC_NEW_AVAL_BY_default();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AVAL_WT_BK_ID_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_NM_onchange = function(event) {
    try {
        SYF_IPLC_NEW_AVAL_BY_default();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AVAL_WT_BK_NM_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_OPT_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_AVAL_WT_BK_OPT();
        EEHtml.fireEvent(document.MAINFORM.NEW_AVAL_WT_BK_SW_ADD, 'onchange');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AVAL_WT_BK_OPT_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ORDER_NO_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_AVAL_WT_BK_MULT_ORDER_NO();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AVAL_WT_BK_ORDER_NO_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_SW_ADD_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_AVAL_WT_BK_SW_TAG();
        SYM_IPLC_SQL_NEW_AVAL_WT_BK_SW_ADD();
        SYF_IPLC_NEW_AVAL_BY_default();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AVAL_WT_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ACNO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_BENE_ACNO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_BENE_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_BENE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_BENE_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_BENE_ORDER_POST_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ADD1_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_CONF_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_CONF_BK_ADD1_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ADD2_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_CONF_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_CONF_BK_ADD2_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ADD3_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_CONF_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_CONF_BK_ADD3_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ID_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_CONF_BK_ID();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_CONF_BK_ID_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_NM_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_CONF_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_CONF_BK_NM_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_SW_ADD_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_CONF_BK_SW_TAG();
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_CONF_BK_SW_ADD_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_INSTR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_CONF_INSTR_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_DRWE_ID_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_DRWE_ID();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_DRWE_ID_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_DRWE_ORDER_NO_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_DRWE_MULT_ORDER_NO();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_DRWE_ORDER_NO_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_DRWE_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_DRWE_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_EXPIRY_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_EXPIRY_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_EXPIRY_PLC_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_EXPIRY_PLC_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_LC_AMT_onchange = function(event) {
    try {
        SYF_IPLC_Cal_DetrimentalAMT();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_LC_AMT_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_LC_BAL_onchange = function(event) {
    try {
        SYF_IPLC_Cal_DetrimentalAMT();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_LC_BAL_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_LTST_SHIP_DT_onchange = function(event) {
    try {
        SYF_IPLC_CHK_NEW_DATES();

        SYF_IPLC_CHK_NEW_SHIP_PRD();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_LTST_SHIP_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_PARTIAL_SHIP_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_PARTIAL_SHIP_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_POS_TOL_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_POS_TOL_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_AUTH_REQ_onchange = function(event) {
    try {
        SYM_IPLC_CHK_NEW_REIM_BK_AUTH_REQ();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_AUTH_REQ_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_CORR_MED_onchange = function(event) {
    try {
        SYM_IPLC_NEW_REIM_BK_MAIL_ADD();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_CORR_MED_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ID_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_REIM_BK_ID();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_ID_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ORDER_NO_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_REIM_BK_MULT_ORDER_NO();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_ORDER_NO_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ORDER_POST_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_REIM_BK_MAIL_ORDER_NO();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_ORDER_POST_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_SW_ADD_onchange = function(event) {
    try {
        SYM_IPLC_CAL_NEW_REIM_BK_ID_back();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_SW_ADD_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_TENOR_DAYS_onchange = function(event) {
    try {
        SYM_IPLC_NEW_Pay_By_Acceptance();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_TENOR_DAYS_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_TENOR_TYPE_onchange = function(event) {
    try {
        SYM_IPLC_NEW_Pay_By_Acceptance();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_TENOR_TYPE_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_TNSHIP_onchange = function(event) {
    try {
        SYF_IPLC_Change_NEW_TNSHIP();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_TNSHIP_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_NON_BANK_ISSUER_ID_onchange = function(event) {
    try {
        SYT_GetCUBK_All('NON_BANK_ISSUER_ID', 'NON_BANK_ISSUER_ID');
        SYF_IPLC_CHECK_52_50B();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NON_BANK_ISSUER_ID_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_PARTIAL_SHIP_onchange = function(event) {
    try {} catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_PARTIAL_SHIP_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_AUTH_REQ_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_AUTH_REQ_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_SAME_AS_APPL_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_SAME_AS_APPL_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_TENOR_DAYS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_TENOR_DAYS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_TENOR_TYPE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_TENOR_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THRU_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THRU_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ADV_THU_BK_POST_ADD_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_ADDIT_CONDITION_CLAUSE_BTN_onclick = function(event) {
    try {
        SYS_InsertClause('AMD_ADDIT_CONDITION');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_ADDIT_CONDITION_CLAUSE_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_CHARGES_CLAUSE_BTN_onclick = function(event) {
    try {
        SYS_InsertClause('AMD_CHARGES');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_CHARGES_CLAUSE_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_DOC_REQ_BTN_onclick = function(event) {
    try {
        SYS_InsertClause('AMD_DOC_REQ');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_DOC_REQ_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_GOOD_DESC_BTN_onclick = function(event) {
    try {
        SYS_InsertClause('AMD_DESC_OF_GOODS');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_GOOD_DESC_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_INSTR_TO_PAY_BK_BTN_onclick = function(event) {
    try {
        SYS_InsertClause('AMD_INSTR_TO_PAY_BK');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_INSTR_TO_PAY_BK_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_AMD_SEND_TO_RCV_INFO_CLAUSE_BTN_onclick = function(event) {
    try {
        SYS_InsertClause('AMD_SEND_TO_RCV_INFO');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AMD_SEND_TO_RCV_INFO_CLAUSE_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPL_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_APPL_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVAL_WT_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVAL_WT_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AVLBL_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_AVLBL_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_BENE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_BENE_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENE_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_BENE_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_GETAC_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CHG_GETAC_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_VALUE_DATE_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CHG_VALUE_DATE_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CONF_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_CONF_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRWE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRWE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRW_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_DRW_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_FORACOF_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_FORACOF_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FORACOF_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_FORACOF_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ISSUE_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_ISSUE_BK_ID_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_ADV_THRU_BK_ID_BTN_onclick = function(event) {
    try {
        SYM_IPLC_SQL_NEW_ADV_THU_BK();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_ADV_THRU_BK_ID_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_ADV_THU_BK_ADD_BTN_onclick = function(event) {
    try {
        SYM_IPLC_CAL_NEW_ADV_THU_BK_MULT_ADD();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_ADV_THU_BK_ADD_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_APPL_ADD_BTN_onclick = function(event) {
    try {
        SYS_InqCUBK_byCondition('NEW_APPL_CUST_MULT_ADD', '1');
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_APPL_ADD_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVAL_WT_BK_ADD_BTN_onclick = function(event) {
    try {
        SYM_IPLC_CAL_NEW_AVAL_WT_BK_MULT_ADD();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AVAL_WT_BK_ADD_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_AVLBL_BK_ID_BTN_onclick = function(event) {
    try {
        SYM_IPLC_SQL_NEW_AVAL_WT_BANK();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_AVLBL_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_BENE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_BENE_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_NEW_BENE_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_BENE_POST_ADD_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_CONF_BK_ID_BTN_onclick = function(event) {
    try {
        SYM_IPLC_SQL_NEW_CONF_BANK();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_CONF_BK_ID_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_DRWE_ADD_BTN_onclick = function(event) {
    try {
        SYM_IPLC_CAL_NEW_DRWE_MULT_ADD();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_DRWE_ADD_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_DRWE_ID_BTN_onclick = function(event) {
    try {
        SYM_IPLC_SQL_NEW_DRWE_BANK();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_DRWE_ID_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ADD_BTN_onclick = function(event) {
    try {
        SYM_IPLC_CAL_REIM_BK_MULT_ADD();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_ADD_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_ID_BTN_onclick = function(event) {
    try {
        SYM_IPLC_SQL_NEW_REIM_BANK();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_ID_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NEW_REIM_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        SYM_IPLC_CAL_NEW_REIM_BK_MAIL_ADD();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NEW_REIM_BK_POST_ADD_BTN_onclick", e);
    }
}

csFuncLevelProto.FLD_IPLC_NON_BANK_ISSUER_ID_BTN_onclick = function(event) {
    try {
        var retvalue;
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_NON_BANK_ISSUER_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_REIM_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_REIM_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button2_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_button2_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button3_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_button3_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button4_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_button4_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button5_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_button5_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button6_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_button6_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_view_1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_IssueLCAmendmentOneStep.js*FLD_IPLC_view_1_onclick", e);
    }
}