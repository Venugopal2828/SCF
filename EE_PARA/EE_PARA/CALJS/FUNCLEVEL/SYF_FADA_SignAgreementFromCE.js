...
csFuncLevelProto.SYF_FADA_CHECK_BUSI_TYPE_FIELD = function() {
    try {
        ...
        DisExcpt("SYF_FADA_SignAgreementFromCE.js", e);
    }
}
...
csFuncLevelProto.SYF_FADA_CHECK_DO_ENABLE = function() {
    try {
        ...
        if (document.MAINFORM.FA_BUSI_TYPE.value == 'RF' || document.MAINFORM.FA_BUSI_TYPE.value == 'DF' || document.MAINFORM.FA_BUSI_TYPE.value == 'POF') {
...
csFuncLevelProto.SYF_FADA_CHECK_DO_NO = function() {
    try {
        ...
        if ((document.MAINFORM.FA_BUSI_TYPE.value == 'DF' || document.MAINFORM.FA_BUSI_TYPE.value == 'RF' || document.MAINFORM.FA_BUSI_TYPE.value == 'POF') && document.MAINFORM.FA_NO_OF_COUNTER.value == 0) {
