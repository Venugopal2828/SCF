...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        DisExcpt("SYF_PYMT_ReversalsPayment.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_Check_Reve_Ac_No = function() {
    try {
        ...
        if (document.MAINFORM.REVE_AC_NO.value.trim().length == 0) {
            ...
            //Sql_Cond = "C_ACCT_CCY=" + "'" + document.MAINFORM.REVE_CCY.value + "'" + " AND " + "C_ACCT_WITH_ID=" + "'" + document.MAINFORM.REVE_AC_NO.value + "'";
            //Field_List = "C_ACCT_WITH_ID";
            //Mapping_List = "C_ACCT_WITH_ID";
            SYS_GetTableDataByRule_S('SYF_PYMT_ReversalsPayment_SYF_PYMT_Check_Reve_Ac_No_0', '1', 'Sett_AccNo_Succ', 'false');
            if (document.MAINFORM.C_ACCT_WITH_ID.value != document.MAINFORM.REVE_AC_NO.value) {
