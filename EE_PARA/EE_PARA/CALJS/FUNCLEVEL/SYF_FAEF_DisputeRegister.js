...
csFuncLevelProto.SYF_FAEF_RefreshOptions = function(mappingList) {
    try {
        ...
        DisExcpt("SYF_FAEF_DisputeRegister.js", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_DSP_REF_onchange = function(event) {
    try {
        SYF_FAEF_SetDspRef();
...
csFuncLevelProto.FLD_FAEF_FA_NOTIFY_BY_onchange = function(event) {
    try {
