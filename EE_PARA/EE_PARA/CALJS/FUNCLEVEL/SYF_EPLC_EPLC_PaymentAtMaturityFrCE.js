...
csFuncLevelProto.SYF_EPLC_BY_STL_INSTR_FLG = function() {
    try {
        ...
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE.js", e);
    }
}
...
csFuncLevelProto.SYF_EPLC_CAL_AMT_TO_BENE_PRES_CCY = function() {
    try {
        ...
        AMT_TOTAL = TTL_STL_AMT_RCV - OUR_CHGS_APPL - ADV_BK_CHGS - ADDIT_PRES_BK_AMTS - PRES_BK_CHGS; // Utility Auto Fix Comments

        if (document.MAINFORM.DISCNT_FLG.value == 'YES') {
            if (AMT_TOTAL > CFNC_N_AMT_LCCCY) {
                NET_AMT_PD_BENE = AMT_TOTAL - CFNC_N_AMT_LCCCY; // Utility Auto Fix Comments
                document.MAINFORM.NET_AMT_PD_BENE.value = SYT_AmtFormat(document.MAINFORM.PRES_CCY.value, NET_AMT_PD_BENE);
                document.MAINFORM.AMT_TO_BENE_PRES_CCY.value = SYT_AmtFormat(document.MAINFORM.PRES_CCY.value, NET_AMT_PD_BENE);
            } else {
            ...
            AMT_TO_BENE_PRES_CCY = NET_AMT_PD_BENE - ADV_BK_CHGS_BENE - TNSFR_DOCS_DEDUCT_AMT - ASSIGN_DEDUCT_AMT - ADV_BK_CHGS - ADDIT_PRES_BK_AMTS - PRES_BK_CHGS;
...
csFuncLevelProto.SYF_EPLC_CAL_NET_PD_BENE = function() {
    try {
        ...
        NET_AMT_PD_BENE = TTL_STL_AMT_RCV - OUR_CHGS_BENE - OUR_CHGS_APPL - ISSUE_BK_CHG;
        document.MAINFORM.NET_AMT_PD_BENE.value = SYT_AmtFormat(document.MAINFORM.PRES_CCY.value, NET_AMT_PD_BENE);
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE.js", e);
    }
    ...
    try {
        ...
        if (document.MAINFORM.SEND_MT754_FLG.value == "YES") {
            ...
            if (document.MAINFORM.ADDIT_PRES_BK_CCY.value == document.MAINFORM.PRES_CCY.value) {
                ...
                document.MAINFORM.X754_ADDIT_AMT_33B.value = 0.00;
...
csFuncLevelProto.SYF_EPLC_loadDoDataComplete = function() {
    try {
        ...
        if (SYS_FUNCTION_TYPE != 'RE' && SYS_FUNCTION_TYPE != 'IQ' && SYS_FUNCTION_TYPE != 'EC') {
            ...
            document.MAINFORM.TTL_STL_AMT_DR.value = SYS_BeFloat(document.MAINFORM.TTL_STL_AMT_RCV.value) - SYS_BeFloat(document.MAINFORM.ISSUE_BK_CHG.value);
...
csFuncLevelProto.FLD_EPLC_ISSUE_BK_CHG_onchange = function(event) {
    try {
        SYF_EPLC_CAL_NET_PD_BENE();
        document.MAINFORM.NET_AMT_PD_BENE.fireEvent('onchange');
        document.MAINFORM.TTL_STL_AMT_DR.fireEvent('onchange');
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE.js", e);
    }
}

csFuncLevelProto.FLD_EPLC_ISSUE_BK_CHG_CCY_onchange = function(event) {
    try {
        document.MAINFORM.AMT_TO_BENE_PRES_CCY.fireEvent('onchange');
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE.js", e);
    }
}
...
csFuncLevelProto.FLD_EPLC_STL_AMT_onchange = function(event) {
    try {
        SYF_EPLC_CAL_CONF_BAL();
        document.MAINFORM.CONF_BAL.fireEvent('onchange');
        document.MAINFORM.TTL_STL_AMT_RCV.fireEvent('onchange');
        document.MAINFORM.AMT_TO_BENE_PRES_CCY.fireEvent('onchange');
        document.MAINFORM.LIAB_BAL.fireEvent('onchange');
        document.MAINFORM.TEMP_STL_AMT.fireEvent('onchange');
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE.js", e);
    }
}
...
csFuncLevelProto.FLD_EPLC_STL_BAL_onchange = function(event) {
    try {
        document.MAINFORM.TEMP_STL_BAL.fireEvent('onchange');
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE.js", e);
    }
}
...
csFuncLevelProto.FLD_EPLC_TTL_STL_AMT_onchange = function(event) {
    try {
        document.MAINFORM.TEMP_TTL_STL_AMT.fireEvent('onchange');
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE.js", e);
    }
}
...
csFuncLevelProto.FLD_EPLC_TTL_STL_AMT_RCV_onchange = function(event) {
    try {
        SYF_EPLC_CAL_NET_PD_BENE();
        EEHtml.fireEvent(document.MAINFORM.NET_AMT_PD_BENE, 'onchange');
        EEHtml.fireEvent(document.MAINFORM.TTL_STL_AMT_DR, 'onchange');
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE.js", e);
    }
}
