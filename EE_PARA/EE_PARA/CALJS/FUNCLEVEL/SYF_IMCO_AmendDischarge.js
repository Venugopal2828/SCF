...
csFuncLevelProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*CancelCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        if (document.MAINFORM.CLS_FLG.value == 'Yes') {
            document.MAINFORM.NXT_STATUS.value = 'Closed';
        }
        ...
        if (document.MAINFORM.NEW_DRWE_MAIL_ADD.value != '') {
            ...
            document.MAINFORM.DRWE_MAIL_ADD.value = document.MAINFORM.TEMP_DRWE_MAIL_ADD.value;
        }
        if (document.MAINFORM.NEW_DRWE_NM.value != '') {
            document.MAINFORM.DRWE_NM.value = document.MAINFORM.NEW_DRWE_NM.value;
        } else {
            document.MAINFORM.DRWE_NM.value = document.MAINFORM.TEMP_DRWE_NM.value;
        }
        ...
        if (document.MAINFORM.NEW_DRWE_REF.value != '') {
            ...
            document.MAINFORM.DRWE_REF.value = document.MAINFORM.TEMP_DRWE_REF.value;
        }
        if (document.MAINFORM.NEW_DRWE_TELEX.value != '') {
            document.MAINFORM.DRWE_TELEX.value = document.MAINFORM.NEW_DRWE_TELEX.value;
        } else {
            document.MAINFORM.DRWE_TELEX.value = document.MAINFORM.TEMP_DRWE_TELEX.value;
        }
        ...
        document.MAINFORM.TEMP_TENOR_DAYS_32K.value = document.MAINFORM.TEP_TENOR_32K.value.substr(0, 6);

        Cal_MSG_TYPE();

        SYT_Document_Against();
        SYT_AMD_SWIFT_MAT();

        //Add on 20181126 for pilot bug #63160;
        ...
        document.MAINFORM.TEMP_TENOR_DAYS_33K.value = document.MAINFORM.TEMP_TENOR_33K.value.substr(0, 6); //Add on20181225 FOR #63159
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*ConfirmBusinessCall", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        if (document.MAINFORM.SEND_AMD_BY.value == 'MT430' && document.MAINFORM.OUR_ROLE.value != 'First Collecting Bank') {
            alert("Our Role should be First Collecting Bank when send MT430!");
            document.MAINFORM.OUR_ROLE.value = '';
            return false;
        }
        return true;
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.NEW_DELVR_DOC_AGST.value = document.MAINFORM.TEMP_DELVR_DOC_AGST.value;
        document.MAINFORM.NEW_TENOR_START_DT.value = document.MAINFORM.TEMP_TENOR_START_DT.value;
        document.MAINFORM.NEW_TENOR_DAYS.value = document.MAINFORM.TEMP_TENOR_DAYS.value;
        document.MAINFORM.NEW_DAY_MON_FLG.value = document.MAINFORM.TEMP_DAY_MON_FLG.value;
        document.MAINFORM.NEW_TENOR_EVENT.value = document.MAINFORM.TEMP_TENOR_EVENT.value;
        document.MAINFORM.NEW_DUE_DT.value = document.MAINFORM.TEMP_DUE_DT.value;
        document.MAINFORM.TEMP_TENOR_33K.value = document.MAINFORM.TEP_TENOR_32K.value;
        document.MAINFORM.NEW_TENOR_DETAILS.value = document.MAINFORM.TEMP_TENOR_DETAILS.value;
        SYF_IMCO_Init_CLS_FLG();
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*InitValues", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_CAL_TENOR_33K = function() {
    try {
        ...
        if (document.MAINFORM.NEW_DUE_DT.value == '') {
            ...
            // document.MAINFORM.TEMP_TENOR_33K.value = ''; 20181225 FOR #63159
        }
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_CAL_TENOR_33K", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_CHK_PRES_BK_REF = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_CHK_PRES_BK_REF", e);
    }
}

csFuncLevelProto.SYF_IMCO_CHK_SEND_AMD_BY = function() {
    try {
        if (document.MAINFORM.SEND_AMD_BY.value == 'MT430' && document.MAINFORM.OUR_ROLE.value != 'First Collecting Bank') {
            alert("Our Role should be First Collecting Bank when send MT430!");
            document.MAINFORM.OUR_ROLE.value = '';
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_CHK_SEND_AMD_BY", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_CLASS_BY_TENOR_TYPE = function() {
    try {
        if (document.MAINFORM.NEW_TENOR_EVENT.value == "XXX") {
            ...
            SYT_ChangeFldClass(document.MAINFORM.NEW_TENOR_EVENT, "M");
            SYT_ChangeFldClass(document.MAINFORM.NEW_TENOR_START_DT, 'P');
            ...
            if (document.MAINFORM.SEND_AMD_BY.value == 'MT430') {
                SYT_ChangeFldClass(document.MAINFORM.SEND_TO_RCV_INFO, "M");
            }
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_CLASS_BY_TENOR_TYPE", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_CLASS_BY_TENOR_TYPE_OLD = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_CLASS_BY_TENOR_TYPE_OLD", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_CLAUSE = function() {
    try {
        ...
        document.MAINFORM.SPCL_INSTR.value = sClause4 + sClause5;
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_CLAUSE", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_COURIER_FEE_CHG1 = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_COURIER_FEE_CHG1", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_MT4XX_32A_FLG = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Cal_MT4XX_32A_FLG", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_MT4XX_33A_FLG = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Cal_MT4XX_33A_FLG", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_NEW_COLL_AMT = function() {
    try {
        ...
        if (document.MAINFORM.NEW_COL_AMT_NCOL_CCY.value < 0) {
            ...
            SYT_ChangeFldClass(document.MAINFORM.NEW_DELVR_DOC_AGST, 'M');
        } else if (COLL_AMT < NEW_COLL_AMT) {
            ...
            document.MAINFORM.DEC_AMT.value = SYT_AmtFormat(document.MAINFORM.COLL_CCY.value, 0);
            document.MAINFORM.INC_AMT.value = SYT_AmtFormat(document.MAINFORM.COLL_CCY.value, 0);
            SYT_ChangeFldClass(document.MAINFORM.NEW_DELVR_DOC_AGST, 'O');
        }
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Cal_NEW_COLL_AMT", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_NO_OF_AMD = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Cal_NO_OF_AMD", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_REMIT_BK_NM = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Cal_REMIT_BK_NM", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Cal_SEND_AMD_BY = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Cal_SEND_AMD_BY", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Charge = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Charge", e);
    }
}

csFuncLevelProto.SYF_IMCO_Chk_AMD_DT = function() {
    try {
        if (SYS_GetSubDays(document.MAINFORM.AMD_DT.name, document.MAINFORM.REG_DT.name) > 0) {
            alert("Amendment Date is not allowed before the Registration Date");
            document.MAINFORM.AMD_DT.value = document.MAINFORM.REG_DT.value;
        }
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Chk_AMD_DT", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Chk_INC_DEC_AMT = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Chk_INC_DEC_AMT", e);
    }
}

csFuncLevelProto.SYF_IMCO_Chk_TENOR_DT = function() {
    try {
        if (SYS_GetSubDays(document.MAINFORM.REG_DT.name, document.MAINFORM.NEW_TENOR_START_DT.name) < 0) {
            alert("New Tenor Start Date is not allowed in the past times!");
            document.MAINFORM.NEW_TENOR_START_DT.value = '';
        } else if (SYS_GetSubDays(document.MAINFORM.NEW_TENOR_START_DT.name, document.MAINFORM.NEW_DUE_DT.name) < 0) {
            alert("New Tenor Maturity Date is not allowed before New Tenor Start Date!")
            document.MAINFORM.NEW_DUE_DT.value = '';
        }
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Chk_TENOR_DT", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_DRWR_ID_B = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_DRWR_ID_B", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_DRWR_NM_Z = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_DRWR_NM_Z", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_DRW_ID = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_DRW_ID", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Field = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Field", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Get_REMIT_BK_ID = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Get_REMIT_BK_ID", e);
    }
}

csFuncLevelProto.SYF_IMCO_Init_CLS_FLG = function() {
    try {
        var amd_type;
        amd_type = document.MAINFORM.AMD_TYPE.value;
        if (amd_type == "Release Free of Payment" || amd_type == "Close File and return documents") {
            document.MAINFORM.CLS_FLG.value = "Yes";
        } else {
            document.MAINFORM.CLS_FLG.value = "No";
        }
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Init_CLS_FLG", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_MAT_DT_back = function(matdt) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_MAT_DT_back", e);
    }
}

csFuncLevelProto.SYF_IMCO_MPO_BY_AMD_TYPE = function() {
    try {
        var amd_type;
        amd_type = document.MAINFORM.AMD_TYPE.value;
        if (amd_type == "Amendment") {
            SYT_ChangeFldClass(document.MAINFORM.CLS_FLG, 'O');
            document.MAINFORM.CLS_FLG.style.visibility = 'hidden';
            EEHtml.getElementById('CLS').style.display = "none";
        }
        if (amd_type == "Release Free of Payment") {
            document.MAINFORM.CLS_FLG.style.visibility = 'visible';
            SYT_ChangeFldClass(document.MAINFORM.CLS_FLG, 'M');
            EEHtml.getElementById('CLS').style.display = "block";
        }
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_MPO_BY_AMD_TYPE", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_NEW_DRWE_CORR_MED = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_NEW_DRWE_CORR_MED", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_NEW_DRWE_ID_B = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_NEW_DRWE_ID_B", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_NEW_DRWE_ID_B2 = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_NEW_DRWE_ID_B2", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_NEW_DRWE_NM_Z = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_NEW_DRWE_NM_Z", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_New_Tenor = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_New_Tenor", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_PRES_BK_ID = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_PRES_BK_ID", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_REMIT_BK_ID_B = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_REMIT_BK_ID_B", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_Remit_Charge = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_Remit_Charge", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_SEND_AMD_BY = function() {
    try {
        ...
        arr_Fld = new Array(document.MAINFORM.SEND_TO_RCV_INFO, document.MAINFORM.AMD_74, document.MAINFORM.NARR_MAIL, document.MAINFORM.NARR, document.MAINFORM.PRES_BK_SW_ADD);
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_SEND_AMD_BY", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_TENOR_DAY = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_TENOR_DAY", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_TENOR_START_DT_OLD = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_TENOR_START_DT_OLD", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_checkChgUnpaid = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_checkChgUnpaid", e);
    }
}
...
csFuncLevelProto.SYF_IMCO_getDOdata_AdviceForBankCust = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*SYF_IMCO_getDOdata_AdviceForBankCust", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*addRecordCheck", e);
    }
}
...
csFuncLevelProto.deleteRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*deleteRecordCheck", e);
    }
}
...
csFuncLevelProto.editRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*editRecordCheck", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*PostconditionOnInit", e);
    }
}

csFuncLevelProto.FLD_IMCO_AMD_DT_onchange = function(event) {
    try {
        SYF_IMCO_Chk_AMD_DT();
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_AMD_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_AMD_TYPE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_AMD_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_ALL_BAL_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_CHG_FLD_ALL_BAL_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_ALL_CHARGE_AT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_CHG_FLD_ALL_CHARGE_AT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_ALL_CHARGE_FOR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_CHG_FLD_ALL_CHARGE_FOR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_COLLECT_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_CHG_FLD_COLLECT_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_FLD_LOCAL_CUST_AC_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_CHG_FLD_LOCAL_CUST_AC_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DIARY_NARRATIVE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DIARY_NARRATIVE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DRWR_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DRWR_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DRWR_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DRWR_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_MAIL_METHOD_1ST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_MAIL_METHOD_1ST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_MAIL_METHOD_2ND_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_MAIL_METHOD_2ND_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_COL_AMT_NCOL_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_COL_AMT_NCOL_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DAY_MON_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DAY_MON_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DELVR_DOC_AGST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DELVR_DOC_AGST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DRWE_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DRWE_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DRWE_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DRWE_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DUE_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DUE_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_TENOR_DAYS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_TENOR_DAYS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_TENOR_EVENT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_TENOR_EVENT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_TENOR_START_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_TENOR_START_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_OUR_ROLE_onchange = function(event) {
    try {
        SYF_IMCO_CHK_PRES_BK_REF();
        SYF_IMCO_CHK_SEND_AMD_BY();
    } catch (e) {
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_OUR_ROLE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_CHG_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_CHG_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_COR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_COR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_SEND_AMD_BY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_SEND_AMD_BY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_SHIP_FM_CNTY_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_SHIP_FM_CNTY_CODE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_SHIP_TO_CNTY_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_SHIP_TO_CNTY_CODE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_TEMP_DRWE_ID_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_TEMP_DRWE_ID_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_WAIVE_REMT_BK_CHG_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_WAIVE_REMT_BK_CHG_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_GETAC_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_CHG_GETAC_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_CHG_VALUE_DATE_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_CHG_VALUE_DATE_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DRWR_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DRWR_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRWR_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DRWR_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_DRW_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_DRW_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DRWE_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRWE_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DRWE_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_NEW_DRW_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_NEW_DRW_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_PRES_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_PRES_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_REMIT_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_REMIT_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_button1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_button1_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_view_1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IMCO_AmendDischarge.js*FLD_IMCO_view_1_onclick", e);
    }
}