...
csFuncLevelProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*CancelCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*ConfirmBusinessCall", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
		...
		document.MAINFORM.FA_INV_LOAN_TIMES.value = 0;
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*InitValues", e);
    }
}
...
csFuncLevelProto.LoadDODataOnInit = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*LoadDODataOnInit", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.PreconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*PreconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_CHG_INIT = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_CHG_INIT", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_CCY_AMT1 = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_CCY_AMT1", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_Change_By_Type = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_Change_By_Type", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_ExcelUploaded = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_ExcelUploaded", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_FA_INV_CCY = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_FA_INV_CCY", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_FINC_CCY1 = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_FINC_CCY1", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_ImportedInvRef = function(ref) {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_ImportedInvRef", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_Ref = function(ref) {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_Ref", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_forChildtoMainScreen = function(node, recordId, status) {
    try {
        ...
        nosum = SYS_getcurrRecordCount("InvTRF");
        docCCY = SYS_getValueFromMain('FA_DOC_CCY');
        type = SYS_getValueFromMain('FA_BUSI_TYPE');

        amtsum = SYS_getFieldSumValue(node, "FA_DOC_AMT", 2);
        efhandalsum = SYS_FloatMul(SYS_BeFloat(document.MAINFORM.FA_EF_HAN_CHG_AMT.value), nosum);
        if (type == 'IF') {
        ...
        for (i = 0, len = arrayvalue.length; i < len; i++) { // Utility Auto Fix Comments
            ...
            if (doctype == '1') {
                invamtsum = SYS_BeFloat(invamtsum) + SYS_BeFloat(docamt);
                invnosum = invnosum + 1;
            } else {
                crnamtsum = SYS_BeFloat(crnamtsum) - SYS_BeFloat(docamt);
                crnnosum = crnnosum + 1;
        ...
        SYS_setValueToMain('FA_TTL_AMT_IN_LMT', amtsum);
        ...
        document.MAINFORM.FA_TTL_AMT_IN_LMT.value = SYT_CCY_AMT(docCCY, document.MAINFORM.FA_TTL_AMT_IN_LMT.value);
        document.MAINFORM.FA_TTL_INV_AMT.value = SYT_CCY_AMT(docCCY, document.MAINFORM.FA_TTL_INV_AMT.value);
        document.MAINFORM.FA_TTL_CRN_AMT.value = SYT_CCY_AMT(docCCY, document.MAINFORM.FA_TTL_CRN_AMT.value);
        ...
        efcommsum = SYS_BeFloat(SYS_getValueFromMain('FA_TTL_AMT_IN_LMT')) * SYS_BeFloat(SYS_getValueFromMain('FA_EF_COMM_RT')) / 100;
        if (type == 'IF') {
            ifcommsum = SYS_BeFloat(SYS_getValueFromMain('FA_TTL_AMT_IN_LMT')) * SYS_BeFloat(SYS_getValueFromMain('FA_IF_COMM_RT')) / 100;
        ...
        if (type == 'DF' && document.MAINFORM.FA_SERVICE_APPRVD.value == '1') {
            incocommsum = SYS_BeFloat(SYS_getValueFromMain('FA_TTL_AMT_IN_LMT')) * SYS_BeFloat(SYS_getValueFromMain('FA_INCO_COMM_RT')) / 100;
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_forChildtoMainScreen", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_forFSBCBal = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_forFSBCBal", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_forRealChgRT = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Cal_forRealChgRT", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_DOC_FLG = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Chk_DOC_FLG", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_FA_TTL_COMM_RT = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Chk_FA_TTL_COMM_RT", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_FA_TTL_FIN_RET_BAL = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Chk_FA_TTL_FIN_RET_BAL", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_FA_TTL_INV_AMT = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Chk_FA_TTL_INV_AMT", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_MultiDebit_BAL = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Chk_MultiDebit_BAL", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_PmtTerms = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Chk_PmtTerms", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_EXCH_RT4 = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Get_EXCH_RT4", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_EXCH_RT6 = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Get_EXCH_RT6", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_FA_DOC_CCY_OPTION = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Get_FA_DOC_CCY_OPTION", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_FA_IF_COMM_RT = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Get_FA_IF_COMM_RT", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_FA_LMT_BAL = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Get_FA_LMT_BAL", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Get_Princing_Info = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Get_Princing_Info", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_MPO_cableChargeCCYReload = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_MPO_cableChargeCCYReload", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Set_charge = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_Set_charge", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_invAllocation = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*SYF_FAEF_invAllocation", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*addRecordCheck", e);
    }
}
...
csFuncLevelProto.deleteRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*deleteRecordCheck", e);
    }
}
...
csFuncLevelProto.editRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*editRecordCheck", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_DIARY_NARRATIVE_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_DIARY_NARRATIVE_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_EXCH_RT6_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_EXCH_RT6_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_CB_FEE_onchange = function() {
    try {
        SYF_FAEF_Set_charge();
        document.MAINFORM.FA_CB_FEE.value = SYT_AmtFormat(document.MAINFORM.FA_CB_FEE_CCY.value, document.MAINFORM.FA_CB_FEE.value);
    } catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_CB_FEE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_DOC_CCY_onchange = function() {
    ...
    ***/
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_DOC_CCY_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_EF_HAN_CHG_AMT_onchange = function() {
    try {
        SYF_FAEF_Cal_forRealChgRT();
    } catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_EF_HAN_CHG_AMT_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_EF_HAN_CHG_PAMT_onchange = function() {
    try {
        var arrayvalue; // Utility Auto Fix Comments
        var doObj_InvTRF; // Utility Auto Fix Comments
        var i; // Utility Auto Fix Comments
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_EF_HAN_CHG_PAMT_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_IF_COMM_SUM_onchange = function() {
    try {
        EEHtml.fireEvent(document.MAINFORM.FA_SEL_AC_AMT, 'onchange');
    } catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_IF_COMM_SUM_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_IF_HAN_CHG_AMT_onchange = function() {
    try {
        SYF_FAEF_Cal_forRealChgRT();
    } catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_IF_HAN_CHG_AMT_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_IF_HAN_CHG_PAMT_onchange = function() {
    try {
        var arrayvalue; // Utility Auto Fix Comments
        var doObj_InvTRF; // Utility Auto Fix Comments
        var i; // Utility Auto Fix Comments
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_IF_HAN_CHG_PAMT_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_IF_HAN_CHG_SUM_onchange = function() {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_IF_HAN_CHG_SUM_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_LMT_CCY_onchange = function() {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_LMT_CCY_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_PRM_DISC_RT_onchange = function() {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_PRM_DISC_RT_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_TEMP4_onchange = function() {
    try {
        SYF_FAEF_Chk_PmtTerms();
    } catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_TEMP4_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_TRF_DT_onchange = function() {
    try {
        SYF_FAEF_Get_Princing_Info();
    } catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_TRF_DT_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_TTL_COMM_RT_onchange = function() {
    try {
        SYF_FAEF_Chk_FA_TTL_COMM_RT();
    } catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_TTL_COMM_RT_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_FA_TTL_INV_AMT_onchange = function() {
    try {
        SYF_FAEF_Cal_forFSBCBal();
        EEHtml.fireEvent(document.MAINFORM.FA_TEMP_AMT11, 'onchange');
        EEHtml.fireEvent(document.MAINFORM.FA_TEMP_AMT12, 'onchange');
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_FA_TTL_INV_AMT_onchange", e);
    }
}

csFuncLevelProto.FLD_FAEF_RPT_OTHER_AMT2_onchange = function() {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_RPT_OTHER_AMT2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_view_1_onclick = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_ManualUploadInvoice.js*FLD_FAEF_view_1_onclick", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_UpLoadFile_InvTRF = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceTransfer.js", e);
    }
}
