...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*InitValues", e);
    }
}
...
csFuncLevelProto.SYF_BANK_MAP_HO_SW_ADD = function() {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*SYF_BANK_MAP_HO_SW_ADD", e);
    }
}
...
csFuncLevelProto.SYF_BANK_getDOdata_PostAddress = function() {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*SYF_BANK_getDOdata_PostAddress", e);
    }
}
...
csFuncLevelProto.SYF_BANK_getDOdata_SwFMTAddress = function() {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*SYF_BANK_getDOdata_SwFMTAddress", e);
    }
}

csFuncLevelProto.PostconditionOnInit = function() {
    try {
        //Add by jane 2010-2-1
        SYM_BANK_GetRef();
    } catch (e) {
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.FLD_BANK_CNTY_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*FLD_BANK_CNTY_CODE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_BANK_HO_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*FLD_BANK_HO_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_BANK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*FLD_BANK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_BANK_COLL_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_BANK_AddNewBankinMaster.js*FLD_BANK_COLL_BK_ID_BTN_onclick", e);
    }
}