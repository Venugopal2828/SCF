...
csFuncLevelProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*CancelCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*ConfirmBusinessCall", e);
    }
}

csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
    	        if(document.MAINFORM.ADV_PRES_BY.value=='MT999'&&document.MAINFORM.PRES_BK_SW_ADD.value==''){
    	        SYS_CheckError(document.MAINFORM.PRES_BK_SW_ADD, 'The Presenter SWIFT address cannot be empty when Advise Presenter is MT999.');	
        	return false;
        }
        return true;

    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.X798_20_REF.value = document.MAINFORM.DRAWING_REF.value;
        document.MAINFORM.X798_ADV_BK_REF_21P.value = document.MAINFORM.C_MAIN_REF.value;
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*InitValues", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHG_INIT_RUN = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*SYF_IPLC_CHG_INIT_RUN", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_CHK_AC_WT_BK_SW_TAG = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*SYF_IPLC_CHK_AC_WT_BK_SW_TAG", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Cal_TEMP_TAG77B = function() {
    try {
        ...
        var commentedText = '';
        if(DISP_DOC!=''){
                var sLength = DISP_DOC.length;
                var num = 33;
                var count = SYS_FloatDiv(sLength, num);
                for (var i = 0; i <= count; i++) {
                    if (DISP_DOC.length <= num) {
                        commentedText += "//" + DISP_DOC;
                    } else {
                        commentedText += "//" + DISP_DOC.substring(0, num) + '\n';
                        DISP_DOC = DISP_DOC.substring(num);
                    }
                }
        ...
        var lines =  commentedText.split('\n');
        for (var i=0; i< lines.length; i++){
        if (lines[i] !== ''&&lines[i].indexOf('//')!=0) { 
        lines[i] = '//' + lines[i];
        }
        }
        commentedText = lines.join('\n'); 
        document.MAINFORM.TEMP_TAG77B.value = DOC_DISP_FLG + '\n' + commentedText;   
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*SYF_IPLC_Cal_TEMP_TAG77B", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_Charge = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*SYF_IPLC_Charge", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_MPO_ADV_PRES = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*SYF_IPLC_MPO_ADV_PRES", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_MT798_FLAG = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*SYF_IPLC_MT798_FLAG", e);
    }
}
...
csFuncLevelProto.SYF_IPLC_getDOdata_AdviceForBankCust = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*SYF_IPLC_getDOdata_AdviceForBankCust", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*addRecordCheck", e);
    }
}
...
csFuncLevelProto.deleteRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*deleteRecordCheck", e);
    }
}
...
csFuncLevelProto.editRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*editRecordCheck", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AC_WT_BK_ADD1_MT734_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_AC_WT_BK_ADD1_MT734_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AC_WT_BK_ADD2_MT734_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_AC_WT_BK_ADD2_MT734_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AC_WT_BK_ADD3_MT734_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_AC_WT_BK_ADD3_MT734_onchange", e);
    }
}

csFuncLevelProto.FLD_IPLC_AC_WT_BK_ID_MT734_onchange = function(event) {
    try {
        SYT_GetCUBK_All('AC_WT_BK_ID_MT734', 'AC_WT_BK_ID_MT734');
        SYF_IPLC_CHK_AC_WT_BK_SW_TAG();
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_AC_WT_BK_ID_MT734_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AC_WT_BK_NM_MT734_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_AC_WT_BK_NM_MT734_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AC_WT_BK_SW_ADD_MT734_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_AC_WT_BK_SW_ADD_MT734_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADDIT_PRES_BK_AMTS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_ADDIT_PRES_BK_AMTS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_PRES_BY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_ADV_PRES_BY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_ADV_THU_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THU_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_ADV_THU_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_APPLY_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_APPLY_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENEF_CERT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_BENEF_CERT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENEF_CERT_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_BENEF_CERT_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BENEF_CERT_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_BENEF_CERT_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BL_AWB_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_BL_AWB_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BL_AWB_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_BL_AWB_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_BL_AWB_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_BL_AWB_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CERTIFICATE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CERTIFICATE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CERTIFICATE_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CERTIFICATE_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CERTIFICATE_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CERTIFICATE_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHGS_DEDUCTED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CHGS_DEDUCTED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_BAL_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CHG_FLD_ALL_BAL_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_CHARGE_AT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CHG_FLD_ALL_CHARGE_AT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_ALL_CHARGE_FOR_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CHG_FLD_ALL_CHARGE_FOR_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_COLLECT_CCY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CHG_FLD_COLLECT_CCY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_FLD_LOCAL_CUST_AC_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CHG_FLD_LOCAL_CUST_AC_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DIARY_NARRATIVE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_DIARY_NARRATIVE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DISP_DOC_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_DISP_DOC_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DOC_DISP_FLG_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_DOC_DISP_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DOC_PRES_BY_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_DOC_PRES_BY_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRAFT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_DRAFT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRAFT_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_DRAFT_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_DRAFT_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_DRAFT_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FREIGHT_INV_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_FREIGHT_INV_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FREIGHT_INV_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_FREIGHT_INV_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_FREIGHT_INV_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_FREIGHT_INV_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INSP_CERT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INSP_CERT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INSP_CERT_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INSP_CERT_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INSP_CERT_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INSP_CERT_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INSURANCE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INSURANCE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INSURANCE_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INSURANCE_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INSURANCE_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INSURANCE_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INVOICE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INVOICE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INVOICE_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INVOICE_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_INVOICE_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_INVOICE_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_LC_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_LC_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_OTHERS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_OTHERS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_OTHERS_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_OTHERS_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_OTHERS_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_OTHERS_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PACK_LIST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PACK_LIST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PACK_LIST_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PACK_LIST_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PACK_LIST_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PACK_LIST_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_ADD1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_ADD1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_ADD2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_ADD2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_ADD3_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_ADD3_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_CHGS_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_CHGS_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_CORR_MED_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_CORR_MED_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_NM_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_NM_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_ORDER_NO_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_ORDER_NO_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_ORDER_POST_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_ORDER_POST_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_REF_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_REF_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_TOTAL_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_TOTAL_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_VESSEL_CERT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_VESSEL_CERT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_VESSEL_CERT_1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_VESSEL_CERT_1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_VESSEL_CERT_2_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_VESSEL_CERT_2_onchange", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_AC_WT_BK_ID_BTN_MT734_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_AC_WT_BK_ID_BTN_MT734_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_ADV_THRU_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_ADV_THRU_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_GETAC_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CHG_GETAC_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_CHG_VALUE_DATE_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_CHG_VALUE_DATE_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_ID_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_PRES_BK_POST_ADD_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_PRES_BK_POST_ADD_BTN_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_button1_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button2_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_button2_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button3_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_button3_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button4_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_button4_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button5_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_button5_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_button6_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_button6_onclick", e);
    }
}
...
csFuncLevelProto.FLD_IPLC_view_1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_RegisterDiscrepancies.js*FLD_IPLC_view_1_onclick", e);
    }
}