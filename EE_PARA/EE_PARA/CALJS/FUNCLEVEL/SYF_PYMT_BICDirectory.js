...
csFuncLevelProto.SYF_PYMT_Bene_BK_BIC = function() {
    try {
        ...
        SYS_GetTableDataByRule('SYF_PYMT_BICDirectory_SYF_PYMT_Bene_BK_BIC_0', '1', '', 'SYF_PYMT_Invalid_bic', 'False');
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_CHK_X103_59A_1_IBAN_MATCH = function() {
    try {
        ...
        var uBIC; // Utility Auto Fix Comments
        var uBIC_CODE; // Utility Auto Fix Comments
        var uBRAN_CODE; // Utility Auto Fix Comments
        if (document.MAINFORM.X103_ACC_BKSW_57A.value != '') {
            uBIC = document.MAINFORM.X103_ACC_BKSW_57A.value;
            //uBIC_CODE = uBIC.substr(0, 8);
            //uBRAN_CODE = uBIC.substr(8, 3);

            //sSQLWhere = "C_UNIQ_BIC = '" + uBIC_CODE + "' AND C_UNIQ_BRANCH = '" + uBRAN_CODE + "'";
            //sTableName = "BICIBAN";
            //sFieldList = "C_PARENT_BANK";
            //sMappingList = "X103_56_PARENT_BANK_TEMP2";
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_CHK_X103_59A_1_IBAN_MATCH_1', '1', true);

            if (document.MAINFORM.X103_56_PARENT_BANK_TEMP1.value != document.MAINFORM.X103_56_PARENT_BANK_TEMP2.value) {
                alert("The Beneficiary IBAN and Beneficiary Bank BIC are not match!");
            ...
            document.MAINFORM.X103_ACC_BKSW_57A.value = document.MAINFORM.X103_56A_BENE_BKBIC.value + document.MAINFORM.X103_56A_BENE_BKBRANCH.value;
        }
        ...
        //sSQLWhere1 = "C_IBAN_COUNTRY = '" + bCNTY_CODE + "' AND C_UNIQIBAN_NATION = '" + bNAT_ID + "'";
        //sTableName1 = "BICIBAN";
        //sFieldList1 = "INSTITUTION;CITY";
        //sMappingList1 = "X103_ACC_BKNM_57A;X103_ACCBKADD1_57A";
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_CHK_X103_59A_1_IBAN_MATCH_2', '1', true);
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_CHK_X103_59A_1_IBAN_VALID = function() {
    try {
        ...
        fIBAN = parseInt(fIBAN, 16); // Utility Auto Fix Comments
        fIBAN1 = String(BENE_IBAN.substr(1, 1));
        fIBAN1 = parseInt(fIBAN1, 16); // Utility Auto Fix Comments
...
csFuncLevelProto.SYF_PYMT_Cal_CPYT_ASSGN_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_CPYT_ASSGN_ORDER_NO_3', '1');
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_Cal_CPYT_ASSGN_OREDER_POST = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_CPYT_ASSGN_OREDER_POST_4', '1');
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_Cal_CPYT_DR_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_CPYT_DR_ORDER_NO_5', '1');
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_Cal_CPYT_DR_ORDER_POST = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_CPYT_DR_ORDER_POST_6', '1');
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_Cal_X103_50_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_50_ORDER_NO_7', '1');
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
}
...
csFuncLevelProto.SYF_PYMT_Cal_X103_51_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_51_ORDER_NO_8', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X103_52_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_52_ORDER_NO_9', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X103_53_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_53_ORDER_NO_10', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X103_54_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_54_ORDER_NO_11', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X103_56_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_56_ORDER_NO_12', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X103_57_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_57_ORDER_NO_13', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X103_59_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_59_ORDER_NO_14', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X103_B2_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_B2_ORDER_NO_15', '1');
        SYF_PYMT_Chk_X103_TAG_B2_TAG();
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
    ...
    try {
        ...
        if (document.MAINFORM.X103_BENECU_BKSW_59.value.length == 11 || document.MAINFORM.X103_BENECU_BKSW_59.value.length == 8) {
            ...
            if (document.MAINFORM.X103_BENECU_ID_59A.value == "") {
                SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X103_BENECU_BKSW_59_16', '1', true);
                Cal_X103_TAG_59A();
                if (document.MAINFORM.X103_BENECU_ID_59A.value != "") {
...
csFuncLevelProto.SYF_PYMT_Cal_X202_52_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X202_52_ORDER_NO_17', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X202_53_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X202_53_ORDER_NO_18', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X202_54_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X202_54_ORDER_NO_19', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X202_56_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X202_56_ORDER_NO_20', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X202_57_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X202_57_ORDER_NO_21', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X202_58_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X202_58_ORDER_NO_22', '1');
...
csFuncLevelProto.SYF_PYMT_Cal_X202_B2_ORDER_NO = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_Cal_X202_B2_ORDER_NO_23', '1');
        SYF_PYMT_Chk_X202_TAG_B2_TAG();
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
...
csFuncLevelProto.SYF_PYMT_SQL_X103_ACC_BKID_57A_BANK = function() {
    try {
        ...
        if (retvalue) {
            ...
            SYS_InqCUBK_byCondition('X103_ACC_BKID_57A_BIC');
        }
...
csFuncLevelProto.SYF_PYMT_SQL_X103_ACC_BKSW_57A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X103_ACC_BKSW_57A.value.length == 11 || document.MAINFORM.X103_ACC_BKSW_57A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X103_ACC_BKSW_57A_ADD_24', '1', true);
            if (document.MAINFORM.X103_ACC_BKID_57A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X103_ADV_BKSW_B2_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X103_ADV_BKSW_B2.value.length == 11 || document.MAINFORM.X103_ADV_BKSW_B2.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X103_ADV_BKSW_B2_ADD_25', '1', true);
            if (document.MAINFORM.X103_ADV_BKID_B2.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X103_MEDI_BKSW_56A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X103_MEDI_BKSW_56A.value.length == 11 || document.MAINFORM.X103_MEDI_BKSW_56A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X103_MEDI_BKSW_56A_ADD_26', '1', true);
            if (document.MAINFORM.X103_MEDI_BKID_56A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X103_ORDCU_SW_50A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X103_ORDCU_SW_50A.value.length == 11 || document.MAINFORM.X103_ORDCU_SW_50A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X103_ORDCU_SW_50A_ADD_27', '1', true);
...
csFuncLevelProto.SYF_PYMT_SQL_X103_ORD_BKSW_52A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X103_ORD_BKSW_52A.value.length == 11 || document.MAINFORM.X103_ORD_BKSW_52A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X103_ORD_BKSW_52A_ADD_28', '1', true);
            if (document.MAINFORM.X103_ORD_BKSW_52A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X103_RECCORRSW_54A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X103_RECCORRSW_54A.value.length == 11 || document.MAINFORM.X103_RECCORRSW_54A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X103_RECCORRSW_54A_ADD_29', '1', true);
            if (document.MAINFORM.X103_RECCORRID_54A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X103_SENDCORRSW53A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X103_SENDCORRSW53A.value.length == 11 || document.MAINFORM.X103_SENDCORRSW53A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X103_SENDCORRSW53A_ADD_30', '1', true);
            if (document.MAINFORM.X103_SENDCORRID53A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X103_SEND_BKSW_51A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X103_SEND_BKSW_51A.value.length == 11 || document.MAINFORM.X103_SEND_BKSW_51A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X103_SEND_BKSW_51A_ADD_31', '1', true);
            if (document.MAINFORM.X103_SEND_BKSW_51A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X202_ACC_BKSW_57A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X202_ACC_BKSW_57A.value.length == 11 || document.MAINFORM.X202_ACC_BKSW_57A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X202_ACC_BKSW_57A_ADD_32', '1', true);
            if (document.MAINFORM.X202_ACC_BKID_57A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X202_ADV_BKSW_B2_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X202_ADV_BKSW_B2.value.length == 11 || document.MAINFORM.X202_ADV_BKSW_B2.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X202_ADV_BKSW_B2_ADD_33', '1', true);
            if (document.MAINFORM.X202_ADV_BKID_B2.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X202_BENE_BKSW_58A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X202_BENE_BKSW_58A.value.length == 11 || document.MAINFORM.X202_BENE_BKSW_58A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X202_BENE_BKSW_58A_ADD_34', '1', true);
            if (document.MAINFORM.X202_BENE_BKID_58A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X202_MEDI_BKSW_56A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X202_MEDI_BKSW_56A.value.length == 11 || document.MAINFORM.X202_MEDI_BKSW_56A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X202_MEDI_BKSW_56A_ADD_35', '1', true);
            if (document.MAINFORM.X202_MEDI_BKID_56A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X202_ORDBK_SW_52A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X202_ORDBK_SW_52A.value.length == 11 || document.MAINFORM.X202_ORDBK_SW_52A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X202_ORDBK_SW_52A_ADD_36', '1', true);
            if (document.MAINFORM.X202_ORDBK_ID_52A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X202_RECCORRSW_54A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X202_RECCORRSW_54A.value.length == 11 || document.MAINFORM.X202_RECCORRSW_54A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X202_RECCORRSW_54A_ADD_37', '1', true);
            if (document.MAINFORM.X202_RECCORRID_54A.value != '') {
...
csFuncLevelProto.SYF_PYMT_SQL_X202_SENDCORRSW53A_ADD = function() {
    try {
        ...
        if (document.MAINFORM.X202_SENDCORRSW53A.value.length == 11 || document.MAINFORM.X202_SENDCORRSW53A.value.length == 8) {
            ...
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_SQL_X202_SENDCORRSW53A_ADD_38', '1', true);
            if (document.MAINFORM.X202_SENDCORRID53A.value != '') {
...
csFuncLevelProto.SYF_PYMT_Set_CPYT_PAY_ADV_MSG = function() {
    try {
        ...
        if (SYS_MODULE_NAME == 'IMCO' || SYS_MODULE_NAME == 'EXCO') {
            ...
            valueArray = ['MT103', 'MT202', 'MT202COV', 'MT799', 'MT999', 'Mail', 'None']; // Utility Auto Fix Comments
...
csFuncLevelProto.SYF_PYMT_X103_56A_1_IBAN = function() {
    try {
        ...
        if (document.MAINFORM.X103_ACC_BKNM_57A.value != '' && document.MAINFORM.X103_ACCBKADD1_57A.value != '') {
            //sSQLWhere = "INSTITUTION = '" + document.MAINFORM.X103_ACC_BKNM_57A.value + "' AND CITY = '" + document.MAINFORM.X103_ACCBKADD1_57A.value + "'";
            //sTableName = "BICIBAN";
            //sFieldList = "NAT_ID;SERVICES";
            //sMappingList = "X103_56_NAT_ID;X103_56_SERVICES";
            SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_X103_56A_1_IBAN_39', '1', true);
            document.MAINFORM.X103_ACC_BKACNO57A.value = "/" + document.MAINFORM.X103_56_NAT_ID.value + document.MAINFORM.X103_56_SERVICES.value;
...
csFuncLevelProto.SYF_PYMT_X103_59A_1_IBAN = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_X103_59A_1_IBAN_40', '1', true);

        SYF_PYMT_CHK_X103_59A_1_IBAN_VALID();
        ...
        //sSQLWhere1 = "C_IBAN_COUNTRY = '" + bCNTY_CODE + "' AND C_UNIQIBAN_NATION = '" + bNAT_ID + "'";
        //sTableName1 = "BICIBAN";
        //sFieldList1 = "C_IBAN_BIC;C_IBAN_BRANCH;C_PARENT_BANK";
        //sMappingList1 = "X103_56A_BENE_BKBIC;X103_56A_BENE_BKBRANCH;X103_56_PARENT_BANK_TEMP1";
        SYS_GetTableDataByRule_S('SYF_PYMT_BICDirectory_SYF_PYMT_X103_59A_1_IBAN_41', '1', true);
...
csFuncLevelProto.SYF_PYMT_X202_TAG_58A_1_IBAN = function() {
    try {
        ...
        if (document.MAINFORM.X202_BENE_BKNM_58A.value != '' && document.MAINFORM.X202BENEBKADD1_58A.value != '') {
            //sSQLWhere = "INSTITUTION = '" + document.MAINFORM.X202_BENE_BKNM_58A.value + "' AND CITY = '" + document.MAINFORM.X202BENEBKADD1_58A.value + "'";
            //sTableName = "BICIBAN";
            //sFieldList = "BIC";
            //sMappingList = "X202_BENE_BKSW_58A";
            SYS_GetTableDataByRule('SYF_PYMT_BICDirectory_SYF_PYMT_X202_TAG_58A_1_IBAN_42', '1', 'SYF_PYMT_Success58', 'SYF_PYMT_Fail58', 'false');
        }
    } catch (e) {
        DisExcpt("SYF_PYMT_BICDirectory.js", e);
    }
