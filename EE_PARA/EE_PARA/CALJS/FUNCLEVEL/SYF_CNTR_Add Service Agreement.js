...
csFuncLevelProto.SYF_CNTR_C_MAIN_REF = function(ref) {
    try {
        ...
        year = dt.substr(2, 2);
        month = dt.substr(5, 2);
        document.MAINFORM.C_MAIN_REF.value = 'INVT' + year + month + ref;
    } catch (e) {
        DisExcpt("SYF_CNTR_Add Service Agreement.js", e);
    }
}
...
csFuncLevelProto.SYF_CNTR_CLTR_ID_afteredit = function(ed, record) {
    try {
        ...
        var config1; // Utility Auto Fix Comments
...
csFuncLevelProto.SYF_CNTR_LoadDoComplete = function() {
    try {
        ...
        /*SYS_GetDataForDO_S('Get_Regulatory',"A",false,'',"WarehouseRgltAuth");
SYS_GetDataForDO_S('Get_Collateral',"A",false,'',"EligibleCollItem");*/
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYS_GetRefNo('Add_Sev_Agr', 'SYF_CNTR_C_MAIN_REF()');
        document.MAINFORM.PROD_TP.value = 'INVT';
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        submitItemTranf("FUND_TP");
        SYF_CNTR_check_MAX_CHG_AMT();
    } catch (e) {
        DisExcpt("SYF_CNTR_Add Service Agreement.js", e);
    }
}
...
csFuncLevelProto.SYF_CNTR_Get_Applicant = function() {
    try {

        SYS_GetCUBK('Inquire_Applicant', 'CUST_ID');
    } catch (e) {
        DisExcpt("SYF_CNTR_Add Service Agreement.js", e);
    }
}
