...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_GTEE_GTEE_SettleCharges.js", e);
    }
}
...
csFuncLevelProto.SYF_GTEE_Get_APPL_MAIL_ADD = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SYF_GTEE_GTEE_SettleCharges_SYF_GTEE_Get_APPL_MAIL_ADD_0', '1');
    } catch (e) {
        DisExcpt("SYF_GTEE_GTEE_SettleCharges.js", e);
    }
}
...
csFuncLevelProto.SYF_GTEE_ContralChgAt = function() {
    try {
        ...
        for (i = 0; i < defChgArr.length; i++) {
            charge = defChgArr[i];
            charge.setChargeFor(strChgFor);
            if (charge.getChargeFor() == 'L') {
...
csFuncLevelProto.SYF_GTEE_MPO_BY_AC_TYPE = function() {
    try {
...
csFuncLevelProto.SYF_GTEE_STL_CHG_AC_OWNERID_BTN_Onclick = function() {
    try {
...
csFuncLevelProto.SYF_GTEE_Cal_STL_CHG_ACNO_CUBK = function() {
    try {

        if (document.MAINFORM.STL_CHG_ACNO.value != '') {
            SYS_GetCUBK('CHG_FOREIGN_CCY', 'STL_CHG_ACNO', 'SYF_GTEE_CAL_FOREN_RT');
        }
    } catch (e) {
        DisExcpt("SYF_GTEE_GTEE_SettleCharges.js", e);
    }
...
csFuncLevelProto.FLD_GTEE_STL_CHG_ACNO_onchange = function(event) {
    try {
        SYF_GTEE_Cal_STL_CHG_ACNO_CUBK();
    } catch (e) {
        DisExcpt("SYF_GTEE_GTEE_SettleCharges.js", e);
    }
}
...
csFuncLevelProto.FLD_GTEE_STL_CHG_AC_OWNERID_BTN_onclick = function(event) {
    try {
        SYF_GTEE_STL_CHG_AC_OWNERID_BTN_Onclick();
    } catch (e) {
        DisExcpt("SYF_GTEE_GTEE_SettleCharges.js", e);
    }
}

csFuncLevelProto.FLD_GTEE_STL_CHG_AC_TYPE_onchange = function(event) {
    try {
        SYF_GTEE_MPO_BY_AC_TYPE();
    } catch (e) {
        DisExcpt("SYF_GTEE_GTEE_SettleCharges.js", e);
    }
}