...
csFuncLevelProto.SYF_IPLC_CAL_ACPT_AMT = function() {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_PayAcceptFrCE.js", e);
    }
}
    ...
    try {
        ...
        if (document.MAINFORM.CHG_FLD_ALL_CHARGE_AT.value == "0") {
            ...
            for (i = 0; i < arrDefObj.length; i++) {
                arrDefObj[i].setChargeAt(Chg.AT_TRX);
            }
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.DOC_STAT.value = 'ACCEPT'; //Add for gapi;
    } catch (e) {
        DisExcpt("SYF_IPLC_IPLC_PayAcceptFrCE.js", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        // SYF_IPLC_Change_STL_AMT_Class_By_AVAL_BY();20200622;

        //Add by Jack on 20120906 for SMBC Workshop
        //SYF_IPLC_MPO_DISCNT_FLG();
        //SYF_IPLC_hiddenDiscounttab();
        //move these to SYF_IPLC_loadDoDataComplete
        ...
        SYT_ChangeFldClass(document.MAINFORM.EXPIRY_DT, "M"); // Utility Auto Fix Comments
        SYT_ChangeFldClass(document.MAINFORM.TENOR_START_DT, "M"); // Utility Auto Fix Comments

        SYT_ChangeFldClass(document.MAINFORM.MESG_TYPE, "O"); // Utility Auto Fix Comments
