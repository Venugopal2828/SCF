...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        SYT_CHG_VOUCHER();
        SYT_LIAB_VOUCHER();
        document.MAINFORM.CURRNT_STATUS.value = 'SG Issue OneStep';
    } catch (e) {
        DisExcpt("SYF_SHGT_IssueSGAgainstLCOneStep.js", e);
    }
}
...
csFuncLevelProto.FLD_SHGT_INV_AMT_onchange = function(event) {
    try {
        if (document.MAINFORM.INV_AMT.value < 0) {
...
csFuncLevelProto.FLD_SHGT_SG_AMT_onchange = function(event) {
    try {
        if (document.MAINFORM.SG_AMT.value < 0) {
