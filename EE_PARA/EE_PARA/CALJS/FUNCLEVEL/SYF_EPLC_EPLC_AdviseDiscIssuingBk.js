...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYM_EPLC_INIT();
        SYF_EPLC_CALL_MT750_TAG77J();
        SYF_EPLC_CALL_RCVER_OF_MT750();
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_AdviseDiscIssuingBk.js", e);
    }
}
...
csFuncLevelProto.SYF_EPLC_MPO_BY_MT750FLG = function() {
    try {

        var arr_Fld = new Array(document.MAINFORM.RCV_BK_ID_MT750, document.MAINFORM.RCV_BK_NM_MT750, document.MAINFORM.RCV_BK_ADD1_MT750, document.MAINFORM.RCV_BK_ADD2_MT750, document.MAINFORM.RCV_BK_ADD3_MT750, document.MAINFORM.RCV_BK_SW_ADD_MT750, document.MAINFORM.RCV_BK_SW_TAG_MT750, document.MAINFORM.RCV_BK_ID_BTN_MT750, document.MAINFORM.AC_WT_BK_ID_MT750, document.MAINFORM.AC_WT_BK_NM_MT750, document.MAINFORM.AC_WT_BK_ADD1_MT750, document.MAINFORM.AC_WT_BK_ADD2_MT750, document.MAINFORM.AC_WT_BK_ADD3_MT750, document.MAINFORM.AC_WT_BK_SW_ADD_MT750, document.MAINFORM.AC_WT_BK_SW_TAG_MT750, document.MAINFORM.AC_WT_BK_ID_BTN_MT750, document.MAINFORM.CHGS_ADDED_TXT_MT750, document.MAINFORM.CHGS_DEDUCTED_TXT_MT750, document.MAINFORM.SEND_TO_RCV_INFO_MT750, document.MAINFORM.DISC_DET_MT750);
        var arr_FldClass_YES = new Array("O", "M", "M", "M", "M", "M", "P", "O", "O", "O", "O", "O", "O", "O", "P", "O", "O", "O", "O", "M");
        var arr_FldClass_NO = new Array("B", "B", "B", "B", "B", "B", "B", "P", "B", "B", "B", "B", "B", "B", "B", "P", "B", "B", "B", "B");
        if (document.MAINFORM.SEND_MT750_FLG.value == "Yes") {
            SYT_ChangeFldStringClass(arr_Fld, arr_FldClass_YES);
        } else {
            SYT_ChangeFldStringClass(arr_Fld, arr_FldClass_NO);
        }
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_AdviseDiscIssuingBk.js", e);
    }
...
csFuncLevelProto.SYF_EPLC_CALL_MT750_TAG77J = function() {
    try {

        if (document.MAINFORM.SEND_MT750_FLG.value == "Yes") {
            document.MAINFORM.DISC_DET_MT750.value = document.MAINFORM.DISC_DET.value;
        } else {
            document.MAINFORM.DISC_DET_MT750.value = "";
        }
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_AdviseDiscIssuingBk.js", e);
    }
...
csFuncLevelProto.SYF_EPLC_CALL_RCVER_OF_MT750 = function() {
    try {
        ...
        if (document.MAINFORM.SEND_MT750_FLG.value == "Yes") {
            ...
            document.MAINFORM.RCV_BK_MT750_NOTES.value = document.MAINFORM.ISSUE_BK_NOTES.value;
        }
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_AdviseDiscIssuingBk.js", e);
    }
...
csFuncLevelProto.FLD_EPLC_SEND_MT750_FLG_onchange = function(event) {
    try {
        ...
        SYF_EPLC_MPO_BY_MT750FLG();
        SYF_EPLC_CALL_RCVER_OF_MT750();
        EEHtml.fireEvent(document.MAINFORM.DISC_DET_MT750, 'onchange');
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_AdviseDiscIssuingBk.js", e);
    }
}
