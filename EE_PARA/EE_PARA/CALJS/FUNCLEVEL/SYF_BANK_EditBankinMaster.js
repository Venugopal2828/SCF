...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_BANK_EditBankinMaster.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_BANK_EditBankinMaster.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.LoadDODataOnInit = function() {
    try {
        ...
        DisExcpt("SYF_BANK_EditBankinMaster.js*LoadDODataOnInit", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_BANK_EditBankinMaster.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.FLD_BANK_CNTY_CODE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_BANK_EditBankinMaster.js*FLD_BANK_CNTY_CODE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_BANK_SW_ADD_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_BANK_EditBankinMaster.js*FLD_BANK_SW_ADD_onchange", e);
    }
}
...
csFuncLevelProto.FLD_BANK_COLL_BK_ID_BTN_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_BANK_EditBankinMaster.js*FLD_BANK_COLL_BK_ID_BTN_onclick", e);
    }
}