...
csFuncLevelProto.SYF_FAEF_Cal_ExcelUploaded = function() {
    try {
        ...
        for (i = 0, len = arrayvalue.length; i < len; i++) { // Utility Auto Fix Comments
            ...
            record = SYS_setValToRec(record, 'FA_DOC_CCY', invccy);
            record = SYS_setValToRec(record, 'FA_DOC_BAL', invccy);
            invbal = SYS_BeFloat(SYS_getValFromRec(record, 'FA_DOC_AMT'));
            //SYS_setFieldValue(node, id, "FA_DOC_BAL", invbal);
            record = SYS_setValToRec(record, 'FA_DOC_BAL', invbal);
            //SYS_setFieldValue(node, id, "FA_TEMP_AMT8", 1);
            record = SYS_setValToRec(record, 'FA_TEMP_AMT8', 1);
            //SYS_setFieldValue(node, id, "FA_DOC_STATUS", 'TRF');
            record = SYS_setValToRec(record, 'FA_DOC_STATUS', 'Bank Approved');
            //SYS_setFieldValue(node, id, "FA_DOC_TYPE", '1');
            record = SYS_setValToRec(record, 'FA_DOC_TYPE', '1');
            //SYS_setFieldValue(node, id, "FA_TRF_DT", document.MAINFORM.FA_TRF_DT.value);
            record = SYS_setValToRec(record, 'FA_TRF_DT', document.MAINFORM.FA_TRF_DT.value);
            //SYS_setFieldValue(node, id, "FA_BUYER_ID", document.MAINFORM.FA_BUYER_ID.value);
            record = SYS_setValToRec(record, 'FA_BUYER_ID', document.MAINFORM.FA_BUYER_ID.value);
            //SYS_setFieldValue(node, id, "FA_BUYER_NM", document.MAINFORM.FA_BUYER_NM.value);
            record = SYS_setValToRec(record, 'FA_BUYER_NM', document.MAINFORM.FA_BUYER_NM.value);
            //SYS_setFieldValue(node, id, "FA_PRM_DISC_DAYS", document.MAINFORM.FA_PRM_DISC_DAYS.value);
            record = SYS_setValToRec(record, 'FA_PRM_DISC_DAYS', document.MAINFORM.FA_PRM_DISC_DAYS.value);
            //SYS_setFieldValue(node, id, "FA_EF_COMM_RT", document.MAINFORM.FA_EF_COMM_RT.value);
            record = SYS_setValToRec(record, 'FA_EF_COMM_RT', document.MAINFORM.FA_EF_COMM_RT.value);
            //SYS_setFieldValue(node, id, "FA_IF_COMM_RT", document.MAINFORM.FA_IF_COMM_RT.value);
            record = SYS_setValToRec(record, 'FA_IF_COMM_RT', document.MAINFORM.FA_IF_COMM_RT.value);
            //SYS_setFieldValue(node, id, "FA_PRM_DISC_RT", document.MAINFORM.FA_PRM_DISC_RT.value);
            record = SYS_setValToRec(record, 'FA_PRM_DISC_RT', document.MAINFORM.FA_PRM_DISC_RT.value);
            //SYS_setFieldValue(node, id, "FA_SND_DISC_DAYS", document.MAINFORM.FA_SND_DISC_DAYS.value);
            record = SYS_setValToRec(record, 'FA_SND_DISC_DAYS', document.MAINFORM.FA_SND_DISC_DAYS.value);
            //SYS_setFieldValue(node, id, "FA_SND_DISC_RT", document.MAINFORM.FA_SND_DISC_RT.value);
            record = SYS_setValToRec(record, 'FA_SND_DISC_RT', document.MAINFORM.FA_SND_DISC_RT.value);
            //SYS_setFieldValue(node, id, "FA_IF_HAN_CHG_AMT", document.MAINFORM.FA_IF_HAN_CHG_AMT.value);
            record = SYS_setValToRec(record, 'FA_IF_HAN_CHG_AMT', document.MAINFORM.FA_IF_HAN_CHG_AMT.value);
            ...
            record = SYS_setValToRec(record, 'FA_IF_HAN_CHG_CCY', document.MAINFORM.FA_IF_HAN_CHG_CCY.value);
            //SYS_setFieldValue(node, id, "FA_EF_HAN_CHG_CCY", document.MAINFORM.FA_EF_HAN_CHG_CCY.value);
            record = SYS_setValToRec(record, 'FA_EF_HAN_CHG_CCY', document.MAINFORM.FA_EF_HAN_CHG_CCY.value);
            //SYS_setFieldValue(node, id, "FA_EF_HAN_CHG_AMT", document.MAINFORM.FA_EF_HAN_CHG_AMT.value);
            record = SYS_setValToRec(record, 'FA_EF_HAN_CHG_AMT', document.MAINFORM.FA_EF_HAN_CHG_AMT.value);
            ...
            invbal = SYS_BeFloat(SYS_getValFromRec(record, 'FA_DOC_AMT'));
            CreditAmount = (invbal * CreditPercentage) / 100;
            invccy = document.MAINFORM.FA_DOC_CCY.value;
            CreditAmount = SYT_AmtFormat(invccy, CreditAmount);
            record = SYS_setValToRec(record, 'FA_CREDIT_NOTE_PER_AMT', CreditAmount);
            ...
            record = SYS_setValToRec(record, 'FA_IF_COMM_AMT', IF_COMM_AMT);
            //SYS_setFieldValue(node, id, "FA_EF_COMM_AMT", EF_COMM_AMT);
            record = SYS_setValToRec(record, 'FA_EF_COMM_AMT', EF_COMM_AMT);

            sbrref = document.MAINFORM.FA_SBR_REF.value;
            var InvRef = SYS_getValFromRec(record, 'FA_DOC_REF');
            if (InvRef == "" || InvRef == null) {
                //SYS_GetSubPageRefNo_S('FAEF_INV_REF', SYF_FAEF_Cal_ImportedInvRef, '', 'InvRef', 'InvRef');
                SYS_GetSubPageRefNo_S('SCF_INV_REF', SYF_FAEF_Cal_ImportedInvRef, '', 'InvRef', 'InvRef');
                InvRef = document.MAINFORM.FA_TEMP3.value;
                //SYS_setFieldValue(node, id, "FA_DOC_REF", InvRef);
                record = SYS_setValToRec(record, 'FA_DOC_REF', InvRef);
            }
            //SYS_setFieldValue(node, id, "FSBC_REF", sbrref);
            record = SYS_setValToRec(record, 'FSBC_REF', sbrref);
            ...
            record = SYS_setValToRec(record, 'FA_INV_LINK_REF', InvRef);

            docno = SYS_getValFromRec(record, 'FA_DOC_NO');
            //SYS_setFieldValue(node, id, "FA_CRN_INV_LINK_NO", docno);
            record = SYS_setValToRec(record, 'FA_CRN_INV_LINK_NO', docno);
        ...
        DisExcpt("SYF_FAEF_InvoiceTransfer_ME.js", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_PmtTerms = function() {
    try {
        ...
        if (pmtTerms > SYS_BeFloat(document.MAINFORM.FA_PMT_TERMS.value)) {
            alert("Commercial Relationship Terms exceed limit set at the FSBC level!");
...
csFuncLevelProto.SYF_FAEF_Cal_forChildtoMainScreen = function(node, recordId, status) {
    try {
        ...
        CreditPercentage = SYS_getValueFromMain('FA_CREDIT_NOTE_PER');
        invsum = (invamtsum * percent) / 100;
        invsum = SYT_AmtFormat(docCCY, invsum);
        CreditAmount = (invamtsum * CreditPercentage) / 100;
        SYS_setValueToMain('AMT_AVAL_FOR_FUNDING', invsum);
        SYS_setValueToMain('FA_CREDIT_NOTE_PER_TOT_AMT', SYT_AmtFormat(docCCY, CreditAmount));
...
csFuncLevelProto.SYF_FAEF_Cal_ImportedInvRef = function(ref) {
    try {
        ...
        sub = 'INV';
        document.MAINFORM.FA_TEMP3.value = sub + UnitCode + year + day + ref;
    } catch (e) {
        DisExcpt("SYF_FAEF_InvoiceTransfer_ME.js", e);
    }
}
...
csFuncLevelProto.PreconditionOnInit = function() {
    try {
        ...
        //SYS_GetRefNo_S('SCF_INV_TRF', 'SYF_FAEF_Cal_Ref');
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        var FA_MAX_LOAN_PERC = SYS_BeFloat(document.MAINFORM.FA_MAX_LOAN_PERC.value);
        var loanAmt = (SYS_BeFloat(document.MAINFORM.FA_TTL_INV_AMT.value) * FA_MAX_LOAN_PERC) / 100
        document.MAINFORM.TTL_LOAN_AVL.value = SYT_CCY_AMT(document.MAINFORM.FA_DOC_CCY.value, loanAmt);
        /*modify by huyechao for POF 20151009*/
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYS_GetRefNo_S('SCF_INV_TRF', 'SYF_FAEF_Cal_Ref');
        //document.MAINFORM.C_MAIN_REF.value = document.MAINFORM.FA_SBR_REF.value;
        ...
        document.MAINFORM.TEMP_INV_NO.value = document.MAINFORM.FA_TTL_INV_NO.value;
        ...
        document.MAINFORM.FA_TTL_INV_AMT.value = '0.00';
        document.MAINFORM.AMT_AVAL_FOR_FUNDING.value = '0';
        /*notes for scf*/
        //FA_TTL_INV_AMT = 0;
...
csFuncLevelProto.SYF_FAEF_Cal_Change_By_Type = function() {
    try {
        ...
        if (val != 'EF') {
            ...
            EEHtml.getElementById('EF4').style.display = "none";
            EEHtml.getElementById('EF5').style.display = "none";
            EEHtml.getElementById('EF6').style.display = "none";
            EEHtml.getElementById('EF7').style.display = "none";
            EEHtml.getElementById('EF8').style.display = "none";
        }

        if (val != 'DF') {
            EEHtml.getElementById('DF1').style.display = "none";
            EEHtml.getElementById('DF2').style.display = "none";
        }


        if (val != 'DF' && val != 'EF') {
            EEHtml.getElementById('DF/EF1').style.display = "none";
        ...
        if (xDO) {
            ...
            for (i = 0; i < records.length; i++) {
                ...
                if (COMM[0] == 'FAEF_EF_COMM') {
                    ...
                    //MODIFY FOR Total Commissions by SCF
                    var amt = SYS_BeFloat(document.MAINFORM.FA_EF_COMM_SUM.value);
                    var rat = SYS_getValFromRec(records[i], "CHG_VAT_RATE")
                    var vatAmt = (amt * rat) / 100;
                    SYS_setFieldValue(xDO, id, "CHG_COLLECT_VAT_AMT", vatAmt);
                } else if (COMM[0] == 'FAEF_EF_CHG') {
                    SYS_setFieldValue(xDO, id, "CHG_COMMISSION_DESC", 'Total Handling Charges');
                    Chg.Screen.setChargeValue(COMM, invccy, document.MAINFORM.FA_EF_HAN_CHG_AMT.value);
                    SYS_setFieldValue(xDO, id, "CHG_COLLECT_AMT", document.MAINFORM.FA_EF_HAN_CHG_AMT.value);
                    SYS_setFieldValue(xDO, id, "CHG_COLLECT_CCY", invccy);
                    //MODIFY FOR Total Handling Charges by SCF
                    var amt = SYS_BeFloat(document.MAINFORM.FA_EF_HAN_CHG_AMT.value);
                    var rat = SYS_getValFromRec(records[i], "CHG_VAT_RATE")
                    var vatAmt = (amt * rat) / 100;
                    SYS_setFieldValue(xDO, id, "CHG_COLLECT_VAT_AMT", vatAmt);
                    ...
                    //MODIFY FOR Cable Charge by SCF
                    var amt = SYS_BeFloat(document.MAINFORM.FA_CB_FEE.value);
                    var rat = SYS_getValFromRec(records[i], "CHG_VAT_RATE")
                    var vatAmt = (amt * rat) / 100;
                    SYS_setFieldValue(xDO, id, "CHG_COLLECT_VAT_AMT", vatAmt);
                }
...
csFuncLevelProto.SYF_FAEF_CHG_INIT = function() {
    try {
        ...
        document.MAINFORM.CHG_VALUE_DATE.value = SYS_BUSI_DATE; //20190524 Barclay Hattie;
    } catch (e) {
        DisExcpt("SYF_FAEF_InvoiceTransfer_ME.js", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Chk_MultiDebit_BAL = function() {
    try {
        ...
        xNum = SYS_getcurrRecordCount("ChgDoTrx");
        ...
        /*modify for scf*/
        EFcommRT = SYS_BeFloat(document.MAINFORM.FA_EF_COMM_RT.value);
        invbal = SYS_BeFloat(document.MAINFORM.FA_TTL_INV_AMT.value);
        COMM_AMT = invbal * EFcommRT / 100;
        COMM_AMT = COMM_AMT.toFixed(2);
        if (num > 0) {
            arrayvalue = SYS_getRecords(_do); // Utility Auto Fix Comments
            for (i = 0, len = arrayvalue.length; i < len; i++) {
                record = arrayvalue[i];
        ...
        if (xNum > 0) {
            arrayvalue = SYS_getRecords(xDO); // Utility Auto Fix Comments
            for (i = 0, len = arrayvalue.length; i < len; i++) {
                record = arrayvalue[i];
                recordTypeTemp2 = SYS_getFieldSumValue(xDO, "CHG_COLLECT_VAT_AMT", 2)
                SYS_setValueToMain('TEMP_CHG_VAT_AMT', recordTypeTemp2);
            }
        }
        /*modify for scf*/
        //if (SYS_BeFloat(document.MAINFORM.FA_TEMP1.value) != paySamt && SYS_BeFloat(document.MAINFORM.FA_TEMP1.value) != payBamt) {
        paySamt = SYS_BeFloat(document.MAINFORM.FA_EF_HAN_CHG_AMT.value) + SYS_BeFloat(document.MAINFORM.FA_CB_FEE.value) + SYS_BeFloat(COMM_AMT) + SYS_BeFloat(document.MAINFORM.TEMP_CHG_VAT_AMT.value);
        paySamt = SYT_AmtFormat(document.MAINFORM.CHG_COLL_CCY.value, paySamt);
        paySamt = SYS_BeFloat(paySamt);
...
*/
                ...
                if (val != duedt) {
                    alert("Please check inv no " + docno + ", Invoice Due Date should be " + val + ", Commercial Relationship Terms should be the same with transaction page!");
                    return false;
                }
            }
        }
...
csFuncLevelProto.SYF_FAEF_MPO_Change_By_Type = function() {
    try {

        if (document.MAINFORM.FA_BUSI_TYPE.value == 'SF') {
            SYT_ChangeFldClass(document.MAINFORM.FA_BUYER_ID, 'M');
            SYT_ChangeFldClass(document.MAINFORM.FA_BUYER_NM, 'M');
            SYT_ChangeFldClass(document.MAINFORM.FA_BUYER_BTN, 'O');
            SYT_ChangeFldClass(document.MAINFORM.FA_SEL_ID, 'P');
            SYT_ChangeFldClass(document.MAINFORM.FA_SEL_NM, 'P');
            SYT_ChangeFldClass(document.MAINFORM.FA_SEL_BTN, 'P');
            ...
            SYT_ChangeFldClass(document.MAINFORM.FA_SEL_BTN, 'O');
            SYT_ChangeFldClass(document.MAINFORM.FA_BUYER_BTN, 'P');
        } else if (document.MAINFORM.FA_BUSI_TYPE.value == 'DD') {
            document.MAINFORM.FA_SEL_ID.value = '';
            document.MAINFORM.FA_SEL_NM.value = '';
            SYT_ChangeFldClass(document.MAINFORM.FA_SEL_ID, 'P');
            SYT_ChangeFldClass(document.MAINFORM.FA_SEL_NM, 'P');
...
csFuncLevelProto.FLD_FAEF_FA_TEMP1_onchange = function(event) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_InvoiceTransfer_ME.js", e);
    }
}
