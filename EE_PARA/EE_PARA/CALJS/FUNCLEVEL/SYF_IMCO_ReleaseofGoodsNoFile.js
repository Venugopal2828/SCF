...
csFuncLevelProto.SYF_IMCO_SetRefNo = function(ref) {
    try {

        document.MAINFORM.C_MAIN_REF.value = ref;
    } catch (e) {
        DisExcpt("SYF_IMCO_ReleaseofGoodsNoFile.js", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYM_IMCO_INIT();
        SYS_GetRefNo('IMCO', 'SYF_IMCO_SetRefNo');
    } catch (e) {
        DisExcpt("SYF_IMCO_ReleaseofGoodsNoFile.js", e);
    }
}
...
csFuncLevelProto.FLD_IMCO_RCV_BK_ORDER_POST_onchange = function(event) {
    try {
        SYM_IMCO_Cal_RCV_BK_ORDER_POST2();
    } catch (e) {
        DisExcpt("SYF_IMCO_ReleaseofGoodsNoFile.js", e);
    }
}
