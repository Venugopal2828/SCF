...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*ConfirmBusinessCall", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYS_GetCUBK('GET_APPR_INV', 'FA_SBR_REF', 'SYF_FAEF_GET_APPR_INV_Callbak()');
    } catch (e) {
        DisExcpt("SYF_FAEF_InvoiceVerify.js*InitValues", e);
    }
}
...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.PreconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*PreconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Cal_Ref = function(ref) {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*SYF_FAEF_Cal_Ref", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_GET_APPR_INV_Callbak = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*SYF_FAEF_GET_APPR_INV_Callbak", e);
    }
}
...
csFuncLevelProto.SYF_FAEF_Verify_Status = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*SYF_FAEF_Verify_Status", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_ACCEPT_FLG_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*FLD_FAEF_FA_ACCEPT_FLG_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FAEF_FA_TEMP3_onchange = function() {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify.js*FLD_FAEF_FA_TEMP3_onchange", e);
    }
}