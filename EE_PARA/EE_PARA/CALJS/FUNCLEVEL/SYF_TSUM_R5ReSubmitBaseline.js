...
csFuncLevelProto.SYF_TSUM_Check_Adju = function() {
    try {
        ...
        var GoodsNode = parent.SYS_getNodeByXpath('R5Goods');
        var TSU_LINE_TTL_AMT = parent.SYS_getFieldSumValue(GoodsNode, 'TSU_LINE_TTL_AMT');
        var AdjNode = parent.SYS_getNodeByXpath('R5Goods.Adjustmtents');
        ...
        DisExcpt("SYF_TSUM_R5ReSubmitBaseline.js", e);
    }
}
    ...
    try {
        ...
        if (SYS_FUNCTION_TYPE == 'PM') {
            ...
            SYS_GetDataForDO_TSU_S('getdata_tsu012', null, null, null, null, {
                "TSU_MERGE_DONAMES": ["R2InvolvedPartyInfo*R5Goods*R5PaymentTerms*R5SettlementTerms*R5PaymentObligation*R5DatasetRequired*UserDefinedInformation"]
            });
...
csFuncLevelProto.SYF_TSUM_Set_Baseline_ID = function() {
    try {
        ...
        if (document.MAINFORM.FUNC_SHORT_NAME.value == 'tsmt.018.001.05B' && document.MAINFORM.BASELN_RP_TP.value == 'FWIS') {
