...
csFuncLevelProto.PreconditionOnInit = function() {
    try {
        ...
        DisExcpt("SYF_REIM_AmendClaim.js", e);
    }
}
...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.ORG_CLM_TRX_CCY_AMT.value = document.MAINFORM.CLM_TRX_CCY_AMT.value;
...
csFuncLevelProto.SYF_REIM_ChgFldCLS = function() {
    try {
        ...
        SYT_ChangeFldClass(document.MAINFORM.CANCEL_CLM_FLG, 'O');
...
csFuncLevelProto.SYF_REIM_Cal_NEW_REIM_INST_BAL = function() {
    try {
        ...
        var ORG_CLM_TRX_CCY_AMT; // Utility Auto Fix Comments
        var PEND_REIM_INST_BAL; // Utility Auto Fix Comments
        var REIM_INST_BAL
        var ORG_PEND_REIM_INST_BAL
        NEW_REIM_INST_BAL = SYS_BeFloat(document.MAINFORM.NEW_REIM_INST_BAL.value);
        PEND_REIM_INST_BAL = SYS_BeFloat(document.MAINFORM.PEND_REIM_INST_BAL.value);
        ORG_CLM_TRX_CCY_AMT = SYS_BeFloat(document.MAINFORM.ORG_CLM_TRX_CCY_AMT.value);
        ...
        ORG_PEND_REIM_INST_BAL = SYS_BeFloat(document.MAINFORM.TEMP_AMT1.value);

        PEND_REIM_INST_BAL = ORG_PEND_REIM_INST_BAL - ORG_CLM_TRX_CCY_AMT + CLM_TRX_CCY_AMT;
...
csFuncLevelProto.SYF_REIM_Cal_DOC_VALUE = function() {
    try {
        ...
        var CLM_TRX_CCY_AMT; // Utility Auto Fix Comments
        var DEC_CLM_AMT; // Utility Auto Fix Comments
        var DOC_VALUE; // Utility Auto Fix Comments
        DOC_VALUE = SYS_BeFloat(document.MAINFORM.DOC_VALUE.value);
        CLM_TRX_CCY_AMT = SYS_BeFloat(document.MAINFORM.CLM_TRX_CCY_AMT.value);
        DEC_CLM_AMT = SYS_BeFloat(document.MAINFORM.DEC_CLM_AMT.value);
...
csFuncLevelProto.SYF_REIM_Chk_CLM_TRX_CCY_AMT = function() {
    try {
        ...
        if (CLM_TRX_CCY_AMT > REIM_INST_BAL) {
            SYS_CheckError(document.MAINFORM.CLM_TRX_CCY_AMT, "Principal Amount Claimed<=Reimbursement Balance"); // Utility Auto Fix Comments
...
csFuncLevelProto.SYF_REIM_Cal_NET_CLAIM_ISSBK = function() {
    try {
        ...
        var ADD_AMT_CLMD; // Utility Auto Fix Comments
        var CHG_MINUS; // Utility Auto Fix Comments
        var CHG_PLUS; // Utility Auto Fix Comments
        var CLM_TRX_CCY_AMT; // Utility Auto Fix Comments
        var NET_CLAIM_ISSBK; // Utility Auto Fix Comments
        CLM_TRX_CCY_AMT = SYS_BeFloat(document.MAINFORM.CLM_TRX_CCY_AMT.value);
        ADD_AMT_CLMD = SYS_BeFloat(document.MAINFORM.ADD_AMT_CLMD.value);
        NET_CLAIM_ISSBK = SYS_BeFloat(document.MAINFORM.NET_CLAIM_ISSBK.value);
        ...
        if (NET_CLAIM_ISSBK < 0) {
            document.MAINFORM.NET_CLAIM_ISSBK.value = 0;
        }
    } catch (e) {
        DisExcpt("SYF_REIM_AmendClaim.js", e);
    }
...
csFuncLevelProto.SYF_REIM_Cal_NEW_REIM_CONF_BAL = function() {
    try {
        ...
        var ORG_CLM_TRX_CCY_AMT; // Utility Auto Fix Comments
        var PEND_REIM_CONF_BAL; // Utility Auto Fix Comments
        var ORG_PEND_REIM_CONF_BAL
        var REIM_CONF_BAL

        NEW_REIM_CONF_BAL = SYS_BeFloat(document.MAINFORM.NEW_REIM_CONF_BAL.value);
        PEND_REIM_CONF_BAL = SYS_BeFloat(document.MAINFORM.PEND_REIM_CONF_BAL.value);
        ORG_CLM_TRX_CCY_AMT = SYS_BeFloat(document.MAINFORM.ORG_CLM_TRX_CCY_AMT.value);
        CLM_TRX_CCY_AMT = SYS_BeFloat(document.MAINFORM.CLM_TRX_CCY_AMT.value);
        REIM_CONF_BAL = SYS_BeFloat(document.MAINFORM.REIM_CONF_BAL.value);
        ORG_PEND_REIM_CONF_BAL = SYS_BeFloat(document.MAINFORM.TEMP_AMT2.value);

        if (document.MAINFORM.CONF_INSTR.value == 'Confirmed') {
            if (document.MAINFORM.CANCEL_CLM_FLG.value == 'No') {
                PEND_REIM_CONF_BAL = ORG_PEND_REIM_CONF_BAL - ORG_CLM_TRX_CCY_AMT + CLM_TRX_CCY_AMT;
...
csFuncLevelProto.SYF_REIM_Cal_CHG_PLUS = function() {
    try {
        ...
        if (CHG_MINUS != 0) {
            document.MAINFORM.CHG_PLUS.value = "0.00";
...
csFuncLevelProto.SYF_REIM_Cal_CHG_MINUS = function() {
    try {
        ...
        CHG_PLUS = SYS_BeFloat(document.MAINFORM.CHG_PLUS.value);
        if (CHG_PLUS != 0) {
            document.MAINFORM.CHG_MINUS.value = "0.00";
...
csFuncLevelProto.FLD_REIM_CANCEL_CLM_FLG_onchange = function(event) {
    try {
...
csFuncLevelProto.FLD_REIM_CLM_TRX_CCY_AMT_onchange = function(event) {
    try {
        ...
        EEHtml.fireEvent(document.MAINFORM.ORG_CLM_TRX_CCY_AMT, 'onchange');
...
csFuncLevelProto.FLD_REIM_DOC_VALUE_onchange = function(event) {
    try {
        SYF_REIM_Cal_DOC_VALUE();
    } catch (e) {
        DisExcpt("SYF_REIM_AmendClaim.js", e);
...
csFuncLevelProto.FLD_REIM_NET_CLAIM_ISSBK_onchange = function(event) {
    try {
        SYF_REIM_Cal_NET_CLAIM_ISSBK();
    } catch (e) {
        DisExcpt("SYF_REIM_AmendClaim.js", e);
...
csFuncLevelProto.FLD_REIM_NEW_REIM_CONF_BAL_onchange = function(event) {
    try {
        SYF_REIM_Cal_NEW_REIM_CONF_BAL();
    } catch (e) {
        DisExcpt("SYF_REIM_AmendClaim.js", e);
...
csFuncLevelProto.FLD_REIM_ORG_CLM_TRX_CCY_AMT_onchange = function(event) {
    try {
        SYF_REIM_Cal_NEW_REIM_CONF_BAL();
        SYF_REIM_Cal_NEW_REIM_INST_BAL();
        EEHtml.fireEvent(document.MAINFORM.NEW_REIM_INST_BAL, 'onchange');
