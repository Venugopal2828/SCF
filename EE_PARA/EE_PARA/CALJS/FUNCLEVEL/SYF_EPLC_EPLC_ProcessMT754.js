...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        SYT_GetBKInfoByBIC(document.MAINFORM.BENE_BK_SW_ADD);
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_ProcessMT754.js", e);
    }
}
...
csFuncLevelProto.FLD_EPLC_BENE_BK_ADD_BTN_onclick = function(event) {
    try {
        SYS_InqCUBK('BENE_BK_ADD', 'BENE_BK_ID', 'ID'); // Utility Auto Fix Comments
    } catch (e) {
        DisExcpt("SYF_EPLC_EPLC_ProcessMT754.js", e);
    }
}
