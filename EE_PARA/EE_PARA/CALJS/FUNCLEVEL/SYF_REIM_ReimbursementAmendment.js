...
csFuncLevelProto.InitValues = function() {
    try {
        ...
        //start	
        document.MAINFORM.TEMP_AC_AMT7.value = document.MAINFORM.CASH_COV_AMT.value;
        document.MAINFORM.TEMP_AC_AMT8.value = document.MAINFORM.CASH_COV_AMT.value;
        document.MAINFORM.TEMP_CASH_COV_AC_NO.value = document.MAINFORM.CASH_COV_AC_NO.value;
        document.MAINFORM.TEMP_CASH_COV_DR_ACNO.value = document.MAINFORM.CASH_COV_DR_ACNO.value;
        //end
        SYT_CLERK_ID();
        ...
        DisExcpt("SYF_REIM_ReimbursementAmendment.js", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        var CASH_COV_AMT;
        var NEW_REIM_CONF_BAL;
        var ORG_CASH_COV_AMT;
        var REIM_CONF_BAL;
        var TEMP_AMT;
        if (document.MAINFORM.NEW_EXPIRY_DT.value == '') {
        ...
        SYF_REIM_Cal_TEMP_CASH_COV_FLG();
    } catch (e) {
        DisExcpt("SYF_REIM_ReimbursementAmendment.js", e);
    }
}
...
csFuncLevelProto.SYF_REIM_ChgFldCLS = function() {
    try {
        ...
        SYT_ChangeFldClass(document.MAINFORM.X730_TAG_57A, 'P');
...
csFuncLevelProto.SYF_REIM_Cal_NEW_AMT_SPEC = function() {
    try {
        ...
        if (document.MAINFORM.NEW_AMT_SPEC.value == "NOT EXCEEDING") {
            ...
            document.MAINFORM.TEMP_AC_AMT9.value = document.MAINFORM.CASH_COV_AMT.value;
            SYT_Cal_LOCAL_AMT('LC_CCY', 'REIM_INST_BAL', 'LOCAL_CCY', 'LOCAL_AMT', 'LOCAL_RATE');
...
csFuncLevelProto.SYF_REIM_Cal_TEMP_CASH_COV_FLG = function() {
    try {

        var CASH_COV_AC_NO = document.MAINFORM.CASH_COV_AC_NO.value;
        var TEMP_CASH_COV_AC_NO = document.MAINFORM.TEMP_CASH_COV_AC_NO.value;
        var CASH_COV_DR_ACNO = document.MAINFORM.CASH_COV_DR_ACNO.value;
        var TEMP_CASH_COV_DR_ACNO = document.MAINFORM.TEMP_CASH_COV_DR_ACNO.value;
        var CASH_COV_AMT = document.MAINFORM.CASH_COV_AMT.value;
        var TEMP_CASH_COV_AMT = document.MAINFORM.TEMP_AC_AMT7.value;
        if (CASH_COV_AC_NO != TEMP_CASH_COV_AC_NO || CASH_COV_DR_ACNO != TEMP_CASH_COV_DR_ACNO || CASH_COV_AMT != TEMP_CASH_COV_AMT) {
            document.MAINFORM.TEMP_CASH_COV_FLG.value = 'true';
        } else {
            document.MAINFORM.TEMP_CASH_COV_FLG.value = 'false';
        }
    } catch (e) {
        DisExcpt("SYF_REIM_ReimbursementAmendment.js", e);
    }
