...
csFuncLevelProto.PostconditionOnInit = function() {
    try {
        ...
        if (SYS_FUNCTION_TYPE == 'EC' || SYS_FUNCTION_TYPE == 'PM') {
            ...
            //SYF_FADA_GET_SBR_BUYER_CCY_EXCH_RT();
        }
        if (document.MAINFORM.FA_BUSI_TYPE.value == 'DF') {
            ...
            EEHtml.getElementById('G_SEPA').style.display = "none";
        ...
        if (document.MAINFORM.FA_BUSI_TYPE.value == 'DF') {
            EEHtml.getElementById('limitInfo').style.display = "";
        } else {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*PostconditionOnInit", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Get_BuyerLimitEndDate = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Get_BuyerLimitEndDate", e);
    }
}

csFuncLevelProto.SYF_FADA_GET_SBR_BUYER_CCY_EXCH_RT = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_GET_SBR_BUYER_CCY_EXCH_RT", e);
    }
}

csFuncLevelProto.SYF_FADA_Get_FA_LMT_BAL = function() {
    try {
        ...
        if (document.MAINFORM.FA_BUSI_TYPE.value == 'DF') {
            ////sFieldList = "LM_CRED_LMT;LM_OUTC_APL;LM_OUTC_APV;LM_OUTD_APL;LM_OUTD_APV";
            ////sMappingList = "LM_CRED_LMT;LM_OUTC_APL;LM_OUTC_APV;LM_OUTD_APL;LM_OUTD_APV";
            ...
            ////sFieldList = "LM_CRED_LMT;LM_OVER_OUT;LM_OUTD_APV;LM_OUTD_APL;LM_OUTC_APV";
            ////sMappingList = "LM_CRED_LMT;LM_OVER_OUT;LM_OUTD_APV;LM_OUTD_APL;LM_OUTC_APV";
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Get_FA_LMT_BAL", e);
    }
}

csFuncLevelProto.SYF_FADA_InqBuyerInfo = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_InqBuyerInfo", e);
    }
}

csFuncLevelProto.SYF_FADA_InqSellerInfo = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_InqSellerInfo", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Cal_FA_IRT_SPREAD = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Cal_FA_IRT_SPREAD", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Cal_setBA_FLG = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Cal_setBA_FLG", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCall = function() {
    try {
        ...
        //SYF_FADA_Cal_forChildtoMainScreen();
    } catch (e) {
        DisExcpt("SYF_FADA_AmendSBR.js*ConfirmBusinessCall", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Cal_IncDecFlg = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Cal_IncDecFlg", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Cal_FA_LMT_BAL = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Cal_FA_LMT_BAL", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Chk_FA_LMT_VAL_DT = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Chk_FA_LMT_VAL_DT", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Chk_FA_LMT_DUE_DT = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Chk_FA_LMT_DUE_DT", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Chk_DecrAmt = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Chk_DecrAmt", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Cal_CUST_TYPE = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Cal_CUST_TYPE", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*ConfirmBusinessCheck", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Chk_IncrAmt = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Chk_IncrAmt", e);
    }
}
...
csFuncLevelProto.SYF_FADA_checkDiscRate1 = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_checkDiscRate1", e);
    }
}
...
csFuncLevelProto.SYF_FADA_checkDiscRate2 = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_checkDiscRate2", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Cal_Incr_Decr_Amt = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Cal_Incr_Decr_Amt", e);
    }
}
...
csFuncLevelProto.SYF_FADA_MPO_IncDecAmt = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_MPO_IncDecAmt", e);
    }
}
...
csFuncLevelProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*ConfirmBusinessCheckSave", e);
    }
}
...
csFuncLevelProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*CancelCheck", e);
    }
}
...
csFuncLevelProto.addRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*addRecordCheck", e);
    }
}
...
csFuncLevelProto.editRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*editRecordCheck", e);
    }
}
...
csFuncLevelProto.deleteRecordCheck = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*deleteRecordCheck", e);
    }
}
...
csFuncLevelProto.LoadDODataOnInit = function() {
    try {
        ...
        /*if (SYS_FUNCTION_TYPE == 'PM') {
            SYF_FADA_Get_DOdata_BuyerInfo()
        }
        SYF_FADA_CHECK_DO_ENABLE();*/
    } catch (e) {
        DisExcpt("SYF_FADA_AmendSBR.js*LoadDODataOnInit", e);
    }
}
...
csFuncLevelProto.SYF_FADA_LoadDoComplete = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_LoadDoComplete", e);
    }
}
...
csFuncLevelProto.SYF_FADA_CHECK_DO_ENABLE = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_CHECK_DO_ENABLE", e);
    }
}
...
csFuncLevelProto.SYF_FADA_CHECK_POF_LOAN_FIELD = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_CHECK_POF_LOAN_FIELD", e);
    }
}
...
csFuncLevelProto.SYF_FADA_Cal_forChildtoMainScreen = function(node, recordId, status) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Cal_forChildtoMainScreen", e);
    }
}

csFuncLevelProto.SYF_FADA_Get_DOdata_BuyerInfo = function() {
    try {

        if (document.MAINFORM.FA_BUSI_TYPE.value == 'DISC') {
            //SYS_GetDataForDO_S('BuyerInfo');
            SYS_GetDataForDO_S("BuyerInfo", "N", false, '', "Buyer_Info");
        }
    } catch (e) {
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_Get_DOdata_BuyerInfo", e);
    }
}
...
csFuncLevelProto.SYF_FADA_MPO_BUYER_SELLER_ACC_NO = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_MPO_BUYER_SELLER_ACC_NO", e);
    }
}
...
csFuncLevelProto.SYF_FADA_CAL_DF_FIELDS = function() {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*SYF_FADA_CAL_DF_FIELDS", e);
    }
}
...
csFuncLevelProto.FLD_FADA_DIARY_NARRATIVE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_DIARY_NARRATIVE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_AUTO_DEBIT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_AUTO_DEBIT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_BUYER_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_BUYER_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_DECR_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_DECR_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_EF_HAN_CHG_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_EF_HAN_CHG_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_INCR_AMT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_INCR_AMT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_LMT_DUE_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_LMT_DUE_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_LMT_VAL_DT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_LMT_VAL_DT_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_LOAN_IRATE_TYPE_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_LOAN_IRATE_TYPE_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_PRM_DISC_RT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_PRM_DISC_RT_onchange", e);
    }
}

csFuncLevelProto.FLD_FADA_FA_COUNTER_CE_FLG_onchange = function() {
    try {
...
csFuncLevelProto.FLD_FADA_FA_CUST_FLAG_onchange = function() {
    try {
        SYF_FADA_Cal_CUST_TYPE();
    } catch (e) {
...
csFuncLevelProto.FLD_FADA_FA_SEL_ID_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_SEL_ID_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_FA_SND_DISC_RT_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_FA_SND_DISC_RT_onchange", e);
    }
}

csFuncLevelProto.FLD_FADA_FA_RELATION_STATUS_onchange = function() {
    try {
...
csFuncLevelProto.FLD_FADA_TEMP_FLG1_onchange = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_TEMP_FLG1_onchange", e);
    }
}
...
csFuncLevelProto.FLD_FADA_view_1_onclick = function(event) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendSBR.js*FLD_FADA_view_1_onclick", e);
    }
}