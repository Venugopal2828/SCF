...
{
	document.MAINFORM.FA_DOC_BAL.value = SYS_BeFloat(document.MAINFORM.FA_TEMP_AMT8.value) - SYS_BeFloat(document.MAINFORM.FA_INV_CLEAR_AMT.value);
}
...
{
document.MAINFORM.FA_INV_CLEAR_AMT.value=0-SYS_BeFloat(document.MAINFORM.FA_TEMP_AMT8.value);
}
...
if(document.MAINFORM.FA_DOC_TYPE.value=='2')
{
document.MAINFORM.FA_INV_CLEAR_AMT.value = 0-SYS_BeFloat(document.MAINFORM.FA_PMT_AMT.value);
}
else
{
...
csDOScreenProto.PostconditionOnInit = function() {
    try {
        ...
        SYS_GetTableDataByRule_S('SSSS_FAEF_setl_PostconditionOnInit_0', '1');
