...
csDOScreenProto.AmtFormatAmtTrxccy = function() {
    try {
        ...
        DisExcpt("SSSS_PaymentCredit.js", e);
    }
}
...
csDOScreenProto.CAL_CPYT_CR_PER = function() {
    try {
...
csDOScreenProto.CAL_X202_BKTOBK_INFO72 = function() {
    try {
...
csDOScreenProto.CHK_CPYT_CR_VAL_DATE = function() {
    try {
...
csDOScreenProto.CPYT_CR_AMT_TXCCY = function() {
    try {
        ...
        document.MAINFORM.CPYT_CR_BAL_TXCCY.value = SYT_AmtFormat(ccy, document.MAINFORM.CPYT_CR_BAL_TXCCY.value);
    } catch (e) {
        DisExcpt("SSSS_PaymentCredit.js", e);
    }
}
...
csDOScreenProto.Cal_X103_VALUE_DT_32A = function() {
    try {
...
csDOScreenProto.Change_53andRecevieBank = function() {
    try {
        if ("REIM" == SYS_MODULE_NAME) {
...
csDOScreenProto.Credit_Fields = function() {
    try {
...
csDOScreenProto.ExchangingRate = function() {
    try {
        ...
        if (fromccy == toccy) {
            ...
            } else if (cpytcreditAmt > 50000 && cpytcreditAmt < 250000) {
...
csDOScreenProto.PostconditionOnInit = function() {
    try {
        ...
        if (SYS_ORG_FUNCTION_NAME == "EXCO_SettlementAtMaturity" || SYS_ORG_FUNCTION_NAME == "EPLC_PayAtMaturity" || SYS_ORG_FUNCTION_NAME == "EPLC_PaymentAtMaturityFrCE") {
            if (document.MAINFORM.DISCNT_FLG.value == "YES") {
                SYT_ChangeFldClass(document.MAINFORM.CPYT_CR_AC, 'P');
                SYT_ChangeFldClass(document.MAINFORM.CPYT_CR_AC_BTN, 'P');
        ...
        if (SYS_MODULE_NAME == "IPLC") {
            if (SYS_ORG_FUNCTION_NAME == "IPLC_PayAcceptWithDiscount" || SYS_ORG_FUNCTION_NAME == "IPLC_PaymentAtMaturity") {
...
csDOScreenProto.Set_X400_ADV_BK_ID_from_MAIN = function() {
    try {
...
csDOScreenProto.X202_TAB_onclick = function() {
    try {
...
csDOScreenProto.X103_BKTOBK_INFO72_onchange = function(event) {
    try {
...
csDOScreenProto.X103_REG_REP_77B_onchange = function(event) {
    try {
...
csDOScreenProto.X103_REMIT_INFO_70_onchange = function(event) {
    try {
...
csDOScreenProto.X202_BKTOBK_INFO72_onchange = function(event) {
    try {
...
csDOScreenProto.X202_MEDIBKACNO56A_onchange = function(event) {
    try {
        SYT_CHK_AC_NO(document.MAINFORM.X202_MEDIBKACNO56A);
    } catch (e) {
        DisExcpt("SSSS_PaymentCredit.js", e);
...
csDOScreenProto.X400_ACC_BK_ADD_BTN_onclick = function(event) {
    try {
...
csDOScreenProto.X400_BKTOBK_INFO_72_onchange = function(event) {
    try {
