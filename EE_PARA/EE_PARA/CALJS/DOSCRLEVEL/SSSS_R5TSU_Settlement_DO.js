"path:SCRN/DO/R5TSU_Settlement_DO.jsp";
...
csDOScreenProto.AddSameDoRecord = function(attrName, xpath) {
    try {
        ...
        DisExcpt("SSSS_R5TSU_Settlement_DO.js", e);
    }
}
...
csDOScreenProto.DO_XPATH = function() {
    try {
        if (SYS_DO_XPATH == "R5SettlementTerms" || SYS_DO_XPATH == "R5SettlementTermsRe") {
...
csDOScreenProto.InitValues = function() {
    try {
        DO_XPATH();
        if (SYS_DO_XPATH == "R5PaymentObligation.R5SettlementTerms2" || SYS_DO_XPATH == "R5PaymentObligationRe.R5SettlementTerms2") {
            AddSameDoRecord('R5SettlementTerms', 'Payment');
        }
...
csDOScreenProto.TsuBene = function() {
    try {
        if (document.MAINFORM.TSU_BENE_IBAN.value == "") {
            if (document.MAINFORM.TSU_IDNT_ID.value == "") {
                if (document.MAINFORM.TSU_SCHM_CD.value == "" && document.MAINFORM.TSU_PRTRY_NM.value == "") {
                    SYT_ChangeFldClass(document.MAINFORM.TSU_SCHM_CD, 'O', 'N');
                    SYT_ChangeFldClass(document.MAINFORM.TSU_PRTRY_NM, 'O', 'N');
                    SYT_ChangeFldClass(document.MAINFORM.TSU_BENE_IBAN, 'M', 'N');
                    SYT_ChangeFldClass(document.MAINFORM.TSU_IDNT_ID, 'M', 'N');

                } else if (document.MAINFORM.TSU_SCHM_CD.value != "") {
                    SYT_ChangeFldClass(document.MAINFORM.TSU_SCHM_CD, 'M', 'N');
                    SYT_ChangeFldClass(document.MAINFORM.TSU_PRTRY_NM, 'P', 'N');
                } else if (document.MAINFORM.TSU_PRTRY_NM.value != "") {
                    SYT_ChangeFldClass(document.MAINFORM.TSU_PRTRY_NM, 'M', 'N');
                    SYT_ChangeFldClass(document.MAINFORM.TSU_SCHM_CD, 'P', 'N');
                }
            } else if (document.MAINFORM.TSU_IDNT_ID.value != "") {
                SYT_ChangeFldClass(document.MAINFORM.TSU_IDNT_ID, 'M', 'N');
        ...
        } else if (document.MAINFORM.TSU_BENE_IBAN.value != "") {
            SYT_ChangeFldClass(document.MAINFORM.TSU_BENE_IBAN, 'M', 'N');
            SYT_ChangeFldClass(document.MAINFORM.TSU_SCHM_CD, 'P', 'N');
            SYT_ChangeFldClass(document.MAINFORM.TSU_PRTRY_NM, 'P', 'N');
            SYT_ChangeFldClass(document.MAINFORM.TSU_IDNT_ID, 'P', 'N');
        }
    } catch (e) {
        DisExcpt("SSSS_R5TSU_Settlement_DO.js", e);
    }
...
csDOScreenProto.checkSetment = function() {
    try {
        var i; // Utility Auto Fix Comments
...
csDOScreenProto.TSU_IDNT_ID_onchange = function(event) {
    try {
        TsuBene();
    } catch (e) {
        DisExcpt("SSSS_R5TSU_Settlement_DO.js", e);
...
csDOScreenProto.TSU_PRTRY_NM_onchange = function(event) {
    try {
        TsuBene();
    } catch (e) {
        DisExcpt("SSSS_R5TSU_Settlement_DO.js", e);
...
csDOScreenProto.TSU_SCHM_CD_onchange = function(event) {
    try {
        TsuBene();
    } catch (e) {
        DisExcpt("SSSS_R5TSU_Settlement_DO.js", e);
