...
csDOScreenProto.ConfirmBusinessCall = function() {
    try {
        setTimeout("SYT_Sum_of_Amount_19('X201_SEQ_B','X203_32B_AMT')", 500);
    } catch (e) {
        DisExcpt("SSSS_201_SEQ_B.js", e);
    }
}
...
csDOScreenProto.InitValues = function() {
    try {
        ...
        document.MAINFORM.X203_20_REF.value = C_MAIN_REF.substr(2, C_MAIN_REF.length - 2) + SYT_Cal_ORDER_NO('X201_SEQ_B');
    } catch (e) {
        DisExcpt("SSSS_201_SEQ_B.js", e);
    }
}
...
csDOScreenProto.X203_21_REF_onchange = function(event) {
    try {
        SYS_GetCUBK('X201_21_REF', 'X203_21_REF', SYT_Cal_DO_XXXX_SEQ_B_21_REF("X201_SEQ_B", document.MAINFORM.X203_21_REF));
    } catch (e) {
        DisExcpt("SSSS_201_SEQ_B.js", e);
    }
}
...
csDOScreenProto.X203_21_REF_BTN_onclick = function(event) {
    try {
        //SYS_InqCUBK_Sql('X201_21_REF', 'C_TRX_STATUS = \'M\' ');
        SYS_InqCUBK_byCondition('X201_21_REF', '1');
    } catch (e) {
        DisExcpt("SSSS_201_SEQ_B.js", e);
    }
}
