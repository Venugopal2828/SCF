"path:SCRN/DO/R5TSU_LineItem.jsp";
...
csDOScreenProto.CheckCurrFreight = function() {
    try {
        ...
        DisExcpt("SSSS_R5TSU_LineItem.js", e);
    }
}
...
csDOScreenProto.FreightType = function() {
    try {
        ...
        Freight = null;
        if (SYS_DO_XPATH == "R5GoodsRe.R5LineItemDetails7") {
            Freight = parent.SYS_getCurrNodeParentValue('R5GoodsRe', 'TSU_FRGHT_TP');
        } else {
            Freight = parent.SYS_getCurrNodeParentValue('R5Goods', 'TSU_FRGHT_TP');
        }
...
csDOScreenProto.TSU_CCY = function() {
    try {
        ...
        if (SYS_DO_XPATH == "R5GoodsRe.R5LineItemDetails7") {
            vTSU_CCY = parent.SYS_getCurrNodeParentValue('R5GoodsRe', 'TSU_CCY');
        } else {
            vTSU_CCY = parent.SYS_getCurrNodeParentValue('R5Goods', 'TSU_CCY'); // Utility Auto Fix Comments
        }
