"path:SCRN/o2m/FAEF_ManUploadInv.jsp";
...
csDOScreenProto.CalCommChg = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*CalCommChg", e);
    }
}
...
csDOScreenProto.CancelCheck = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*CancelCheck", e);
    }
}
...
csDOScreenProto.ConfirmBusinessCall = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*ConfirmBusinessCall", e);
    }
}
...
csDOScreenProto.ConfirmBusinessCheck = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*ConfirmBusinessCheck", e);
    }
}
...
csDOScreenProto.ConfirmBusinessCheckSave = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*ConfirmBusinessCheckSave", e);
    }
}
...
csDOScreenProto.FA_BA_FLG = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*FA_BA_FLG", e);
    }
}
...
csDOScreenProto.InitValues = function() {
    try {
        ...
        if (SYS_ORG_FUNCTION_NAME == 'InvoiceTransfer_ME') {
            SYS_GetSubPageRefNo_S('SCF_INV_REF', setManUploadInv, '', 'ManUploadInv', 'ManUploadInv');
        } else {
            SYS_getDORefForDO('FAEF_MANINV_REF', setManUploadInv, '', 'ManUploadInv', 'ManUploadInv');
        }

		document.MAINFORM.FA_DOC_DT.value = SYS_BUSI_DATE;
        document.MAINFORM.FA_DOC_VAL_DT.value = SYS_BUSI_DATE;
    } catch (e) {
        DisExcpt("SSSS_FAEF_ManUploadInv.js*InitValues", e);
    }
}
...
csDOScreenProto.PostconditionOnInit = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*PostconditionOnInit", e);
    }
}
...
csDOScreenProto.PreconditionOnInit = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*PreconditionOnInit", e);
    }
}
...
csDOScreenProto.ReferenceNumber = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*ReferenceNumber", e);
    }
}
...
csDOScreenProto.calTotalInvoiceAmtandNO = function() {
    try {
        ...
        num = SYS_getcurrRecordCount("ManUploadInv"); //grid.getRowCount();
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*calTotalInvoiceAmtandNO", e);
    }
}
...
csDOScreenProto.checkDocDate = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*checkDocDate", e);
    }
}
...
csDOScreenProto.checkDocValDate = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*checkDocValDate", e);
    }
}
...
csDOScreenProto.checkINV_NO = function() {
    try {
        ...
        node = SYS_getDoByXpath('ManUploadInv');
        ...
        SYS_GetTableDataByRule_S('SYF_FAEF_ManualUploadInvoice_Check_Duplicate', '1', 'Y');
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*checkINV_NO", e);
    }
}
...
csDOScreenProto.checkINV_NO_table = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*checkINV_NO_table", e);
    }
}
...
csDOScreenProto.check_invduedate = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*check_invduedate", e);
    }
}
...
csDOScreenProto.chkIssueDT = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*chkIssueDT", e);
    }
}
...
csDOScreenProto.getInvDueDate = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*getInvDueDate", e);
    }
}
...
csDOScreenProto.setDocBalance = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*setDocBalance", e);
    }
}
...
csDOScreenProto.setInvDueDate = function(date) {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*setInvDueDate", e);
    }
}

csDOScreenProto.setManUploadInv = function(ref) {
    try {
        if (SYS_ORG_FUNCTION_NAME == 'InvoiceTransfer_ME') {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*setManUploadInv", e);
    }
}

csDOScreenProto.window_onload = function() {
    try {} catch (e) {
        DisExcpt("SSSS_FAEF_ManUploadInv.js*window_onload", e);
    }
}
...
csDOScreenProto.FA_DOC_AMT_onchange = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*FA_DOC_AMT_onchange", e);
    }
}
...
csDOScreenProto.FA_DOC_DT_onchange = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*FA_DOC_DT_onchange", e);
    }
}
...
csDOScreenProto.FA_DOC_NO_onchange = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*FA_DOC_NO_onchange", e);
    }
}
...
csDOScreenProto.FA_DOC_VAL_DT_onchange = function() {
    try {
        ...
        DisExcpt("SSSS_FAEF_ManUploadInv.js*FA_DOC_VAL_DT_onchange", e);
    }
}

csDOScreenProto.FA_PMT_TERMS_onchange = function() {
    try {} catch (e) {
        DisExcpt("SSSS_FAEF_ManUploadInv.js*FA_PMT_TERMS_onchange", e);
    }
}