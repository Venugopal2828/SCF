function GeneralAccountHeader_GeneralAccount_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_REIM_REIM_GeneralAccounting_DO.js", e);
    }
}
...
function SYF_REIM_getDOdata_GeneralAccountHeader() {
    try {
...
function SYF_REIM_getDOdata_GeneralAccountHeader_GeneralAccount() {
    try {
