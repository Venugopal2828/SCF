function GeneralAccountHeader_GeneralAccount_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_SYND_SYND_GeneralAccounting_DO.js", e);
    }
}
...
function SYF_SYND_getDOdata_GeneralAccountHeader() {
    try {
...
function SYF_SYND_getDOdata_GeneralAccountHeader_GeneralAccount() {
    try {
