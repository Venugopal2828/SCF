function AdviceForBankCust_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_SBLC_SBLC_ProcessClaim_DO.js", e);
    }
}
...
function SYF_SBLC_getDOdata_AdviceForBankCust() {
    try {
...
function BneficiarySBLC_OnDeSelected(node, record, recordId) {
    try {
...
function BneficiarySBLC_OnSelected(node, record, recordId) {
    try {
...
function SYF_SBLC_getDOdata_BneficiarySBLC() {
    try {
...
function SYF_SBLC_getDOdata_PaymentDealer() {
    try {
...
function SYF_SBLC_getDOdata_PaymentDealer_PaymentCreditHeader() {
    try {
...
function SYF_SBLC_getDOdata_PaymentDealer_PaymentCreditHeader_PaymentCredit() {
    try {
...
function SYF_SBLC_getDOdata_PaymentDealer_PaymentDebitHeader() {
    try {
...
function SYF_SBLC_getDOdata_PaymentDealer_PaymentDebitHeader_PaymentDebit() {
    try {
