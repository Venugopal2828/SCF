function InvFinance(node, recordId, status) {
    try {
            ...
            if ('D' != status) {
                for (i = 0, len = arrayvalue.length; i < len; i++) {
                    ...
                    loanamt = SYS_BeFloat(lmtApprv) * (SYS_BeFloat(FA_LOAN_PERC) / 100);*/
                        ...
                        loanamt = SYT_CCY_AMT(document.MAINFORM.FA_LMT_CCY.value, loanamt);
                        loanbal = SYT_CCY_AMT(document.MAINFORM.FA_LMT_CCY.value, loanbal);
                        ttlloanamt = SYT_CCY_AMT(document.MAINFORM.FA_LMT_CCY.value, ttlloanamt);
                        ...
                        if (document.MAINFORM.FA_INT_CHG_TYPE.value == '1') {
                            ...
                            if (SYS_BeFloat(loanamt) > 0) {
                                ...
                                netInt = SYS_BeFloat(iaYReaccInt);
              ...
              document.MAINFORM.FA_PAID_INT_SUM.value = SYT_CCY_AMT(document.MAINFORM.FA_LMT_CCY.value, document.MAINFORM.FA_PAID_INT_SUM.value);
        ...
        DisExcpt("SYF_FAEF_DFFinancingFromCE_DO.js", e);
    }
}
