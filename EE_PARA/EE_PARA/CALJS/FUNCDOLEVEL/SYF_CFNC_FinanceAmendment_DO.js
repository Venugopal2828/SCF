function FincAmend_OnDeSelected(node, record, recordId) {
    try {

    } catch (e) {
        DisExcpt("SYF_CFNC_FinanceAmendment_DO.js", e);
    }
}

function FincAmend_OnSelected(node, record, recordId) {
    try {
...
function SYF_CFNC_getDOdata_FincAmend() {
    try {
...
function SYF_CFNC_getDOdata_PaymentDealer() {
    try {
...
function SYF_CFNC_getDOdata_PaymentDealer_PaymentCreditHeader() {
    try {
...
function SYF_CFNC_getDOdata_PaymentDealer_PaymentCreditHeader_PaymentCredit() {
    try {
...
function SYF_CFNC_getDOdata_PaymentDealer_PaymentDebitHeader() {
    try {
...
function SYF_CFNC_getDOdata_PaymentDealer_PaymentDebitHeader_PaymentDebit() {
    try {
