function R2DatasetRequired(node, recordId, status) {
    try {
        ...
        DisExcpt("SYF_TSUM_R2ProcessOutgoingBaselineRequest_DO.js", e);
    }
}
...
function R2Goods_R2LineItemDetails7(node, recordId, status) {
    try {
        ...
        function LineItmDtls_Edit(node, editedRecordId) {
            ...
            /*if (sum!=0)
	{
		LineItmDtls_Edit_brother(node);
	}
	else{
		LineItmDtls_Edit_child(node,editedRecordId);
	}

}

function LineItmDtls_Edit_brother(node){
...
function LineItmDtls_Edit_child(node,editedRecordId){*/
            // Get the changed TSU_TTL_AMT VALUE
            var nTSU_QTY_VAL = SYS_getFieldValue(node, editedRecordId, 'TSU_QTY_VAL');
            SYS_setFieldValue(node, editedRecordId, 'TSU_QTY_OUVAL', nTSU_QTY_VAL);
            ...
            SYS_setFieldValue(node, editedRecordId, 'TSU_TTL_OUAMT', nSumTTLAmt);
            var TSU_TTL_AMT_sum = SYS_getFieldSumByDoName('TSU_TTL_AMT');
            TSU_TTL_AMT_sum = SYS_BeFloat(TSU_TTL_AMT_sum);
            ...
            SYS_setCurrNodeParentValue('R2Goods', "TSU_TTL_NET_OUAMT", nSumTTLAmt);
            SYS_RefreshGrid();
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByAir(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByAir_DprtureAirprt(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByAir_DstnAirprt(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRail(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRail_PlcOfDlvry(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRail_PlcOfRct(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRoad(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRoad_PlcOfDlvry(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRoad_PlcOfRct(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportBySea(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportBySea_PortOfDschrge(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2IndvTrnsprt_R2TransportBySea_PortOfLoadng(node, recordId, status) {
    try {
...
function R2Goods_R2LineItemDetails7_R2RoutingSummary_R2MltmdlTrnsprt(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByAir(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByAir_DprtureAirprt(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByAir_DstnAirprt(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRail(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRail_PlcOfDlvry(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRail_PlcOfRct(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRoad(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRoad_PlcOfDlvry(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportByRoad_PlcOfRct(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportBySea(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportBySea_PortOfDschrge(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2IndvTrnsprt_R2TransportBySea_PortOfLoadng(node, recordId, status) {
    try {
...
function R2Goods_R2RoutingSummary_R2MltmdlTrnsprt(node, recordId, status) {
    try {
...
function R2InvolvedPartyInfo_BillTo(node, recordId, status) {
    try {
        ...
        var TSU_PARTY_NM = SYS_getCurrDoScreenValue('TSU_PARTY_NM');
        var TSU_PARTY_CNTY = SYS_getCurrDoScreenValue('TSU_PARTY_CNTY');
        var record = [DoFrame.tree.getDONameFunction(node, '_') + recordId, "Bill To", CUST_ID, '', TSU_PARTY_NM, TSU_PARTY_CNTY, 'A'];
...
function R2InvolvedPartyInfo_Buyer(node, recordId, status) {
    try {
        ...
        var record = [index + recordId, "Buyer", CUST_ID, '', TSU_PARTY_NM, TSU_PARTY_CNTY, 'A'];
        SYS_DistillInfo(node, recordId, status, record);
...
function R2InvolvedPartyInfo_BuyerBank(node, recordId, status) {
    try {
        ...
        var TSU_BUYER_BK_ID = SYS_getCurrDoScreenValue('TSU_BUYER_BK_ID');
        var TSU_BUYER_BK_BIC = SYS_getCurrDoScreenValue('TSU_BUYER_BK_BIC');
        var TSU_BUYER_BK_NM = SYS_getCurrDoScreenValue('TSU_BUYER_BK_NM');
        //var TSU_BYRBK_ID = SYS_getCurrDoScreenValue('TSU_BYRBK_ID');
        var record = [DoFrame.tree.getDONameFunction(node, '_') + recordId, "Buyer Bank", TSU_BUYER_BK_ID, TSU_BUYER_BK_BIC, TSU_BUYER_BK_NM, '', 'A'];
        SYS_DistillInfo(node, recordId, status, record);
...
function R2InvolvedPartyInfo_BuyrSdSubmitgBk(node, recordId, status) {
    try {
        var TSU_BUYER_BK_ID = SYS_getCurrDoScreenValue('TSU_BUYER_BK_ID');
        var TSU_BUYER_SUB_BK = SYS_getCurrDoScreenValue('TSU_BUYER_SUB_BK');
        var TSU_BUYER_BK_NM = SYS_getCurrDoScreenValue('TSU_BUYER_BK_NM');;
        var record = [DoFrame.tree.getDONameFunction(node, '_') + recordId, "Buyer Side Submitting Bank", TSU_BUYER_BK_ID, TSU_BUYER_SUB_BK, TSU_BUYER_BK_NM, '', 'A'];
        SYS_DistillInfo(node, recordId, status, record);
    } catch (e) {
        DisExcpt("SYF_TSUM_R2ProcessOutgoingBaselineRequest_DO.js", e);
    }
...
function R2InvolvedPartyInfo_Consignee(node, recordId, status) {
    try {
        ...
        var TSU_PARTY_NM = SYS_getCurrDoScreenValue('TSU_PARTY_NM');
        var TSU_PARTY_CNTY = SYS_getCurrDoScreenValue('TSU_PARTY_CNTY');
        var record = [DoFrame.tree.getDONameFunction(node, '_') + recordId, "Consignee", CUST_ID, '', TSU_PARTY_NM, TSU_PARTY_CNTY, 'A'];
        SYS_DistillInfo(node, recordId, status, record);
...
function R2InvolvedPartyInfo_Seller(node, recordId, status) {
    try {
        ...
        var TSU_PARTY_NM = SYS_getCurrDoScreenValue('TSU_PARTY_NM');
        var TSU_PARTY_CNTY = SYS_getCurrDoScreenValue('TSU_PARTY_CNTY');
        var record = [DoFrame.tree.getDONameFunction(node, '_') + recordId, "Seller", CUST_ID, '', TSU_PARTY_NM, TSU_PARTY_CNTY, 'A'];
        SYS_DistillInfo(node, recordId, status, record);
...
function R2InvolvedPartyInfo_SellerBank(node, recordId, status) {
    try {
        ...
        var TSU_SEL_BK_ID = SYS_getCurrDoScreenValue('TSU_SEL_BK_ID');
        var TSU_SEL_BK_BIC = SYS_getCurrDoScreenValue('TSU_SEL_BK_BIC');
        var TSU_SEL_BK_NM = SYS_getCurrDoScreenValue('TSU_SEL_BK_NM');
        var record = [DoFrame.tree.getDONameFunction(node, '_') + recordId, "Seller Bank", TSU_SEL_BK_ID, TSU_SEL_BK_BIC, TSU_SEL_BK_NM, '', 'A'];
        SYS_DistillInfo(node, recordId, status, record);
...
function R2InvolvedPartyInfo_SellerBank_ContactIdentification1(node, recordId, status) {
    try {
...
function R2InvolvedPartyInfo_Seller_ContactIdentification1(node, recordId, status) {
    try {
...
function R2InvolvedPartyInfo_SellrSdSubmitgBk(node, recordId, status) {
    try {
        var TSU_SEL_BK_ID = SYS_getCurrDoScreenValue('TSU_SEL_BK_ID');
        var TSU_SEL_SUB_BK = SYS_getCurrDoScreenValue('TSU_SEL_SUB_BK');
        var TSU_SEL_BK_NM = SYS_getCurrDoScreenValue('TSU_SEL_BK_NM');
        var xpath = DoFrame.tree.getDONameFunction(node, '_');
        var record = [xpath + recordId, "Seller Side Submitting Bank", TSU_SEL_BK_ID, TSU_SEL_SUB_BK, TSU_SEL_BK_NM, '', 'A'];
        SYS_DistillInfo(node, recordId, status, record);
...
function R2InvolvedPartyInfo_ShipTo(node, recordId, status) {
    try {
        ...
        var TSU_PARTY_NM = SYS_getCurrDoScreenValue('TSU_PARTY_NM');
        var TSU_PARTY_CNTY = SYS_getCurrDoScreenValue('TSU_PARTY_CNTY');
        var record = [DoFrame.tree.getDONameFunction(node, '_') + recordId, "Ship To", CUST_ID, '', TSU_PARTY_NM, TSU_PARTY_CNTY, 'A'];
        SYS_DistillInfo(node, recordId, status, record);
