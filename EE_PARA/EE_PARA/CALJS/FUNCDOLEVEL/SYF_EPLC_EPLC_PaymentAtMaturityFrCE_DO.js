function AdviceForBankCust_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_EPLC_EPLC_PaymentAtMaturityFrCE_DO.js", e);
    }
}
...
function SYF_EPLC_getDOdata_FincSinglePayment() {
    try {
...
function SYF_EPLC_getDOdata_PaymentDealer() {
    try {
...
function SYF_EPLC_getDOdata_PaymentDealer_PaymentCreditHeader() {
    try {
...
function SYF_EPLC_getDOdata_PaymentDealer_PaymentCreditHeader_PaymentCredit() {
    try {
...
function SYF_EPLC_getDOdata_PaymentDealer_PaymentDebitHeader() {
    try {
...
function SYF_EPLC_getDOdata_PaymentDealer_PaymentDebitHeader_PaymentDebit() {
    try {
