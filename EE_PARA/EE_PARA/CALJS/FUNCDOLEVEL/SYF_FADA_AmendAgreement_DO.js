function DFAgreement(node, recordId, status) {
    try {
        ...
        DisExcpt("SYF_FADA_AmendAgreement_DO.js", e);
    }
}
...
function EndCtr_OnDeSelected(node, record, recordId) {
    try {
...
function EndCtr_OnSelected(node, record, recordId) {
    try {
...
function SYF_FADA_getDOdata_EndCtr() {
    try {
