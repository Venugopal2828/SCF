function AdviceForBankCust_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_IWGT_IWGT_SettlementClaim_CE_DO.js", e);
    }
}
...
function SYF_IWGT_getDOdata_AdviceForBankCust() {
    try {
...
function SYF_IWGT_getDOdata_PaymentDealer() {
    try {
...
function SYF_IWGT_getDOdata_PaymentDealer_PaymentCreditHeader() {
    try {
...
function SYF_IWGT_getDOdata_PaymentDealer_PaymentCreditHeader_PaymentCredit() {
    try {
...
function SYF_IWGT_getDOdata_PaymentDealer_PaymentDebitHeader() {
    try {
...
function SYF_IWGT_getDOdata_PaymentDealer_PaymentDebitHeader_PaymentDebit() {
    try {
