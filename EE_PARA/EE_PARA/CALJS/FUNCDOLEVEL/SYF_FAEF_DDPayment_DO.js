...
function InvFinance(node, recordId, status) {
    try {
       ...
       // num = SYS_getcurrRecordCount("InvFinance");
        ...
        DisExcpt("SYF_FAEF_DDPayment_DO.js*InvFinance", e);
    }
}

function InvFinance_OnDeSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*InvFinance_OnDeSelected", e);
    }
}

function InvFinance_OnSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*InvFinance_OnSelected", e);
    }
}

function MultiCreditSummary_MultiCredit_OnDeSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*MultiCreditSummary_MultiCredit_OnDeSelected", e);
    }
}

function MultiCreditSummary_MultiCredit_OnSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*MultiCreditSummary_MultiCredit_OnSelected", e);
    }
}

function MultiCreditSummary_OnDeSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*MultiCreditSummary_OnDeSelected", e);
    }
}

function MultiCreditSummary_OnSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*MultiCreditSummary_OnSelected", e);
    }
}

function MultiDebitSummary_MultiDebit_OnDeSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*MultiDebitSummary_MultiDebit_OnDeSelected", e);
    }
}

function MultiDebitSummary_MultiDebit_OnSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*MultiDebitSummary_MultiDebit_OnSelected", e);
    }
}

function MultiDebitSummary_OnDeSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*MultiDebitSummary_OnDeSelected", e);
    }
}

function MultiDebitSummary_OnSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*MultiDebitSummary_OnSelected", e);
    }
}
...
function SYF_FAEF_getDOdata_InvFinance(node, record, recordId) {
    try {
            ...
            var docNo = SYS_getValFromRec(record, 'FA_DOC_NO');
                        if(loandays >0 ){
                            if (RT == null ||  RT == '' && status != 'E') {
                            	 var ref = ref + docNo + '; ' ;
                         // alert("Invoice: " + docNo + " has no available DD Rate Rule, can't do discount.");    
                        // continue;
                              }
                        }
      ...
      if(ref.length!=0){
         alert("Invoice: " + ref + " has no available DD Rate Rule, can't do discount.");    
       }
       if(ovr.length!=0){
       	alert("Invoice: " + ovr + " is overdue, will be paid!");  
      }
        ...
        DisExcpt("SYF_FAEF_DDPayment_DO.js*SYF_FAEF_getDOdata_InvFinance", e);
    }
}

function SYF_FAEF_getDOdata_MultiCreditSummary(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*SYF_FAEF_getDOdata_MultiCreditSummary", e);
    }
}

function SYF_FAEF_getDOdata_MultiCreditSummary_MultiCredit(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*SYF_FAEF_getDOdata_MultiCreditSummary_MultiCredit", e);
    }
}

function SYF_FAEF_getDOdata_MultiDebitSummary(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*SYF_FAEF_getDOdata_MultiDebitSummary", e);
    }
}

function SYF_FAEF_getDOdata_MultiDebitSummary_MultiDebit(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_DDPayment_DO.js*SYF_FAEF_getDOdata_MultiDebitSummary_MultiDebit", e);
    }
}