function R2ComrclDataset_DT_BillTo_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_TSUM_R2ReceiveInvoiceData_DO.js", e);
    }
}
...
function SYF_TSUM_getDOdata_R2ComrclDataset_DT_PmtTerms() {
    try {
...
function SYF_TSUM_getDOdata_R2ComrclDataset_R2DT_ComrclDocRef() {
    try {
...
function SYF_TSUM_getDOdata_R2ComrclDataset_R2DT_ComrclDocRef_R2DT_Goods() {
    try {
...
function SYF_TSUM_getDOdata_R2ComrclDataset_R2DT_SttlmTerms() {
    try {
