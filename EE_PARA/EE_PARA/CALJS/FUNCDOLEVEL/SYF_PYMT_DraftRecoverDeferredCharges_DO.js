function PaymentDealer_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_PYMT_DraftRecoverDeferredCharges_DO.js", e);
    }
}
...
function SYF_PYMT_getDOdata_PaymentDealer() {
    try {
...
function SYF_PYMT_getDOdata_PaymentDealer_PaymentCreditHeader() {
    try {
...
function SYF_PYMT_getDOdata_PaymentDealer_PaymentCreditHeader_PaymentCredit() {
    try {
...
function SYF_PYMT_getDOdata_PaymentDealer_PaymentDebitHeader() {
    try {
...
function SYF_PYMT_getDOdata_PaymentDealer_PaymentDebitHeader_PaymentDebit() {
    try {
