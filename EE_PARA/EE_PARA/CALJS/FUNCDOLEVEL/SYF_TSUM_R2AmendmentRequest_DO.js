function R2DatasetRequiredRe_CertificateDataSetRequired(node, recordId, status) {
    try {
        ...
        DisExcpt("SYF_TSUM_R2AmendmentRequest_DO.js", e);
    }
}
...
function R2GoodsRe_R2LineItemDetails7_R2RoutingSummary(node, recordId, status) {
    try {
...
function R2GoodsRe_R2RoutingSummary(node, recordId, status) {
    try {
        /*var selectValue=SYS_getCurrDoScreenValue("selectobj");
if (selectValue=="0"){
  SYS_setChildDoDisabled("R2MltmdlTrnsprt",recordId);
