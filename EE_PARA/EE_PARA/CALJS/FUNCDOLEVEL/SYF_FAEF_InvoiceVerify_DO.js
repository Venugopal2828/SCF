function SYF_FAEF_getDOdata_VerifyInv(node, recordId, status) {
    try {
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify_DO.js*SYF_FAEF_getDOdata_VerifyInv", e);
    }
}
...
//tempo solution end        
        ...
        DisExcpt("SYF_FAEF_InvoiceVerify_DO.js*VerifyInv", e);
    }
}

function VerifyInv_OnDeSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_InvoiceVerify_DO.js*VerifyInv_OnDeSelected", e);
    }
}

function VerifyInv_OnSelected(node, record, recordId) {
    try {} catch (e) {
        DisExcpt("SYF_FAEF_InvoiceVerify_DO.js*VerifyInv_OnSelected", e);
    }
}