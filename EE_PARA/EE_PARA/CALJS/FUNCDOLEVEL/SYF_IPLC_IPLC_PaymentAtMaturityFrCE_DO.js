function FincSinglePayment_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_IPLC_IPLC_PaymentAtMaturityFrCE_DO.js", e);
    }
}
...
function SYF_IPLC_getDOdata_FincSinglePayment() {
    try {
...
function SYF_IPLC_getDOdata_PaymentDealer() {
    try {
...
function SYF_IPLC_getDOdata_PaymentDealer_PaymentCreditHeader() {
    try {
...
function SYF_IPLC_getDOdata_PaymentDealer_PaymentCreditHeader_PaymentCredit() {
    try {
...
function SYF_IPLC_getDOdata_PaymentDealer_PaymentDebitHeader() {
    try {
...
function SYF_IPLC_getDOdata_PaymentDealer_PaymentDebitHeader_PaymentDebit() {
    try {
