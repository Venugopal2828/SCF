function AdviceForBankCust_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_RPFM_RPFM_AutoTracer_DO.js", e);
    }
}
...
function SYF_RPFM_getDOdata_AdviceForBankCust() {
    try {
...
function SYF_RPFM_getDOdata_FinanceEstablishment() {
    try {
...
function SYF_RPFM_getDOdata_PaymentDealer() {
    try {
...
function SYF_RPFM_getDOdata_PaymentDealer_PaymentCreditHeader() {
    try {
...
function SYF_RPFM_getDOdata_PaymentDealer_PaymentCreditHeader_PaymentCredit() {
    try {
...
function SYF_RPFM_getDOdata_PaymentDealer_PaymentDebitHeader() {
    try {
...
function SYF_RPFM_getDOdata_PaymentDealer_PaymentDebitHeader_PaymentDebit() {
    try {
