function GeneralAccountHeader_GeneralAccount_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_EXCO_EXCO_GeneralAccounting_DO.js", e);
    }
}
...
function SYF_EXCO_getDOdata_GeneralAccountHeader() {
    try {
...
function SYF_EXCO_getDOdata_GeneralAccountHeader_GeneralAccount() {
    try {
