function AdviceForBankCust_OnDeSelected(node, record, recordId) {
    try {
        ...
        DisExcpt("SYF_SYND_SYND_NotePartChg_DO.js", e);
    }
}
...
function SYF_SYND_getDOdata_PaymentDealer() {
    try {
...
function SYF_SYND_getDOdata_PaymentDealer_PaymentCreditHeader() {
    try {
...
function SYF_SYND_getDOdata_PaymentDealer_PaymentCreditHeader_PaymentCredit() {
    try {
...
function SYF_SYND_getDOdata_PaymentDealer_PaymentDebitHeader() {
    try {
...
function SYF_SYND_getDOdata_PaymentDealer_PaymentDebitHeader_PaymentDebit() {
    try {
