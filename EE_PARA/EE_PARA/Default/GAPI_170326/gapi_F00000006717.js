if (DV.getFieldValue("R_LMT_DECISION_FLG") != "Failed") {
    ...
    if (E_PAID_CONFIRM_COMM_AMT > 0) {
        DV.writeLog("=====eLoan GAPI SBLC_ProClaim_Payment_ISSU_eLoan======START====");
        DV.appendField("SBLC_SBLC_ProClaim_Payment_ISSU_eLoan");
        DV.writeLog("=====eLoan GAPI SBLC_ProClaim_Payment_ISSU_eLoan======END====");
    }
