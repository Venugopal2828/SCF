...
stp.setGapiRule("IMLC_001_ImpLcApplctn");
...
var AvalBy = stp.getXMLNodeValue("AvalBy");
...
if (AvalBy == "BY MIXED PYMT") {
    ...
    var PmtAmt1 = stp.getXMLNodeValue("PmtAmt1");
    var PmtPct1 = stp.getXMLNodeValue("PmtPct1");
    var PmtTp1 = stp.getXMLNodeValue("PmtTp1");
    var TenorDays1 = stp.getXMLNodeValue("TenorDays1");
    var TenorTp1 = stp.getXMLNodeValue("TenorTp1");
    ...
    var PmtAmt2 = stp.getXMLNodeValue("PmtAmt2");
    var PmtPct2 = stp.getXMLNodeValue("PmtPct2");
    var PmtTp2 = stp.getXMLNodeValue("PmtTp2");
    var TenorDays2 = stp.getXMLNodeValue("TenorDays2");
    var TenorTp2 = stp.getXMLNodeValue("TenorTp2");
    ...
    var PmtAmt3 = stp.getXMLNodeValue("PmtAmt3");
    var PmtPct3 = stp.getXMLNodeValue("PmtPct3");
    var PmtTp3 = stp.getXMLNodeValue("PmtTp3");
    var TenorDays3 = stp.getXMLNodeValue("TenorDays3");
    var TenorTp3 = stp.getXMLNodeValue("TenorTp3");
    ...
    var PmtAmt4 = stp.getXMLNodeValue("PmtAmt4");
    var PmtPct4 = stp.getXMLNodeValue("PmtPct4");
    var PmtTp4 = stp.getXMLNodeValue("PmtTp4");
    var TenorDays4 = stp.getXMLNodeValue("TenorDays4");
    var TenorTp4 = stp.getXMLNodeValue("TenorTp4");
    ...
    var PmtAmt5 = stp.getXMLNodeValue("PmtAmt5");
    var PmtPct5 = stp.getXMLNodeValue("PmtPct5");
    var PmtTp5 = stp.getXMLNodeValue("PmtTp5");
    var TenorDays5 = stp.getXMLNodeValue("TenorDays5");
    var TenorTp5 = stp.getXMLNodeValue("TenorTp5");
    ...
    var PmtAmt6 = stp.getXMLNodeValue("PmtAmt6");
    var PmtPct6 = stp.getXMLNodeValue("PmtPct6");
    var PmtTp6 = stp.getXMLNodeValue("PmtTp6");
    var TenorDays6 = stp.getXMLNodeValue("TenorDays6");
    var TenorTp6 = stp.getXMLNodeValue("TenorTp6");
