...
// get C_MAIN_REF 
var LC_NO = stp.getSWIFTTagValue("20");
stp.updateFieldValue("LC_NO", LC_NO);
stp.SYS_getCUBK("PRE_ADV_REF", "LC_NO");
...
/* for SENDER_REF*/
var SENDER_REF = stp.getSWIFTTagValue("20");
stp.updateFieldValue("SENDER_REF", SENDER_REF);


/* for business control */
stp.updateFieldValue("CURRNT_STATUS", "RcvMT700After705");
...
TAG41A = stp.getLineValue(TAG41A, 2);
stp.writeLog("TAG41A====" + TAG41A);
...
if (TAG42CMP != "" && TAG41A != "BY PAYMENT" && TAG41A != "BY MIXED PYMT") {
