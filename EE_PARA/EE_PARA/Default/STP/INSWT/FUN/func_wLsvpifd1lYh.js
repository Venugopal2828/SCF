stp.writeLog("STP START: Start Incoming pacs008");
...
var UETR = stp.getXMLNodeValue("FIToFICstmrCdtTrf/CdtTrfTxInf/PmtId/UETR");
stp.writeLog("UETR=============" + UETR);
stp.updateFieldValue("UETR_GPI_121", UETR);
stp.updateFieldValue("CURRNT_STATUS", "RcvPacs008");

stp.writeLog("End Incoming pacs008");