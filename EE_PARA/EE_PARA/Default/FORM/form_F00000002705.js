...
DV.appendField("SSSS_ALL_GenAdv_Ben_Swe", "AdviceForBankCust", "MESG_TYPE_CUST = 'Mail' && SEND_TO_CUST_LANG = 'Swedish'");
DV.appendField("SSSS_ALL_GenAdv_Bank_Swe", "AdviceForBankCust", "MESG_TYPE_BANK = 'Mail' && SEND_TO_BANK_LANG = 'Swedish'");
