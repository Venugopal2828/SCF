...
if (MESG_TYPE.substr(0, 2) == 'MT' && TEMP_CATEGORY_FLG != '' && TEMP_MESG_TYPE != 'MT999') {
...
if (SUB_MESS_TYPE == "793") {

    DV.appendSWIFT("COMM_OUT_790_793");


}
if (SUB_MESS_TYPE == "794") {

    DV.appendSWIFT("COMM_OUT_791_794");
}

if (SUB_MESS_TYPE == "789") {

    DV.appendSWIFT("COMM_OUT_799_789");
}