...
var SEND_NT750_FLG = DV.getFieldValue("SEND_MT750_FLG");
var DOC_STAT = DV.getFieldValue("DOC_STAT");

if (SEND_NT750_FLG == "Yes" && DOC_STAT == "Discrepancy Found") {
    if (sResult_750 == "TRUE") {
...
if (DV.getFieldValue("APPLY_FLG") == "YES" && DV.getFieldValue("SUB_MESS_TYPE") == "737") {
    DV.appendSWIFT("EPLC_OUT_MT737");
}