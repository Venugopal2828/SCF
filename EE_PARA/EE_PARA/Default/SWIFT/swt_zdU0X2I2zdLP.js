...
var sB2_412 = DV.getFieldValue("REMIT_BK_SW_ADD");
var sResult_412 = DV.checkRMA(sB1, sB2_412, "412");
var REMIT_CORR_MEDIUM = DV.getFieldValue("REMIT_BK_COR_MED");
if (REMIT_CORR_MEDIUM == 'SWIFT') {
    if (sResult_412 == 'TRUE') {
        DV.appendSWIFT("SSSS_MT_412T");
    } else {
        var arr_para = new Array(sB1, sB2_412, "412");
        DV.throwException("1847", arr_para);
    }
}

//DV.appendSWIFT("IMCO_MT416");
var MESG_TYPE_BANK;
