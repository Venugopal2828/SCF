...
var sB2_710 = DV.getFieldValue("TRM_TO_BK_SW_ADD");
...
var sResult_710 = DV.checkRMA(sB1, sB2_710, "710");
var sResult_730 = DV.checkRMA(sB1, sB2_730, "730");
/* for RMA Check End */

if (DV.getFieldValue("ADV_LC_BY") == "SWIFT to Beneficiary's Bank") {
    if (sResult_710 == "TRUE") {
        DV.appendSWIFT("EPLC_EPLC_SWIFT_MT710");
        //For NonRegular
        //DV.appendSWIFT("EPLC_EPLC_SWIFT_MT710_NonRegular");
    } else {
        var arr_para = new Array(sB1, sB2_710, "710");
...
if (DV.getFieldValue("APPLY_FLG") == "YES") {
    if (DV.getFieldValue("SUB_MESS_TYPE") == "774") {
        DV.appendSWIFT("EPLC_OUT_MT700_MT774");
    } else if (DV.getFieldValue("SUB_MESS_TYPE") == "780") {
        DV.appendSWIFT("EPLC_OUT_MT710_MT780");
    } else {
        DV.appendSWIFT("EPLC_OUT_MT720_MT782");
    }
}
