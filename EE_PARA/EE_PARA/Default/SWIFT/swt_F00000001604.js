...
var sB2_720 = DV.getFieldValue("ADV_BK_SW_ADD");
var ADV_BK_CORR_MED = DV.getFieldValue("ADV_BK_CORR_MED");
var sB2_740 = DV.getFieldValue("ADV_BK_SW_ADD");
...
if (ADV_BK_CORR_MED == 'SWIFT') {
    var sResult_720 = DV.checkRMA(sB1, sB2_720, "720");
    if (sResult_720 == 'TRUE') {
        DV.appendSWIFT("IPLC_MT720_TranserLC");
        //For Nonregular
        //DV.appendSWIFT("IPLC_MT720_TranserLC_NonRegular");
    } else {
        var arr_para = new Array(sB1, sB2_720, "720");
