...
<xsl:stylesheet AutoGen-Parameter-Version="1.0" exclude-result-prefixes="xalan"
    ...
    <xsl:template match="/">
        <xsl:element name="MSG06">
            ...
            <xsl:element name="CreditCoverNr">
                <xsl:value-of select="/root/domData/FA_CCR_REF"/>
            </xsl:element>
            <xsl:element name="MsgFunction">
                <xsl:value-of select="ee:getInterpreter(/root/domData/FA_MSG_FUNC)"/>
            </xsl:element>
            <xsl:element name="OrigReqNr">
                <xsl:value-of select="/root/domData/FA_CCA_THEIR_REF"/>
            </xsl:element>
            <xsl:element name="OrigReqDate">
            ...
            <xsl:element name="Seller">
                ...
                <xsl:element name="IFOwnSellerNr">
            ...
            <xsl:element name="Buyer">
                ...
                <xsl:element name="DirectContact">
                    <xsl:value-of select="ee:getInterpreter(/root/domData/FA_BUYER_CNTY_FLG)"/>
                </xsl:element>
            ...
            <xsl:element name="CreditCoverDetails">
                <xsl:element name="CreditCoverAmt">
