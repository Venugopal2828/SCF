        ...
        <xsl:element name="MSG10">
            ...
            <xsl:element name="AdjustDetails">
                <xsl:element name="InvValueDate">
                    <xsl:value-of select="/root/domData/FA_DOC_VAL_DT"/>
                </xsl:element>
                ...
                <xsl:element name="PmtCondition">
                    <xsl:value-of select="ee:getInterpreter(/root/domData/FA_PMT_COND)"/>
                </xsl:element>
                <xsl:element name="OrderNrRef">
                    <xsl:value-of select="/root/domData/FA_DOC_REF"/>
                </xsl:element>
            </xsl:element>
