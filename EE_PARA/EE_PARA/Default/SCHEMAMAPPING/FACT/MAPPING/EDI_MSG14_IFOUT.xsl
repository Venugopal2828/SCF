...
<xsl:stylesheet exclude-result-prefixes="xalan"
    ...
    <xsl:template match="/">
        <xsl:element name="MSG14">
            ...
            <xsl:element name="DisputeNr">
                <xsl:value-of select="/root/domData/DisputeReg/FA_DSP_NO"/>
            </xsl:element>
            ...
            <xsl:apply-templates mode="m0" select="/root/domData/DisputeReg"/>
    ...
    <xsl:template match="/root/domData/DisputeReg" mode="m0">
        <DisputeDetails>
