    ...
    <xsl:template match="/">
        <xsl:element name="MSG15">
            ...
            <xsl:element name="DisputeStatus">
                <xsl:value-of select="/root/domData/FA_DSP_STATUS"/>
            </xsl:element>
            ...
            <xsl:element name="DisputeDetails">
                <xsl:element name="DocType">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_DOC_TYPE"/>
                </xsl:element>
                <xsl:element name="DocNr">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_DOC_NO"/>
                </xsl:element>
                <xsl:element name="DocDate">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_DOC_DT"/>
                </xsl:element>
                <xsl:element name="DocAmt">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_DOC_AMT"/>
                </xsl:element>
                <xsl:element name="DisputeAmt">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_DSP_AMT"/>
                </xsl:element>
                <xsl:element name="DisputeReason">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_DSP_RSN_CODE"/>
                </xsl:element>
                <xsl:element name="InstructionStatus">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_DSP_INSTR"/>
                </xsl:element>
                <xsl:element name="NotifyingParty">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_NOTIFY_BY_NM"/>
                </xsl:element>
                <xsl:element name="Action">
                    <xsl:value-of select="/root/domData/DisputeSettl/FA_ACTION_CODE"/>
                </xsl:element>
            </xsl:element>
