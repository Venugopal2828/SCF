    ...
    <xsl:template match="/">
        <xsl:element name="root">
            <xsl:element name="domData">
                ...
                <xsl:apply-templates mode="m0" select="/MSG15/DisputeDetails"/>
            </xsl:element>
        </xsl:element>
    </xsl:template>
    <xsl:template match="/MSG15/DisputeDetails" mode="m0">
        <DisputeSettl>
            ...
            <xsl:element name="FA_DSP_INSTR">
                <xsl:value-of select="InstructionStatus"/>
            </xsl:element>
