...
<xsl:stylesheet xmlns:base="base" xmlns:cs="cs" xmlns:ee="ee" xmlns:xalan="http://xml.apache.org/xalan" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xalan" extension-element-prefixes="base ee cs" version="1.0">
    ...
    <xsl:template match="/">
        <xsl:element name="MSG09">
            ...
            <xsl:apply-templates mode="m0" select="/root/domData/VerifyInv"/>
    ...
    <xsl:template match="/root/domData/VerifyInv" mode="m0">
        <InvCreditNoteDetails>
            ...
            <xsl:element name="DocAmt">
                <xsl:value-of select="FA_ADJ_AMT"/>
            </xsl:element>
            ...
            <xsl:element name="OrderNrRef">
                <xsl:value-of select="/root/domData/FA_ORDER_NO"/>
            </xsl:element>
