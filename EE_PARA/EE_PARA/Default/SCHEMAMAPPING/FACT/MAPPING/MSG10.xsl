    ...
    <xsl:template match="/">
        <xsl:element name="MSG10">
            ...
            <xsl:element name="OrigDocNr">
                <xsl:value-of select="/root/domData/EFIncAjustCancel/FA_TEMP3"/>
            </xsl:element>
            ...
            <xsl:apply-templates mode="m0" select="/root/domData/EFIncAjustCancel"/>
            <xsl:element name="MsgText">
                <xsl:value-of select="/root/domData/EFIncAjustCancel/FA_MSG_TEXT02"/>
            </xsl:element>
        </xsl:element>
    </xsl:template>
    <xsl:template match="/root/domData/EFIncAjustCancel" mode="m0">
        <AdjustDetails>
