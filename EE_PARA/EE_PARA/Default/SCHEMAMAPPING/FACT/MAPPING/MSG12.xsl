...
<xsl:stylesheet AutoGen-Parameter-Version="1.0" exclude-result-prefixes="xalan"
    ...
    <xsl:template match="/">
        <xsl:element name="MSG12">
            ...
            <xsl:element name="PmtBatchCurrency">
                <xsl:value-of select="/root/domData/FA_PMT_CCY"/>
            </xsl:element>
            ...
            <xsl:apply-templates mode="m0" select="/root/domData/IndirectPmt"/>
    ...
    <xsl:template match="/root/domData/IndirectPmt" mode="m0">
        <PmtDetails>
