...
public class RegistrationTokenService {
	...
	public HashMap<String, String> generateRegistrationToken(String cMainRef, String counterPartyId,
		...
		String jwtToken = Jwts.builder().setSubject("COUNTERPARTY_REGISTRATION")
				...
				.claim("customerName", customerName).claim("mobile", mobile)
	...
	public HashMap<String, String> generateRejectRegistrationToken(String rejectReason,String cMainRef, String email, Integer expirationHours) throws Exception {
		...
		String jwtToken = Jwts.builder()
			    ...
			    .claim("flowType", "REJECT")

			    // 🔥 ADD THESE (VERY IMPORTANT)
			    .claim("email", email)
			    .claim("customerName","")   // fallback
			    .claim("mobile", "")
			    .claim("counterpartyId", cMainRef)
